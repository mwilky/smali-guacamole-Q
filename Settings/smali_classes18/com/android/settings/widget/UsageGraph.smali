...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Lcom/android/settings/widget/UsageGraph;->mPath:Landroid/graphics/Path;

    new-instance v0, Landroid/util/SparseIntArray;

    invoke-direct {v0}, Landroid/util/SparseIntArray;-><init>()V

    iput-object v0, p0, Lcom/android/settings/widget/UsageGraph;->mPaths:Landroid/util/SparseIntArray;

    new-instance v0, Landroid/util/SparseIntArray;

    invoke-direct {v0}, Landroid/util/SparseIntArray;-><init>()V

    iput-object v0, p0, Lcom/android/settings/widget/UsageGraph;->mLocalPaths:Landroid/util/SparseIntArray;

    new-instance v0, Landroid/util/SparseIntArray;

    invoke-direct {v0}, Landroid/util/SparseIntArray;-><init>()V

    iput-object v0, p0, Lcom/android/settings/widget/UsageGraph;->mProjectedPaths:Landroid/util/SparseIntArray;

    new-instance v0, Landroid/util/SparseIntArray;

    invoke-direct {v0}, Landroid/util/SparseIntArray;-><init>()V

    iput-object v0, p0, Lcom/android/settings/widget/UsageGraph;->mLocalProjectedPaths:Landroid/util/SparseIntArray;

    const/high16 v0, 0x42c80000    # 100.0f

    iput v0, p0, Lcom/android/settings/widget/UsageGraph;->mMaxX:F

    iput v0, p0, Lcom/android/settings/widget/UsageGraph;->mMaxY:F
    ...
    iput v0, p0, Lcom/android/settings/widget/UsageGraph;->mMiddleDividerTint:I

    iput v0, p0, Lcom/android/settings/widget/UsageGraph;->mTopDividerTint:I
    ...
    iput-object v1, p0, Lcom/android/settings/widget/UsageGraph;->mLinePaint:Landroid/graphics/Paint;
    ...
    iput v1, p0, Lcom/android/settings/widget/UsageGraph;->mCornerRadius:I

    iget-object v1, p0, Lcom/android/settings/widget/UsageGraph;->mLinePaint:Landroid/graphics/Paint;

    new-instance v3, Landroid/graphics/CornerPathEffect;

    iget v4, p0, Lcom/android/settings/widget/UsageGraph;->mCornerRadius:I
    ...
    iput-object v1, p0, Lcom/android/settings/widget/UsageGraph;->mFillPaint:Landroid/graphics/Paint;

    iget-object v1, p0, Lcom/android/settings/widget/UsageGraph;->mFillPaint:Landroid/graphics/Paint;
    ...
    iput-object v1, p0, Lcom/android/settings/widget/UsageGraph;->mDottedPaint:Landroid/graphics/Paint;

    iget-object v1, p0, Lcom/android/settings/widget/UsageGraph;->mDottedPaint:Landroid/graphics/Paint;
    ...
    iput-object v2, p0, Lcom/android/settings/widget/UsageGraph;->mDivider:Landroid/graphics/drawable/Drawable;
    ...
    iput v2, p0, Lcom/android/settings/widget/UsageGraph;->mDividerSize:I
...
.method private drawDivider(ILandroid/graphics/Canvas;I)V
    ...
    iget-object v1, p0, Lcom/android/settings/widget/UsageGraph;->mTintedDivider:Landroid/graphics/drawable/Drawable;
    ...
    iget v3, p0, Lcom/android/settings/widget/UsageGraph;->mDividerSize:I
...
.method private getY(F)I
    ...
    iget v1, p0, Lcom/android/settings/widget/UsageGraph;->mMaxY:F
...
.method private hasDiff(II)Z
    ...
    iget v1, p0, Lcom/android/settings/widget/UsageGraph;->mCornerRadius:I
...
.method calculateLocalPaths(Landroid/util/SparseIntArray;Landroid/util/SparseIntArray;)V
    ...
    invoke-direct {p0, v10}, Lcom/android/settings/widget/UsageGraph;->getX(F)I

    move-result v2

    int-to-float v10, v7

    invoke-direct {p0, v10}, Lcom/android/settings/widget/UsageGraph;->getY(F)I
    ...
    invoke-direct {p0, v10, v2}, Lcom/android/settings/widget/UsageGraph;->hasDiff(II)Z

    move-result v8

    if-nez v8, :cond_4

    invoke-direct {p0, v9, v3}, Lcom/android/settings/widget/UsageGraph;->hasDiff(II)Z
...
.method clearPaths()V
    ...
    iget-object v0, p0, Lcom/android/settings/widget/UsageGraph;->mLocalProjectedPaths:Landroid/util/SparseIntArray;
...
.method setDividerLoc(I)V
    ...
    iput v1, p0, Lcom/android/settings/widget/UsageGraph;->mMiddleDividerLoc:F
...
.method setMax(II)V
    ...
    iput v2, p0, Lcom/android/settings/widget/UsageGraph;->mMaxX:F

    int-to-float v2, p2

    iput v2, p0, Lcom/android/settings/widget/UsageGraph;->mMaxY:F
