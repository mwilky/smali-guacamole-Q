...
.method private static buildPreferenceControllers(Landroid/content/Context;Landroid/app/Activity;Lcom/android/settingslib/core/lifecycle/Lifecycle;Lcom/android/settings/development/DevelopmentSettingsDashboardFragment;Lcom/android/settings/development/BluetoothA2dpConfigStore;)Ljava/util/List;
    ...
    invoke-direct {v1, p0}, Lcom/android/settings/development/DesktopModePreferenceController;-><init>(Landroid/content/Context;)V
    ...
    new-instance v1, Lcom/android/settings/development/BubbleGlobalPreferenceController;

    invoke-direct {v1, p0}, Lcom/android/settings/development/BubbleGlobalPreferenceController;-><init>(Landroid/content/Context;)V
    ...
    new-instance v1, Lcom/android/settings/development/TrustAgentsExtendUnlockPreferenceController;

    invoke-direct {v1, p0}, Lcom/android/settings/development/TrustAgentsExtendUnlockPreferenceController;-><init>(Landroid/content/Context;)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v1, Lcom/android/settings/development/TrustLostLocksScreenPreferenceController;

    invoke-direct {v1, p0}, Lcom/android/settings/development/TrustLostLocksScreenPreferenceController;-><init>(Landroid/content/Context;)V
...
.method public onSwitchChanged(Landroid/widget/Switch;Z)V
    ...
    :cond_1
    const-class v1, Lcom/android/settings/development/BluetoothA2dpHwOffloadPreferenceController;
    ...
    check-cast v1, Lcom/android/settings/development/BluetoothA2dpHwOffloadPreferenceController;

    if-eqz v1, :cond_3

    invoke-virtual {v1}, Lcom/android/settings/development/BluetoothA2dpHwOffloadPreferenceController;->isDefaultValue()Z
