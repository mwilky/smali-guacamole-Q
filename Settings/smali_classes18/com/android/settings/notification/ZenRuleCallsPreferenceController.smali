...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/settingslib/core/lifecycle/Lifecycle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/notification/ZenRuleCallsPreferenceController;->mListValues:[Ljava/lang/String;
...
.method private updateFromContactsValue(Landroidx/preference/Preference;)V
    ...
    iget-object v0, p0, Lcom/android/settings/notification/ZenRuleCallsPreferenceController;->mRule:Landroid/app/AutomaticZenRule;
    ...
    iget-object v1, p0, Lcom/android/settings/notification/ZenRuleCallsPreferenceController;->mBackend:Lcom/android/settings/notification/ZenModeBackend;

    iget-object v2, p0, Lcom/android/settings/notification/ZenRuleCallsPreferenceController;->mRule:Landroid/app/AutomaticZenRule;

    invoke-virtual {v2}, Landroid/app/AutomaticZenRule;->getZenPolicy()Landroid/service/notification/ZenPolicy;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/android/settings/notification/ZenModeBackend;->getContactsCallsSummary(Landroid/service/notification/ZenPolicy;)I

    move-result v1

    invoke-virtual {v0, v1}, Landroidx/preference/ListPreference;->setSummary(I)V

    iget-object v1, p0, Lcom/android/settings/notification/ZenRuleCallsPreferenceController;->mRule:Landroid/app/AutomaticZenRule;
    ...
    iget-object v2, p0, Lcom/android/settings/notification/ZenRuleCallsPreferenceController;->mListValues:[Ljava/lang/String;

    invoke-virtual {p0, v1}, Lcom/android/settings/notification/ZenRuleCallsPreferenceController;->getIndexOfSendersValue(Ljava/lang/String;)I
...
.method public onPreferenceChange(Landroidx/preference/Preference;Ljava/lang/Object;)Z
    ...
    iget-object v1, p0, Lcom/android/settings/notification/ZenRuleCallsPreferenceController;->mMetricsFeatureProvider:Lcom/android/settingslib/core/instrumentation/MetricsFeatureProvider;

    iget-object v2, p0, Lcom/android/settings/notification/ZenRuleCallsPreferenceController;->mContext:Landroid/content/Context;
    ...
    iget-object v5, p0, Lcom/android/settings/notification/ZenRuleCallsPreferenceController;->mId:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/android/settings/notification/ZenRuleCallsPreferenceController;->mRule:Landroid/app/AutomaticZenRule;
    ...
    iget-object v2, p0, Lcom/android/settings/notification/ZenRuleCallsPreferenceController;->mId:Ljava/lang/String;
