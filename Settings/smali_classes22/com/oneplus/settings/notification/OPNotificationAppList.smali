...
.method static synthetic access$1000(Lcom/oneplus/settings/notification/OPNotificationAppList;)Landroid/content/pm/PackageManager;
    .locals 1
...
.method static synthetic access$1100(Lcom/oneplus/settings/notification/OPNotificationAppList;)Lcom/oneplus/settings/notification/OPNotificationAppList$Backend;
    .locals 1
...
.method static synthetic access$600(Lcom/oneplus/settings/notification/OPNotificationAppList;)Ljava/lang/Runnable;
    .locals 1
...
.method static synthetic access$700(Lcom/oneplus/settings/notification/OPNotificationAppList;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic access$800(Lcom/oneplus/settings/notification/OPNotificationAppList;)Landroid/util/ArrayMap;
    .locals 1
...
.method static synthetic access$900(Lcom/oneplus/settings/notification/OPNotificationAppList;)Landroid/content/pm/LauncherApps;
    .locals 1
...
.method public static applyConfigActivities(Landroid/content/pm/PackageManager;Landroid/util/ArrayMap;Ljava/util/List;)V
    ...
    :cond_1
    iget-object v6, v5, Lcom/oneplus/settings/notification/OPNotificationAppList$AppRow;->settingsIntent:Landroid/content/Intent;
    ...
    sget-object v7, Lcom/oneplus/settings/notification/OPNotificationAppList;->APP_NOTIFICATION_PREFS_CATEGORY_INTENT:Landroid/content/Intent;
    ...
    iput-object v6, v5, Lcom/oneplus/settings/notification/OPNotificationAppList$AppRow;->settingsIntent:Landroid/content/Intent;
...
.method private refreshDisplayedItems(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v3, v4}, Landroidx/preference/SwitchPreference;->setKey(Ljava/lang/String;)V

    iget-object v4, v1, Lcom/oneplus/settings/notification/OPNotificationAppList$AppRow;->label:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroidx/preference/SwitchPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v3, v4}, Landroidx/preference/SwitchPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v3, v4}, Landroidx/preference/SwitchPreference;->setOnPreferenceChangeListener(Landroidx/preference/Preference$OnPreferenceChangeListener;)V
    ...
    iget-object v4, p0, Lcom/oneplus/settings/notification/OPNotificationAppList;->mNotAllowLEDApps:Landroidx/preference/PreferenceCategory;
    ...
    iget-object v4, p0, Lcom/oneplus/settings/notification/OPNotificationAppList;->mAllowLEDApps:Landroidx/preference/PreferenceCategory;
    ...
    iget-object v1, p0, Lcom/oneplus/settings/notification/OPNotificationAppList;->mSortedRows:Ljava/util/ArrayList;
    ...
    const-string v1, " displayed items"
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/oneplus/settings/notification/OPNotificationAppList;->getActivity()Landroidx/fragment/app/FragmentActivity;
    ...
    invoke-virtual {p0}, Lcom/oneplus/settings/notification/OPNotificationAppList;->getPreferenceScreen()Landroidx/preference/PreferenceScreen;

    move-result-object v0

    iput-object v0, p0, Lcom/oneplus/settings/notification/OPNotificationAppList;->mRoot:Landroidx/preference/PreferenceScreen;

    const-string v0, "op_notification_allow_led"

    invoke-virtual {p0, v0}, Lcom/oneplus/settings/notification/OPNotificationAppList;->findPreference(Ljava/lang/CharSequence;)Landroidx/preference/Preference;

    move-result-object v0

    check-cast v0, Landroidx/preference/PreferenceCategory;

    iput-object v0, p0, Lcom/oneplus/settings/notification/OPNotificationAppList;->mAllowLEDApps:Landroidx/preference/PreferenceCategory;
    ...
    iput-object v0, p0, Lcom/oneplus/settings/notification/OPNotificationAppList;->mNotAllowLEDApps:Landroidx/preference/PreferenceCategory;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/oneplus/settings/notification/OPNotificationAppList;->getListView()Landroidx/recyclerview/widget/RecyclerView;
