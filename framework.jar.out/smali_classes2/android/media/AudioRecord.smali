...
.field private mIsPermRejected:Z
...
.method constructor <init>(J)V
    ...
    iput-boolean v0, p0, Landroid/media/AudioRecord;->mIsPermRejected:Z
...
.method public constructor <init>(Landroid/media/AudioAttributes;Landroid/media/AudioFormat;II)V
    ...
    iput-boolean v14, v12, Landroid/media/AudioRecord;->mIsPermRejected:Z
...
.method public read(Ljava/nio/ByteBuffer;II)I
    ...
    :cond_2
    iget-boolean v2, p0, Landroid/media/AudioRecord;->mIsPermRejected:Z

    const/4 v3, 0x0

    if-eqz v2, :cond_3

    const-string v1, "Recording permission has been denied"
...
.method public read([FIII)I
    ...
    :cond_3
    iget-boolean v0, p0, Landroid/media/AudioRecord;->mIsPermRejected:Z

    const/4 v3, 0x0

    if-eqz v0, :cond_4

    const-string v0, "Recording permission has been denied"
...
.method public startRecording()V
    ...
    invoke-static {v1, v4}, Landroid/util/PermissionInjector;->rejectPerm(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v4

    iput-boolean v4, p0, Landroid/media/AudioRecord;->mIsPermRejected:Z

    iget-boolean v4, p0, Landroid/media/AudioRecord;->mIsPermRejected:Z

    if-eqz v4, :cond_1

    invoke-static {v3}, Landroid/util/PermissionInjector;->isSpecialHandleForRecordAudio(Ljava/lang/String;)Z
