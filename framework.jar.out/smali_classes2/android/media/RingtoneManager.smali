...
.method static constructor <clinit>()V
    ...
    filled-new-array {v2, v3, v3, v1, v0}, [Ljava/lang/String;

    move-result-object v4

    sput-object v4, Landroid/media/RingtoneManager;->INTERNAL_COLUMNS:[Ljava/lang/String;
...
.method public static getActualRingtoneUriBySubId(Landroid/content/Context;I)Landroid/net/Uri;
    ...
    invoke-static {p0, p1}, Lcom/oneplus/media/OnePlusRingtoneManagerInjector;->getActualRingtoneUriBySubId(Landroid/content/Context;I)Landroid/net/Uri;
...
.method public static getCacheForType(II)Landroid/net/Uri;
    ...
    const-string v2, "getCacheForType: type("
...
.method public static getDefaultRingtoneSubIdByUri(Landroid/net/Uri;)I
    ...
    invoke-static {p0}, Lcom/oneplus/media/OnePlusRingtoneManagerInjector;->getDefaultRingtoneSubIdByUri(Landroid/net/Uri;)I
...
.method public static getDefaultRingtoneUriBySubId(I)Landroid/net/Uri;
    ...
    invoke-static {p0}, Lcom/oneplus/media/OnePlusRingtoneManagerInjector;->getDefaultRingtoneUriBySubId(I)Landroid/net/Uri;
...
.method public static getStaticDefaultRingtoneUri(Landroid/content/Context;)Landroid/net/Uri;
    ...
    invoke-static {p0}, Lcom/oneplus/media/OnePlusRingtoneManagerInjector;->getStaticDefaultRingtoneUri(Landroid/content/Context;)Landroid/net/Uri;
...
.method public static setActualDefaultRingtoneUri(Landroid/content/Context;ILandroid/net/Uri;)V
    ...
    invoke-static {p0, p1, p2}, Lcom/oneplus/media/OnePlusRingtoneManagerInjector;->ringtoneCopyFrom3rdParty(Landroid/content/Context;ILandroid/net/Uri;)Landroid/net/Uri;
    ...
    invoke-static {p0, v0, p2}, Lcom/oneplus/media/OnePlusRingtoneManagerInjector;->setActualDefaultRingtoneUri(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;)V
    ...
    const-string v2, "Avoid to cache the null ringtone uri"
    ...
    :try_start_3
    invoke-static {v2, v6}, Landroid/media/RingtoneManager;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_3
...
.method public static setActualRingtoneUriBySubId(Landroid/content/Context;ILandroid/net/Uri;)V
    ...
    invoke-static {p0, p1, p2}, Lcom/oneplus/media/OnePlusRingtoneManagerInjector;->setActualRingtoneUriBySubId(Landroid/content/Context;ILandroid/net/Uri;)V
...
.method public getCursor()Landroid/database/Cursor;
    ...
    const-string v3, "Invalid column DISPLAY_NAME, use DEFAULT_SORT_ORDER instead: "
...
.method public getRingtoneUri(I)Landroid/net/Uri;
    ...
    const-string/jumbo v1, "getRingtoneUri: return null for position("
