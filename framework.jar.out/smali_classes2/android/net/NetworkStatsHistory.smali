...
.method public generateRandom(JJJJJJJLjava/util/Random;)V
    ...
    invoke-direct/range {v4 .. v18}, Landroid/net/NetworkStats$Entry;-><init>(Ljava/lang/String;IIIJJJJJ)V
    ...
    invoke-static {v3, v13, v14, v1, v2}, Landroid/net/NetworkStatsHistory;->randomLong(Ljava/util/Random;JJ)J
    ...
    invoke-static {v3, v13, v14, v0, v1}, Landroid/net/NetworkStatsHistory;->randomLong(Ljava/util/Random;JJ)J
    ...
    invoke-static {v3, v13, v14, v5, v6}, Landroid/net/NetworkStatsHistory;->randomLong(Ljava/util/Random;JJ)J

    move-result-wide v0

    iput-wide v0, v4, Landroid/net/NetworkStats$Entry;->rxBytes:J

    invoke-static {v3, v13, v14, v7, v8}, Landroid/net/NetworkStatsHistory;->randomLong(Ljava/util/Random;JJ)J

    move-result-wide v0

    iput-wide v0, v4, Landroid/net/NetworkStats$Entry;->rxPackets:J

    invoke-static {v3, v13, v14, v9, v10}, Landroid/net/NetworkStatsHistory;->randomLong(Ljava/util/Random;JJ)J

    move-result-wide v0

    iput-wide v0, v4, Landroid/net/NetworkStats$Entry;->txBytes:J

    invoke-static {v3, v13, v14, v11, v12}, Landroid/net/NetworkStatsHistory;->randomLong(Ljava/util/Random;JJ)J
    ...
    iput-wide v13, v4, Landroid/net/NetworkStats$Entry;->operations:J

    iget-wide v13, v4, Landroid/net/NetworkStats$Entry;->rxBytes:J

    sub-long/2addr v5, v13

    iget-wide v13, v4, Landroid/net/NetworkStats$Entry;->rxPackets:J

    sub-long/2addr v7, v13

    iget-wide v13, v4, Landroid/net/NetworkStats$Entry;->txBytes:J

    sub-long/2addr v9, v13

    iget-wide v13, v4, Landroid/net/NetworkStats$Entry;->txPackets:J

    sub-long/2addr v11, v13

    iget-wide v13, v4, Landroid/net/NetworkStats$Entry;->operations:J
    ...
    const-string v1, "NetworkStatsHistory"
...
.method public recordData(JJLandroid/net/NetworkStats$Entry;)V
    ...
    div-long v14, v23, v16

    mul-long v23, v12, v1

    move-wide/from16 v29, v12

    div-long v12, v23, v16
    ...
    invoke-static {v12, v7, v1, v2}, Landroid/net/NetworkStatsHistory;->addLong([JIJ)V

    iget-object v12, v0, Landroid/net/NetworkStatsHistory;->rxBytes:[J

    invoke-static {v12, v7, v3, v4}, Landroid/net/NetworkStatsHistory;->addLong([JIJ)V

    sub-long v19, v19, v3

    iget-object v12, v0, Landroid/net/NetworkStatsHistory;->rxPackets:[J

    invoke-static {v12, v7, v5, v6}, Landroid/net/NetworkStatsHistory;->addLong([JIJ)V

    sub-long/2addr v8, v5

    iget-object v12, v0, Landroid/net/NetworkStatsHistory;->txBytes:[J

    invoke-static {v12, v7, v14, v15}, Landroid/net/NetworkStatsHistory;->addLong([JIJ)V
    ...
    invoke-static {v3, v7, v4, v5}, Landroid/net/NetworkStatsHistory;->addLong([JIJ)V
...
.method public recordHistory(Landroid/net/NetworkStatsHistory;JJ)V
    ...
    invoke-direct/range {v2 .. v16}, Landroid/net/NetworkStats$Entry;-><init>(Ljava/lang/String;IIIJJJJJ)V
    ...
    :goto_0
    iget v0, v1, Landroid/net/NetworkStatsHistory;->bucketCount:I

    if-ge v3, v0, :cond_2

    iget-object v0, v1, Landroid/net/NetworkStatsHistory;->bucketStart:[J

    aget-wide v4, v0, v3

    iget-wide v6, v1, Landroid/net/NetworkStatsHistory;->bucketDuration:J
    ...
    :cond_0
    iget-object v0, v1, Landroid/net/NetworkStatsHistory;->rxBytes:[J

    const-wide/16 v8, 0x0

    invoke-static {v0, v3, v8, v9}, Landroid/net/NetworkStatsHistory;->getLong([JIJ)J

    move-result-wide v10

    iput-wide v10, v2, Landroid/net/NetworkStats$Entry;->rxBytes:J

    iget-object v0, v1, Landroid/net/NetworkStatsHistory;->rxPackets:[J
    ...
    iget-object v0, v1, Landroid/net/NetworkStatsHistory;->txBytes:[J
    ...
    iget-object v0, v1, Landroid/net/NetworkStatsHistory;->txPackets:[J
    ...
    iget-object v0, v1, Landroid/net/NetworkStatsHistory;->operations:[J
    ...
    const-string v8, "NetworkStatsHistory"

    const-string v9, "Caught an IllegalArgumentException"
