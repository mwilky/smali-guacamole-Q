...
.method public createFromParcel(Landroid/os/Parcel;)Landroid/net/wifi/WifiInfo;
    ...
    :goto_4
    invoke-static {v0, v1}, Landroid/net/wifi/WifiInfo;->access$702(Landroid/net/wifi/WifiInfo;Z)Z

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v1

    invoke-static {v0, v1}, Landroid/net/wifi/WifiInfo;->access$802(Landroid/net/wifi/WifiInfo;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/WifiInfo;->access$1102(Landroid/net/wifi/WifiInfo;I)I
    ...
    :goto_5
    invoke-static {v0, v1}, Landroid/net/wifi/WifiInfo;->access$1202(Landroid/net/wifi/WifiInfo;Z)Z
    ...
    :goto_6
    invoke-static {v0, v2}, Landroid/net/wifi/WifiInfo;->access$1302(Landroid/net/wifi/WifiInfo;Z)Z
