...
.method static constructor <clinit>()V
    ...
    :cond_1
    sput-boolean v0, Landroid/telephony/CellSignalStrengthCdma;->DBG:Z
...
.method private constructor <init>(Landroid/os/Parcel;)V
    ...
    iput v0, p0, Landroid/telephony/CellSignalStrengthCdma;->mOpLevel:I

    sget-boolean v0, Landroid/telephony/CellSignalStrengthCdma;->DBG:Z
    ...
    const-string v1, "CellSignalStrengthCdma(Parcel): "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p0}, Landroid/telephony/CellSignalStrengthCdma;->toString()Ljava/lang/String;
    ...
    invoke-static {v0}, Landroid/telephony/CellSignalStrengthCdma;->log(Ljava/lang/String;)V
...
.method protected copyFrom(Landroid/telephony/CellSignalStrengthCdma;)V
    ...
    iget v0, p1, Landroid/telephony/CellSignalStrengthCdma;->mOpLevel:I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget v2, p0, Landroid/telephony/CellSignalStrengthCdma;->mOpLevel:I

    iget v3, v0, Landroid/telephony/CellSignalStrengthCdma;->mOpLevel:I
...
.method public getAsuLevel()I
    ...
    :goto_2
    sget-boolean v4, Landroid/telephony/CellSignalStrengthCdma;->DBG:Z
    ...
    invoke-static {v4}, Landroid/telephony/CellSignalStrengthCdma;->log(Ljava/lang/String;)V
...
.method public getCdmaLevel()I
    ...
    sget v2, Landroid/telephony/CellSignalStrengthCdma;->mOperatorDefine:I

    const/4 v3, 0x2

    if-eq v2, v3, :cond_d

    sget v2, Landroid/telephony/CellSignalStrengthCdma;->OEM_SMOOTH_LOWEST_LVL:I
    ...
    :goto_2
    sget-boolean v5, Landroid/telephony/CellSignalStrengthCdma;->DBG:Z
    ...
    invoke-static {v5}, Landroid/telephony/CellSignalStrengthCdma;->log(Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, v2}, Landroid/telephony/OpSignalStrength;->getCdmaLevel(III)I
...
.method public getEvdoLevel()I
    ...
    sget v3, Landroid/telephony/CellSignalStrengthCdma;->mOperatorDefine:I

    const/4 v4, 0x2

    if-eq v3, v4, :cond_d

    sget v3, Landroid/telephony/CellSignalStrengthCdma;->OEM_SMOOTH_LOWEST_LVL:I
    ...
    :goto_2
    sget-boolean v6, Landroid/telephony/CellSignalStrengthCdma;->DBG:Z
    ...
    invoke-static {v6}, Landroid/telephony/CellSignalStrengthCdma;->log(Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, v2, v3}, Landroid/telephony/OpSignalStrength;->getEvdoLevel(IIII)I
...
.method public getOpLevel()I
    ...
    iget v0, p0, Landroid/telephony/CellSignalStrengthCdma;->mOpLevel:I
...
.method public hashCode()I
    ...
    iget v1, p0, Landroid/telephony/CellSignalStrengthCdma;->mOpLevel:I
...
.method public updateLevel(Landroid/os/PersistableBundle;Landroid/telephony/ServiceState;)V
    ...
    iput v2, p0, Landroid/telephony/CellSignalStrengthCdma;->mOpLevel:I
    ...
    sget-boolean v2, Landroid/telephony/CellSignalStrengthCdma;->DBG:Z
    ...
    const-string/jumbo v3, "updateLevel - mLevel="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v3, p0, Landroid/telephony/CellSignalStrengthCdma;->mLevel:I

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v3, ", mOpLevel"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v3, p0, Landroid/telephony/CellSignalStrengthCdma;->mOpLevel:I
    ...
    invoke-static {v2}, Landroid/telephony/CellSignalStrengthCdma;->log(Ljava/lang/String;)V
