...
.method public static findLatestIncomingMessage(Ljava/util/List;)Landroid/app/Notification$MessagingStyle$Message;
    ...
    invoke-static {v1}, Landroid/app/Notification$MessagingStyle$Message;->access$4600(Landroid/app/Notification$MessagingStyle$Message;)Landroid/app/Person;
...
.method private fixTitleAndTextExtras(Landroid/os/Bundle;)V
    ...
    :cond_0
    invoke-static {v0}, Landroid/app/Notification$MessagingStyle$Message;->access$4500(Landroid/app/Notification$MessagingStyle$Message;)Ljava/lang/CharSequence;
    ...
    :cond_1
    invoke-static {v0}, Landroid/app/Notification$MessagingStyle$Message;->access$4600(Landroid/app/Notification$MessagingStyle$Message;)Landroid/app/Person;
    ...
    invoke-static {v4}, Landroid/app/Notification$Builder;->access$4400(Landroid/app/Notification$Builder;)Landroid/content/Context;
...
.method private makeMessagingView(ZZ)Landroid/widget/RemoteViews;
    ...
    invoke-static {p0}, Landroid/app/Notification$Style;->access$4300(Landroid/app/Notification$Style;)Ljava/lang/CharSequence;
    ...
    invoke-static {v1}, Landroid/app/Notification$Builder;->access$4400(Landroid/app/Notification$Builder;)Landroid/content/Context;
    ...
    invoke-static {v7}, Landroid/app/Notification;->access$1400(Landroid/app/Notification;)Landroid/graphics/drawable/Icon;
    ...
    invoke-static {v8}, Landroid/app/Notification$Builder;->access$4700(Landroid/app/Notification$Builder;)I

    move-result v8

    invoke-static {v4, v8, v3, v7}, Landroid/app/Notification$Builder;->access$3300(Landroid/app/Notification$Builder;ILandroid/app/Notification$StandardTemplateParams;Landroid/app/Notification$TemplateBindResult;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v8, v3}, Landroid/app/Notification$Builder;->access$4800(Landroid/app/Notification$Builder;Landroid/app/Notification$StandardTemplateParams;)Z
...
.method public isGroupConversation()Z
    ...
    invoke-static {v0}, Landroid/app/Notification$Builder;->access$4400(Landroid/app/Notification$Builder;)Landroid/content/Context;
