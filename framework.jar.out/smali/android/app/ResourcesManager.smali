...
.method public final applyConfigurationToResourcesLocked(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)Z
    ...
    iget-object v8, v1, Landroid/app/ResourcesManager;->mAdjustedDisplays:Landroid/util/ArrayMap;
    ...
    iget-object v9, v1, Landroid/app/ResourcesManager;->mResCompatibilityInfo:Landroid/content/res/CompatibilityInfo;

    if-eqz v9, :cond_2

    iget-object v9, v1, Landroid/app/ResourcesManager;->mResCompatibilityInfo:Landroid/content/res/CompatibilityInfo;

    invoke-virtual {v9, v3}, Landroid/content/res/CompatibilityInfo;->equals(Ljava/lang/Object;)Z
    ...
    :cond_3
    invoke-static {v2, v8, v3}, Landroid/content/res/Resources;->updateSystemConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;Landroid/content/res/CompatibilityInfo;)V
    ...
    const-string v7, "Changing resources "

    invoke-virtual {v15, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v15, v14}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v7, " config to: "
    ...
    :cond_5
    iget v7, v12, Landroid/content/res/ResourcesKey;->mDisplayId:I
    ...
    invoke-virtual {v14, v2, v11, v3}, Landroid/content/res/ResourcesImpl;->updateConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;Landroid/content/res/CompatibilityInfo;)V
    ...
    invoke-virtual {v14}, Landroid/content/res/ResourcesImpl;->getDisplayAdjustments()Landroid/view/DisplayAdjustments;
    ...
    invoke-direct {v4, v5}, Landroid/view/DisplayAdjustments;-><init>(Landroid/view/DisplayAdjustments;)V
    ...
    :goto_4
    invoke-virtual {v1, v7, v4}, Landroid/app/ResourcesManager;->getDisplayMetrics(ILandroid/view/DisplayAdjustments;)Landroid/util/DisplayMetrics;

    move-result-object v5

    if-nez v15, :cond_b

    invoke-static {v5, v9}, Landroid/app/ResourcesManager;->applyNonDefaultDisplayMetricsToConfiguration(Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;)V

    :cond_b
    if-eqz v18, :cond_c

    iget-object v11, v12, Landroid/content/res/ResourcesKey;->mOverrideConfiguration:Landroid/content/res/Configuration;

    invoke-virtual {v9, v11}, Landroid/content/res/Configuration;->updateFrom(Landroid/content/res/Configuration;)I

    :cond_c
    invoke-virtual {v14, v9, v5, v3}, Landroid/content/res/ResourcesImpl;->updateConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;Landroid/content/res/CompatibilityInfo;)V
    ...
    invoke-virtual {v4, v10}, Landroid/util/ArrayMap;->removeAt(I)Ljava/lang/Object;
    :try_end_2
...
.method public dump(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    const-string v2, "resource impls: "
