...
.field private mProjectionAggregationAllowed:Z
...
.method public constructor <init>()V
    ...
    iput-boolean v1, p0, Landroid/database/sqlite/SQLiteQueryBuilder;->mProjectionAggregationAllowed:Z

    const-string v2, ""

    iput-object v2, p0, Landroid/database/sqlite/SQLiteQueryBuilder;->mTables:Ljava/lang/String;
...
.method public computeProjection([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v5, p0, Landroid/database/sqlite/SQLiteQueryBuilder;->mProjectionMap:Ljava/util/Map;
    ...
    iget-boolean v6, p0, Landroid/database/sqlite/SQLiteQueryBuilder;->mProjectionAggregationAllowed:Z
    ...
    invoke-static {v3, v5}, Landroid/database/sqlite/SQLiteQueryBuilder;->maybeWithOperator(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    iget-boolean v6, p0, Landroid/database/sqlite/SQLiteQueryBuilder;->mStrict:Z
    ...
    :cond_2
    invoke-static {v3, v4}, Landroid/database/sqlite/SQLiteQueryBuilder;->maybeWithOperator(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v8, "Allowing abusive custom column: "
    ...
    const-string v8, "SQLiteQueryBuilder"
...
.method public isProjectionAggregationAllowed()Z
    ...
    iget-boolean v0, p0, Landroid/database/sqlite/SQLiteQueryBuilder;->mProjectionAggregationAllowed:Z
...
.method public query(Landroid/database/sqlite/SQLiteDatabase;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    invoke-virtual {p1, v9, v11}, Landroid/database/sqlite/SQLiteDatabase;->validateSql(Ljava/lang/String;Landroid/os/CancellationSignal;)V
...
.method public setProjectionAggregationAllowed(Z)V
    ...
    iput-boolean p1, p0, Landroid/database/sqlite/SQLiteQueryBuilder;->mProjectionAggregationAllowed:Z
