...
.method private cleanupSensorConnection(Landroid/hardware/Sensor;)V
    ...
    const-string v6, "removed trigger listener"
    ...
    const-string v6, "removed event listener"
...
.method private static native nativeNotifyWakeUpFromPowerKey(J)V
.end method

.method private static native nativeSetOperationParameter(JII[F[I)I
.end method

.method private static native nativeSetSensorAccessState(JIZ)V
.end method
...
.method protected configureDirectChannelImpl(Landroid/hardware/SensorDirectChannel;Landroid/hardware/Sensor;I)I
    ...
    const-string v1, "rate parameter invalid"
...
.method protected notifyWakeUpFromPowerKeyImpl()V
    .locals 3
    ...
    invoke-static {v1, v2}, Landroid/hardware/SystemSensorManager;->nativeNotifyWakeUpFromPowerKey(J)V
...
.method protected registerListenerImpl(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;ILandroid/os/Handler;II)Z
    ...
    invoke-static {v0, v3, v4}, Landroid/util/SeempLog;->record_sensor_rate(ILandroid/hardware/Sensor;I)I
    ...
    iget-object v8, v1, Landroid/hardware/SystemSensorManager;->mContext:Landroid/content/Context;
    ...
    const-string v10, "registerListenerImpl sensorName:"
    ...
    const-string v10, ",isWakeUpSensor:"

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual/range {p2 .. p2}, Landroid/hardware/Sensor;->isWakeUpSensor()Z

    move-result v10

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v10, ",callingApp: "
    ...
    const-string v9, "invalid application register pocket or infrared, denied"
    ...
    const-string v10, "Trigger Sensors should use the requestTriggerSensor."
    ...
    :cond_4
    iget-object v9, v1, Landroid/hardware/SystemSensorManager;->mSensorListeners:Ljava/util/HashMap;
    ...
    :try_start_0
    iget-object v11, v1, Landroid/hardware/SystemSensorManager;->mSensorListeners:Ljava/util/HashMap;

    invoke-virtual {v11, v2}, Ljava/util/HashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v11

    check-cast v11, Landroid/hardware/SystemSensorManager$SensorEventQueue;
    ...
    new-instance v14, Landroid/hardware/SystemSensorManager$SensorEventQueue;

    invoke-direct {v14, v2, v12, p0, v13}, Landroid/hardware/SystemSensorManager$SensorEventQueue;-><init>(Landroid/hardware/SensorEventListener;Landroid/os/Looper;Landroid/hardware/SystemSensorManager;Ljava/lang/String;)V

    move-object v11, v14

    invoke-virtual {v11, v3, v4, v5}, Landroid/hardware/SystemSensorManager$SensorEventQueue;->addSensor(Landroid/hardware/Sensor;II)Z

    move-result v14

    if-nez v14, :cond_7

    invoke-virtual {v11}, Landroid/hardware/SystemSensorManager$SensorEventQueue;->dispose()V
    ...
    const-string v9, "register failed, the sensor listeners size has exceeded the maximum limit 128"
    ...
    const-string v10, "maxBatchReportLatencyUs and delayUs should be non-negative"
...
.method protected requestTriggerSensorImpl(Landroid/hardware/TriggerEventListener;Landroid/hardware/Sensor;)Z
    ...
    const-string v1, "request failed, the trigger listeners size has exceeded the maximum limit 128"
...
.method protected setSensorAccessStateImpl(IZ)V
    .locals 3
    ...
    invoke-static {v1, v2, p1, p2}, Landroid/hardware/SystemSensorManager;->nativeSetSensorAccessState(JIZ)V
...
.method protected unregisterListenerImpl(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;)V
    ...
    const-string/jumbo v4, "unregisterListenerImpl sensorName:"
    ...
    const-string v4, ",isWakeUpSensor:"
    ...
    const-string/jumbo v4, "unregisterListenerImpl callingApp: "
