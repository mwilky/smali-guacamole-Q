...
.method public configureStreamsChecked(Landroid/hardware/camera2/params/InputConfiguration;Ljava/util/List;ILandroid/hardware/camera2/CaptureRequest;)Z
    ...
    const-string v5, "cannot configure an input stream without any output streams"
    ...
    :goto_2
    iget-object v0, v1, Landroid/hardware/camera2/impl/CameraDeviceImpl;->mConfiguredOutputs:Landroid/util/SparseArray;
    ...
    invoke-virtual {v12, v13, v14, v15}, Landroid/hardware/camera2/impl/ICameraDeviceUserWrapper;->createInputStream(III)I
    ...
    invoke-direct {v13, v14, v2}, Ljava/util/AbstractMap$SimpleEntry;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {v14, v15}, Landroid/util/SparseArray;->delete(I)V
    ...
    invoke-virtual {v14, v13}, Landroid/hardware/camera2/impl/ICameraDeviceUserWrapper;->createStream(Landroid/hardware/camera2/params/OutputConfiguration;)I

    move-result v14

    iget-object v15, v1, Landroid/hardware/camera2/impl/CameraDeviceImpl;->mConfiguredOutputs:Landroid/util/SparseArray;
    ...
    :cond_d
    iget v12, v1, Landroid/hardware/camera2/impl/CameraDeviceImpl;->customOpMode:I
    :try_end_3
    ...
    invoke-virtual {v11, v3, v12}, Landroid/hardware/camera2/impl/ICameraDeviceUserWrapper;->endConfigure(ILandroid/hardware/camera2/impl/CameraMetadataNative;)V
    ...
    invoke-virtual {v12, v3, v11}, Landroid/hardware/camera2/impl/ICameraDeviceUserWrapper;->endConfigure(ILandroid/hardware/camera2/impl/CameraMetadataNative;)V
    :try_end_4
    ...
    iget-object v10, v1, Landroid/hardware/camera2/impl/CameraDeviceImpl;->mCallOnIdle:Ljava/lang/Runnable;
    ...
    iget-object v10, v1, Landroid/hardware/camera2/impl/CameraDeviceImpl;->mCallOnUnconfigured:Ljava/lang/Runnable;
    ...
    const-string v11, "The camera is currently busy. You must wait until the previous operation completes."
