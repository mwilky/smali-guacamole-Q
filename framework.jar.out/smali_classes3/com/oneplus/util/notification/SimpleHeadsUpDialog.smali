...
.field private static final SHADOW_COLOR:I = 0x61000000
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->mShadowOffsetY:I
...
.method private handleHide(Landroid/view/View;)V
    ...
    iput-object v1, p0, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->mCurrentEntry:Lcom/oneplus/util/notification/SimpleHeadsUpController$Entry;
...
.method private handleShow(Lcom/oneplus/util/notification/SimpleHeadsUpController$Entry;)V
    ...
    const-string v1, "SimpleHeadsUpDialog"
    ...
    const-string v0, "Showing simple heads-up dialog window"
    ...
    invoke-direct {v0, p0, v2}, Lcom/oneplus/util/notification/SimpleHeadsUpDialog$ContentWindowView;-><init>(Lcom/oneplus/util/notification/SimpleHeadsUpDialog;Landroid/content/Context;)V
    ...
    iget-object v2, p0, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->mWindowManager:Landroid/view/WindowManager;

    iget-object v3, p0, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->mContentWindow:Lcom/oneplus/util/notification/SimpleHeadsUpDialog$ContentWindowView;
    ...
    invoke-virtual {v0, v2, v3}, Lcom/oneplus/util/notification/SimpleHeadsUpDialog$ContentWindowView;->setTimeOut(J)V
    ...
    :cond_4
    const-string v4, "Get simple heads-up container layout params fail."
    ...
    invoke-virtual {v1, v4, v5}, Lcom/oneplus/util/notification/SimpleHeadsUpDialog$ContentWindowView;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method private recreateIcon(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    iget v2, p0, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->mShadowOffsetY:I
...
.method private updateEntryView(Lcom/oneplus/util/notification/SimpleHeadsUpController$Entry;Landroid/content/Context;Z)V
    .locals 12
    ...
    :cond_0
    invoke-direct {p0, v1}, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->drawableToBitmap(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    iget v8, p0, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->mShadowOffsetY:I
    ...
    iget v9, p0, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->mShadowOffsetY:I
    ...
    iget v7, p0, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->mShadowOffsetY:I
...
.method public hide(Landroid/view/View;J)V
    ...
    const-string v1, "hide notifications, delay = "
...
.method public hideFromPackage(Ljava/lang/String;)V
    ...
    const-string v1, "hideFromPackage: "
    ...
    const-string v0, "hideFromPackage: mContentWindow is null"
    ...
    invoke-virtual {v3, v2}, Lcom/oneplus/util/notification/SimpleHeadsUpDialog$ContentWindowView;->getChildAt(I)Landroid/view/View;
    ...
    sget-boolean v3, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->DEBUG_ONEPLUS:Z
    ...
    invoke-virtual {p0, v3, v4, v5}, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->hide(Landroid/view/View;J)V
...
.method public show(Landroid/service/notification/StatusBarNotification;ZI)V
    .locals 7
    ...
    const-string/jumbo v4, "show notification: "
    ...
    const-string v4, "SimpleHeadsUpDialog"
    ...
    :goto_2
    iget-object v5, p0, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->mContext:Landroid/content/Context;
    ...
    new-instance v6, Lcom/oneplus/util/notification/SimpleHeadsUpController$Entry;

    invoke-direct {v6, p1, p2, v5}, Lcom/oneplus/util/notification/SimpleHeadsUpController$Entry;-><init>(Landroid/service/notification/StatusBarNotification;ZLandroid/view/View;)V

    iput-object v6, p0, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->mCurrentEntry:Lcom/oneplus/util/notification/SimpleHeadsUpController$Entry;

    goto :goto_3

    :cond_4
    iget-object v4, p0, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->mCurrentEntry:Lcom/oneplus/util/notification/SimpleHeadsUpController$Entry;

    invoke-virtual {v4}, Lcom/oneplus/util/notification/SimpleHeadsUpController$Entry;->getView()Landroid/view/View;

    move-result-object v5

    invoke-virtual {v4, p1, p2, v5}, Lcom/oneplus/util/notification/SimpleHeadsUpController$Entry;->updateEntry(Landroid/service/notification/StatusBarNotification;ZLandroid/view/View;)V
    ...
    :cond_5
    invoke-direct {p0, v4, v5, v2}, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->updateEntryView(Lcom/oneplus/util/notification/SimpleHeadsUpController$Entry;Landroid/content/Context;Z)V
    ...
    invoke-virtual {v1, v3}, Lcom/oneplus/util/notification/SimpleHeadsUpDialog$H;->removeMessages(I)V

    iget-object v1, p0, Lcom/oneplus/util/notification/SimpleHeadsUpDialog;->mHandler:Lcom/oneplus/util/notification/SimpleHeadsUpDialog$H;

    const/4 v2, 0x4

    invoke-virtual {v1, v2}, Lcom/oneplus/util/notification/SimpleHeadsUpDialog$H;->removeMessages(I)V
    ...
    :cond_7
    invoke-virtual {v3}, Lcom/oneplus/util/notification/SimpleHeadsUpDialog$ContentWindowView;->getTimeOut()J

    move-result-wide v3

    :goto_4
    invoke-virtual {v1, v2, v3, v4}, Lcom/oneplus/util/notification/SimpleHeadsUpDialog$H;->sendEmptyMessageDelayed(IJ)Z
