...
.method private logBootEvents(Landroid/content/Context;)V
    ...
    const-string v5, "Boot info:\n"

    invoke-virtual {v3, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v5, "Last boot reason: "
    ...
    invoke-virtual {v14, v0}, Lnet/oneplus/odm/OpDeviceManagerInjector;->preserveRebootReason(Landroid/content/Context;)V

    const-wide/16 v2, 0x0

    const-string/jumbo v4, "ro.runtime.firstboot"
    ...
    invoke-virtual {v1, v2, v9}, Landroid/os/DropBoxManager;->addText(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v5, "/cache/recovery/last_kmsg"

    const-string v7, "SYSTEM_RECOVERY_KMSG"
    ...
    invoke-static {v1, v13, v9, v2, v3}, Lcom/android/server/BootReceiver;->addAuditErrorsToDropBox(Landroid/os/DropBoxManager;Ljava/util/HashMap;Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-static {v1, v13, v9, v2, v3}, Lcom/android/server/BootReceiver;->addFsckErrorsToDropBoxAndLogFsStat(Landroid/os/DropBoxManager;Ljava/util/HashMap;Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {v15, v13}, Lcom/android/server/BootReceiver;->writeTimestamps(Ljava/util/HashMap;)V

    new-instance v16, Lcom/android/server/BootReceiver$2;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/BootReceiver$2;-><init>(Lcom/android/server/BootReceiver;Ljava/lang/String;ILandroid/os/DropBoxManager;Ljava/lang/String;)V

    sput-object v16, Lcom/android/server/BootReceiver;->sTombstoneObserver:Landroid/os/FileObserver;
