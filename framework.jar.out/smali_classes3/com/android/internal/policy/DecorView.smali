...
.method private calculateNavigationBarColor()I
    ...
    iget v6, p0, Lcom/android/internal/policy/DecorView;->mSemiTransparentBarColor:I

    iget-object v0, p0, Lcom/android/internal/policy/DecorView;->mWindow:Lcom/android/internal/policy/PhoneWindow;

    iget v7, v0, Lcom/android/internal/policy/PhoneWindow;->mNavigationBarColor:I
    ...
    const-string v5, "calNavBarColor: color="
    ...
    const-string v5, ", mSemiTransparentBarColor="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v5, p0, Lcom/android/internal/policy/DecorView;->mSemiTransparentBarColor:I
    ...
    const-string v5, ", scrimTrans="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v5, p0, Lcom/android/internal/policy/DecorView;->mWindow:Lcom/android/internal/policy/PhoneWindow;

    iget-boolean v5, v5, Lcom/android/internal/policy/PhoneWindow;->mEnsureNavigationBarContrastWhenTransparent:Z
...
.method onResourcesLoaded(Landroid/view/LayoutInflater;I)V
    ...
    const-string v2, "checkDecorLayout"
    ...
    invoke-virtual {v2, v3, p2}, Lcom/oneplus/embryo/EmbryoApp;->checkDecorLayout(Landroid/content/Context;I)Landroid/view/View;
    ...
    const-string v3, "checkDecorLayout_fail"
    ...
    invoke-virtual {p0, v0, v3}, Lcom/android/internal/policy/DecorView;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v0, v2, v3}, Lcom/android/internal/widget/DecorCaptionView;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {p0, v2, v0, v3}, Lcom/android/internal/policy/DecorView;->addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
...
.method public onWindowFocusChangedFromViewRoot(Z)V
    ...
    const-string v1, "onWindowFocusChangedFromViewRoot hasFocus: "
...
.method updateColorViews(Landroid/view/WindowInsets;Z)Landroid/view/WindowInsets;
    ...
    invoke-virtual {v1}, Lcom/android/internal/policy/PhoneWindow;->isForcedNavigationBarColor()Z

    move-result v1

    if-nez v1, :cond_f

    iget-object v1, v11, Lcom/android/internal/policy/DecorView;->mContext:Landroid/content/Context;
    ...
    invoke-static {v1, v2, v10}, Landroid/provider/Settings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    const-string v3, " DecorView set IME navigation bar color to black."
