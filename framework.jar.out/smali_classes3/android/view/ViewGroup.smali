...
.field private mViewGroupInjector:Landroid/view/ViewGroupInjector;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    new-instance v0, Landroid/view/ViewGroupInjector;

    invoke-direct {v0}, Landroid/view/ViewGroupInjector;-><init>()V

    iput-object v0, p0, Landroid/view/ViewGroup;->mViewGroupInjector:Landroid/view/ViewGroupInjector;
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, v0, Landroid/view/ViewGroup;->mLongshotUtils:Lcom/oneplus/longshot/LongshotUtil;

    if-eqz v3, :cond_2e

    invoke-virtual/range {p0 .. p0}, Landroid/view/ViewGroup;->isGeneralScrollView()Z

    move-result v3

    if-nez v3, :cond_2e

    iget-object v3, v0, Landroid/view/ViewGroup;->mViewGroupInjector:Landroid/view/ViewGroupInjector;

    invoke-virtual/range {p0 .. p0}, Landroid/view/ViewGroup;->getLongshotUtils()Lcom/oneplus/longshot/LongshotUtil;

    move-result-object v4

    invoke-virtual {v3, v0, v4}, Landroid/view/ViewGroupInjector;->updateLastItem(Landroid/view/ViewGroup;Lcom/oneplus/longshot/LongshotUtil;)V
