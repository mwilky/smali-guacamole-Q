...
.method private static createAnimationFromXml(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/view/animation/AnimationSet;Landroid/util/AttributeSet;)Landroid/view/animation/Animation;
    ...
    :cond_7
    sget-boolean v4, Landroid/view/animation/OpAnimationInjector;->IS_ONEPLUS_ANIMATION_ENABLED:Z

    if-eqz v4, :cond_a

    invoke-static {v2, p0, p3}, Landroid/view/animation/OpAnimationInjector;->getOpAnimationFromString(Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/animation/Animation;
    ...
    const-string v6, "Unknown opAnimation name: "
