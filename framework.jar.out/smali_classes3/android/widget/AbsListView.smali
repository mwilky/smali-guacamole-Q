...
.field private static final MOVE_TOUCH_MIN_VENDOR:I = 0x4

.field private static final MOVE_TOUCH_SLOP:D = 0.6

.field private static final MOVE_TOUCH_SLOP_VENDOR:D = 1.0

.field private static ONEPLUS_OPTS_INPUT:Z = false
...
.field private static final TOUCH_SLOP_MIN_VENDOR:D = 0.1
...
.method static constructor <clinit>()V
    ...
    const-string v1, "debug.vendor.oneplus.flingopts.enable"

    invoke-static {v1, v0}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v1

    sput-boolean v1, Landroid/widget/AbsListView;->ONEPLUS_OPTS_INPUT:Z

    sget-boolean v1, Landroid/widget/AbsListView;->ONEPLUS_OPTS_INPUT:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Landroid/widget/AbsListView;->mIsCts:Z
...
.method private initAbsListView()V
    ...
    const-string v2, "android.widget.cts"
    ...
    iget-boolean v1, p0, Landroid/widget/AbsListView;->mIsCts:Z
    ...
    :goto_1
    iget v1, p0, Landroid/widget/AbsListView;->mMoveAcceleration:I

    const/4 v2, 0x4

    if-ge v1, v2, :cond_9

    iput v2, p0, Landroid/widget/AbsListView;->mMoveAcceleration:I
...
.method private startScrollIfNeeded(IILandroid/view/MotionEvent;)Z
    ...
    :cond_4
    sget-boolean v6, Landroid/widget/AbsListView;->ONEPLUS_OPTS_INPUT:Z

    if-eqz v6, :cond_a

    iget-boolean v6, p0, Landroid/widget/AbsListView;->mIsCts:Z
    ...
    :cond_5
    iget-boolean v8, p0, Landroid/widget/AbsListView;->mIsFirstTouchMoveEvent:Z

    if-nez v8, :cond_8

    sget-boolean v8, Landroid/widget/AbsListView;->ONEPLUS_OPTS_INPUT:Z
    ...
    :cond_8
    :goto_4
    iget v8, p0, Landroid/widget/AbsListView;->mMoveAcceleration:I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_d
    sget-boolean v5, Landroid/widget/AbsListView;->OPTS_INPUT:Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    sget-boolean v0, Landroid/widget/AbsListView;->OPTS_INPUT:Z
