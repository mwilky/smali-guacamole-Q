...
.method protected layoutChildren()V
    ...
    iput-boolean v10, v7, Landroid/widget/ListView;->mBlockLayoutRequests:Z
    ...
    iget v15, v7, Landroid/widget/ListView;->mFirstPosition:I
    ...
    iget v15, v7, Landroid/widget/ListView;->mSelectedPosition:I
    ...
    iget v0, v7, Landroid/widget/ListView;->mNextSelectedPosition:I

    invoke-virtual {v7, v0}, Landroid/widget/ListView;->setSelectedPositionInt(I)V
    ...
    invoke-virtual/range {v21 .. v21}, Landroid/view/ViewRootImpl;->getAccessibilityFocusedHost()Landroid/view/View;

    move-result-object v3

    if-eqz v3, :cond_f

    invoke-virtual {v7, v3}, Landroid/widget/ListView;->getAccessibilityFocusedChild(Landroid/view/View;)Landroid/view/View;
    ...
    iget-boolean v5, v7, Landroid/widget/ListView;->mAdapterHasStableIds:Z
    ...
    invoke-virtual/range {v21 .. v21}, Landroid/view/ViewRootImpl;->getAccessibilityFocusedVirtualView()Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    :cond_14
    invoke-virtual {v3, v13, v4}, Landroid/widget/AbsListView$RecycleBin;->fillActiveViews(II)V
    ...
    invoke-direct {v7, v1, v12}, Landroid/widget/ListView;->fillUp(II)Landroid/view/View;
    ...
    invoke-direct {v7, v1, v11, v12}, Landroid/widget/ListView;->fillFromSelection(III)Landroid/view/View;
    ...
    :cond_16
    invoke-direct {v7, v11, v12}, Landroid/widget/ListView;->fillFromMiddle(II)Landroid/view/View;
    ...
    iput v10, v7, Landroid/widget/ListView;->mFirstPosition:I

    invoke-direct {v7, v11}, Landroid/widget/ListView;->fillFromTop(I)Landroid/view/View;
    ...
    invoke-virtual {v7, v10, v9}, Landroid/widget/ListView;->lookForSelectablePosition(IZ)I
    ...
    invoke-virtual {v7, v1, v10}, Landroid/widget/ListView;->lookForSelectablePosition(IZ)I
    ...
    invoke-direct {v7, v2, v12}, Landroid/widget/ListView;->fillUp(II)Landroid/view/View;
    ...
    :cond_1c
    invoke-direct {v7, v10, v11}, Landroid/widget/ListView;->fillSpecific(II)Landroid/view/View;

    move-result-object v1

    :goto_8
    invoke-virtual {v14}, Landroid/widget/AbsListView$RecycleBin;->scrapActiveViews()V
    ...
    :cond_29
    iput v10, v7, Landroid/widget/ListView;->mSelectedTop:I
    ...
    invoke-virtual/range {v23 .. v23}, Landroid/view/accessibility/AccessibilityNodeInfo;->getSourceNodeId()J
    ...
    invoke-virtual {v2, v6, v9, v4}, Landroid/view/accessibility/AccessibilityNodeProvider;->performAction(IILandroid/os/Bundle;)Z
    ...
    invoke-static {v2, v10, v6}, Landroid/util/MathUtils;->constrain(III)I
    ...
    invoke-virtual/range {v24 .. v24}, Landroid/view/View;->getWindowToken()Landroid/os/IBinder;

    move-result-object v2

    if-eqz v2, :cond_2e

    invoke-virtual/range {v24 .. v24}, Landroid/view/View;->dispatchFinishTemporaryDetach()V

    :cond_2e
    iput v10, v7, Landroid/widget/ListView;->mLayoutMode:I

    iput-boolean v10, v7, Landroid/widget/ListView;->mDataChanged:Z
    ...
    iput-object v4, v7, Landroid/widget/ListView;->mPositionScrollAfterLayout:Ljava/lang/Runnable;

    :cond_2f
    iput-boolean v10, v7, Landroid/widget/ListView;->mNeedSync:Z
    ...
    iget-object v3, v7, Landroid/widget/ListView;->mAdapter:Landroid/widget/ListAdapter;
    ...
    iget-object v0, v7, Landroid/widget/ListView;->mAdapter:Landroid/widget/ListAdapter;
