...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    invoke-static {v1}, Landroid/widget/Magnifier;->createBuilderWithOldMagnifierDefaults(Landroid/view/View;)Landroid/widget/Magnifier$Builder;

    move-result-object v1

    invoke-virtual {v1}, Landroid/widget/Magnifier$Builder;->build()Landroid/widget/Magnifier;

    move-result-object v1

    new-instance v2, Landroid/widget/Editor$MagnifierMotionAnimator;

    invoke-direct {v2, v1, v0}, Landroid/widget/Editor$MagnifierMotionAnimator;-><init>(Landroid/widget/Magnifier;Landroid/widget/Editor$1;)V

    iput-object v2, p0, Landroid/widget/Editor;->mMagnifierAnimator:Landroid/widget/Editor$MagnifierMotionAnimator;
...
.method static synthetic access$4500(Landroid/widget/Editor;)Landroid/widget/SelectionActionModeHelper;
    .locals 1
...
.method static synthetic access$4602(Landroid/widget/Editor;Z)Z
    .locals 0
...
.method static synthetic access$4800(Landroid/widget/Editor;Landroid/graphics/drawable/Drawable;F)I
    .locals 1
...
.method static synthetic access$4900(Landroid/widget/Editor;)Landroid/view/inputmethod/InputMethodManager;
    .locals 1
...
.method static synthetic access$5900(Landroid/widget/Editor;Landroid/view/MotionEvent;)V
    .locals 0
...
.method static synthetic access$6100(Landroid/widget/Editor;)Ljava/lang/Runnable;
    .locals 1
...
.method static synthetic access$6102(Landroid/widget/Editor;Ljava/lang/Runnable;)Ljava/lang/Runnable;
    .locals 0
...
.method static synthetic access$6200(Landroid/widget/Editor;)I
    .locals 1
...
.method static synthetic access$6300(Landroid/widget/Editor;)Z
    .locals 1
...
.method static synthetic access$6600(Landroid/widget/Editor;I)I
    .locals 1
...
.method static synthetic access$6700(Landroid/widget/Editor;I)I
    .locals 1
...
.method static synthetic access$6800(Landroid/widget/Editor;)Landroid/text/method/WordIterator;
    .locals 1
...
.method static synthetic access$6900(Landroid/widget/Editor;IZ)I
    .locals 1
...
.method static synthetic access$7600(Landroid/widget/Editor;II)J
    .locals 2
...
.method private drawHardwareAcceleratedInner(Landroid/graphics/Canvas;Landroid/text/Layout;Landroid/graphics/Path;Landroid/graphics/Paint;I[I[IIII)I
    ...
    invoke-virtual {v12, v0, v3}, Landroid/graphics/RenderNode;->beginRecording(II)Landroid/graphics/RecordingCanvas;
    ...
    :try_start_0
    invoke-virtual {v3, v0, v7}, Landroid/graphics/RecordingCanvas;->translate(FF)V

    invoke-virtual {v2, v3, v5, v4}, Landroid/text/Layout;->drawText(Landroid/graphics/Canvas;II)V
    ...
    :goto_6
    invoke-virtual {v12, v6, v13, v15, v14}, Landroid/graphics/RenderNode;->setLeftTopRightBottom(IIII)Z
...
.method public synthetic lambda$startActionModeInternal$0$Editor()V
    .locals 0
...
.method loadHandleDrawables(Z)V
    ...
    invoke-static {v0}, Landroid/widget/Editor$InsertionPointCursorController;->access$7700(Landroid/widget/Editor$InsertionPointCursorController;)V
    ...
    invoke-static {v0}, Landroid/widget/Editor$SelectionModifierCursorController;->access$7800(Landroid/widget/Editor$SelectionModifierCursorController;)V
