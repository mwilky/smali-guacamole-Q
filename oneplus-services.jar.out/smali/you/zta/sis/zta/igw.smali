...
# instance fields
.field final synthetic WCa:Z

.field final synthetic XCa:Z
...
.method constructor <init>(Lyou/zta/sis/zta/wtn;ZZ)V
    ...
    iput-boolean p2, p0, Lyou/zta/sis/zta/igw;->WCa:Z

    iput-boolean p3, p0, Lyou/zta/sis/zta/igw;->XCa:Z
...
.method public zta(Lyou/zta/sis/zta/ugm;)Lyou/zta/sis/zta/ugm;
    ...
    :cond_1
    invoke-virtual {p1}, Lyou/zta/sis/zta/oxb;->Ak()Z
    ...
    iget-boolean v0, p0, Lyou/zta/sis/zta/igw;->WCa:Z

    if-nez v0, :cond_3

    iget-object v0, p0, Lyou/zta/sis/zta/igw;->this$0:Lyou/zta/sis/zta/wtn;

    invoke-virtual {v0}, Lyou/zta/sis/zta/wtn;->ok()Z

    move-result v0

    if-nez v0, :cond_3

    invoke-virtual {p1}, Lyou/zta/sis/zta/oxb;->Dk()V
    ...
    :cond_4
    iget-boolean v0, p0, Lyou/zta/sis/zta/igw;->XCa:Z

    if-eqz v0, :cond_6

    invoke-virtual {p1}, Lyou/zta/sis/zta/oxb;->Bk()Z
    ...
    :cond_5
    invoke-virtual {p1}, Lyou/zta/sis/zta/oxb;->Ek()V
