...
.field private static final Qc:I = 0x400

.field private static Rc:Z = false

.field private static Sc:Landroid/util/ArrayMap; = null
...
.field private static final Uc:I = 0x3
...
.field private Pc:Lcom/android/server/zgw$zta;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/zgw;->Rc:Z

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, Lcom/android/server/zgw;->Sc:Landroid/util/ArrayMap;
...
.method private constructor <init>()V
    ...
    iput v0, p0, Lcom/android/server/zgw;->Lc:I

    const-wide/32 v0, 0x100000

    iput-wide v0, p0, Lcom/android/server/zgw;->Mc:J

    const v0, 0x493e0

    iput v0, p0, Lcom/android/server/zgw;->Nc:I

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/server/zgw;->Oc:Z
    ...
    iput-object v0, p0, Lcom/android/server/zgw;->Pc:Lcom/android/server/zgw$zta;
...
.method static synthetic access$100()Landroid/util/ArrayMap;
    ...
    sget-object v0, Lcom/android/server/zgw;->Sc:Landroid/util/ArrayMap;
...
.method private dump()V
    ...
    iget v1, p0, Lcom/android/server/zgw;->Nc:I
    ...
    iget v1, p0, Lcom/android/server/zgw;->Lc:I
    ...
    iget-wide v1, p0, Lcom/android/server/zgw;->Mc:J
    ...
    sget-object p0, Lcom/android/server/zgw;->Sc:Landroid/util/ArrayMap;
    ...
    sget-object v2, Lcom/android/server/zgw;->Sc:Landroid/util/ArrayMap;
...
.method private il()V
    ...
    sget-boolean v1, Lcom/android/server/zgw;->Rc:Z
    ...
    iget-object v2, p0, Lcom/android/server/zgw;->Pc:Lcom/android/server/zgw$zta;

    invoke-virtual {v2, v1}, Landroid/os/Handler;->removeMessages(I)V

    iget-object v1, p0, Lcom/android/server/zgw;->Pc:Lcom/android/server/zgw$zta;

    iget p0, p0, Lcom/android/server/zgw;->Lc:I
...
.method private jl()V
    ...
    sget-object v5, Lcom/android/server/zgw;->Sc:Landroid/util/ArrayMap;
    ...
    :cond_0
    sget-object v3, Lcom/android/server/zgw;->Sc:Landroid/util/ArrayMap;
    ...
    sget-object v7, Lcom/android/server/zgw;->Sc:Landroid/util/ArrayMap;
    ...
    sput-boolean v4, Lcom/android/server/zgw;->Rc:Z

    goto :goto_1

    :cond_5
    invoke-direct {p0}, Lcom/android/server/zgw;->il()V
...
.method public static w()Landroid/util/ArrayMap;
    ...
    sget-object v1, Lcom/android/server/zgw;->Sc:Landroid/util/ArrayMap;
...
.method static synthetic you(Lcom/android/server/zgw;I)I
    ...
    iput p1, p0, Lcom/android/server/zgw;->Lc:I
...
.method static synthetic you(Lcom/android/server/zgw;J)J
    ...
    iput-wide p1, p0, Lcom/android/server/zgw;->Mc:J
...
.method static synthetic zta(Lcom/android/server/zgw;I)I
    ...
    iput p1, p0, Lcom/android/server/zgw;->Nc:I
...
.method static synthetic zta(Lcom/android/server/zgw;)V
    ...
    invoke-direct {p0}, Lcom/android/server/zgw;->jl()V
...
.method public bio(I)V
    ...
    iget-object p0, p0, Lcom/android/server/zgw;->Pc:Lcom/android/server/zgw$zta;
...
.method public schedulePerformPoll()V
    ...
    :cond_0
    sget-boolean v0, Lcom/android/server/zgw;->Rc:Z
...
.method public x()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/zgw;->Oc:Z
