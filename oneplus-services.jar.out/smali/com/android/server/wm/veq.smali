...
# static fields
.field private static OS:Ljava/lang/Object; = null

.field private static final PS:Ljava/lang/String; = "Quick_Reply_Config"

.field public static final RS:F = 0.4f
...
.field public static final VS:I = 0x1

.field public static final WS:I = 0x2

.field public static final XS:I = 0x30a

.field public static final YS:I = 0x60

.field public static final ZS:I = 0x54

.field public static final _S:I = 0x2a

.field public static final aT:I = 0x3c

.field public static final bT:I = 0x30
...
.field public static final iT:I = 0x28

.field public static final jT:I = 0x28

.field public static final kT:I = 0x28

.field public static lT:I = 0x0

.field public static mT:I = 0x0

.field public static nT:I = 0x0

.field public static final oT:I = 0x12c

.field public static final pT:I = 0x64
...
.field private static final sT:Ljava/util/List;
...
.field private static final tT:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field public static uT:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field public static vT:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
# instance fields
.field private AS:Lcom/oneplus/config/ConfigObserver;
...
.field private final ES:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field MS:Landroid/widget/FrameLayout;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/wm/veq;->OS:Ljava/lang/Object;
    ...
    sput v0, Lcom/android/server/wm/veq;->SS:I
    ...
    sput v0, Lcom/android/server/wm/veq;->lT:I

    sput v0, Lcom/android/server/wm/veq;->mT:I
    ...
    sput-object v0, Lcom/android/server/wm/veq;->tT:Ljava/util/List;
    ...
    sput-object v0, Lcom/android/server/wm/veq;->uT:Ljava/util/List;
    ...
    sput-object v0, Lcom/android/server/wm/veq;->vT:Ljava/util/List;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/wm/veq;->ES:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/veq;->FS:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/server/wm/veq;->GS:Ljava/util/List;
...
.method private Ga(Z)V
    ...
    sput p1, Lcom/android/server/wm/veq;->nT:I
    ...
    sput p0, Lcom/android/server/wm/veq;->nT:I
    ...
    sget p1, Lcom/android/server/wm/veq;->nT:I
...
.method private Gb(I)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/veq;->IS:Landroid/view/View;
    ...
    sget v0, Lcom/android/server/wm/veq;->SS:I
    ...
    iput-object p1, p0, Lcom/android/server/wm/veq;->IS:Landroid/view/View;
    ...
    iput-object p1, p0, Lcom/android/server/wm/veq;->MS:Landroid/widget/FrameLayout;

    iget-object p1, p0, Lcom/android/server/wm/veq;->MS:Landroid/widget/FrameLayout;
...
.method private Hb(I)V
    ...
    iget-object p0, p0, Lcom/android/server/wm/veq;->FS:Ljava/util/ArrayList;
...
.method private Ib(I)V
    ...
    iget-object p0, p0, Lcom/android/server/wm/veq;->IS:Landroid/view/View;
...
.method private Ip()V
    ...
    iget-object v3, p0, Lcom/android/server/wm/veq;->HS:Landroid/view/View;
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/server/wm/veq;->KS:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/server/wm/veq;->KS:Landroid/view/View;
    ...
    iget-object v1, p0, Lcom/android/server/wm/veq;->KS:Landroid/view/View;
...
.method private Np()V
    ...
    iget-object v5, p0, Lcom/android/server/wm/veq;->ES:Landroid/util/ArrayMap;
...
.method private Op()V
    ...
    iget-object v2, p0, Lcom/android/server/wm/veq;->HS:Landroid/view/View;

    invoke-interface {v0, v2}, Landroid/view/WindowManager;->removeView(Landroid/view/View;)V

    :cond_0
    iput-object v1, p0, Lcom/android/server/wm/veq;->HS:Landroid/view/View;
    ...
    iget-object v2, p0, Lcom/android/server/wm/veq;->KS:Landroid/view/View;

    invoke-interface {v0, v2}, Landroid/view/WindowManager;->removeView(Landroid/view/View;)V

    :cond_4
    iput-object v1, p0, Lcom/android/server/wm/veq;->KS:Landroid/view/View;
...
.method private Rp()V
    ...
    sput v2, Lcom/android/server/wm/veq;->lT:I

    invoke-static {v1}, Ljava/lang/Math;->round(F)I

    move-result v2

    sput v2, Lcom/android/server/wm/veq;->mT:I
    ...
    sput v2, Lcom/android/server/wm/veq;->nT:I
    ...
    sget v1, Lcom/android/server/wm/veq;->fT:I
...
.method private Sp()V
    ...
    sget v1, Lcom/android/server/wm/veq;->SS:I
    ...
    sget v3, Lcom/android/server/wm/veq;->hT:I
    ...
    sget v4, Lcom/android/server/wm/veq;->hT:I
...
.method private Tp()V
    ...
    sget v4, Lcom/android/server/wm/veq;->lT:I
    ...
    sget v5, Lcom/android/server/wm/veq;->eT:I
    ...
    iput v1, p0, Lcom/android/server/wm/veq;->DS:I
    ...
    iget v2, p0, Lcom/android/server/wm/veq;->CS:I
    ...
    sget v3, Lcom/android/server/wm/veq;->mT:I
    ...
    iget v1, p0, Lcom/android/server/wm/veq;->DS:I
    ...
    iput v3, p0, Lcom/android/server/wm/veq;->DS:I
    ...
    iput v2, p0, Lcom/android/server/wm/veq;->DS:I

    :cond_8
    :goto_0
    iget v1, p0, Lcom/android/server/wm/veq;->BS:I
    ...
    sget v3, Lcom/android/server/wm/veq;->nT:I
...
.method private bio(Lorg/json/JSONArray;)V
    ...
    :cond_5
    sget-object p1, Lcom/android/server/wm/veq;->OS:Ljava/lang/Object;
    ...
    sput-object p0, Lcom/android/server/wm/veq;->uT:Ljava/util/List;
...
.method private gc(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/wm/veq;->uT:Ljava/util/List;
...
.method static synthetic sis(Lcom/android/server/wm/veq;I)I
    ...
    iput p1, p0, Lcom/android/server/wm/veq;->BS:I
...
.method static synthetic ugm(Lcom/android/server/wm/veq;)I
    ...
    iget p0, p0, Lcom/android/server/wm/veq;->DS:I
...
.method static synthetic you(Lcom/android/server/wm/veq;)Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Lcom/android/server/wm/veq;->ES:Landroid/util/ArrayMap;
...
.method static synthetic zta(Lcom/android/server/wm/veq;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/veq;->bio(Lorg/json/JSONArray;)V
...
.method private zta(Lcom/android/server/wm/WindowState;)Z
    ...
    sget v0, Lcom/android/server/wm/veq;->rT:I
...
.method private zta(Ljava/lang/String;Lcom/android/server/wm/WindowState;)Z
    ...
    sget v2, Lcom/android/server/wm/veq;->qT:I
...
.method public bootComplete()V
    ...
    iget-object v0, p0, Lcom/android/server/wm/veq;->AS:Lcom/oneplus/config/ConfigObserver;
    ...
    iget-object v3, p0, Lcom/android/server/wm/veq;->vS:Lcom/android/server/wm/veq$zta;
    ...
    iput-object v0, p0, Lcom/android/server/wm/veq;->AS:Lcom/oneplus/config/ConfigObserver;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/wm/veq;->bio(Lorg/json/JSONArray;)V
...
.method public getImBound()Landroid/graphics/Rect;
    ...
    sget v2, Lcom/android/server/wm/veq;->SS:I
    ...
    sget v1, Lcom/android/server/wm/veq;->nT:I
...
.method public getQuickReplyList(I)Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/wm/veq;->uT:Ljava/util/List;

    :cond_1
    return-object v1

    :cond_2
    sget-object p0, Lcom/android/server/wm/veq;->tT:Ljava/util/List;
...
.method public isInCameraActivityList(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/wm/veq;->vT:Ljava/util/List;
...
.method public isQuickReplyIM(Ljava/lang/String;)Z
    ...
    sget-object v0, Lcom/android/server/wm/veq;->sT:Ljava/util/List;
    ...
    sget-object v0, Lcom/android/server/wm/veq;->tT:Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/server/wm/veq;->GS:Ljava/util/List;
...
.method public notifyImeShow(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/veq;->ES:Landroid/util/ArrayMap;
...
.method public notifyImeVisibilityChanged(ZI)V
    ...
    sget v0, Lcom/android/server/wm/veq;->nT:I
...
.method public systemReady()V
    ...
    iput v0, p0, Lcom/android/server/wm/veq;->BS:I
...
.method public updateIMEFrameIfNeeded(Ljava/lang/String;Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    sget p2, Lcom/android/server/wm/veq;->SS:I
    ...
    sget p2, Lcom/android/server/wm/veq;->eT:I
