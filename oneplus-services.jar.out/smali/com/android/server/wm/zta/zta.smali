...
.field private static final xb:F = 0.6f

.field public static final yb:J = 0x12cL

.field private static final zb:Landroid/view/animation/Interpolator;


# instance fields
.field private final gb:F

.field private final hb:F

.field private final ib:J

.field private final jb:J
...
.field private final ob:Landroid/graphics/Rect;

.field private final pb:Landroid/graphics/Rect;

.field private qb:Landroid/graphics/RectF;
...
.field private sb:Lcom/android/server/wm/zta/zta$zta;

.field private tb:Lcom/android/server/wm/zta/zta$zta;

.field private ub:Lcom/android/server/wm/zta/zta$zta;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/wm/zta/zta;->zb:Landroid/view/animation/Interpolator;
    ...
    sput-object v1, Lcom/android/server/wm/zta/zta;->Ab:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/graphics/Rect;Landroid/graphics/Rect;F)V
    ...
    iput v0, p0, Lcom/android/server/wm/zta/zta;->gb:F
    ...
    iput-wide v0, p0, Lcom/android/server/wm/zta/zta;->ib:J

    const-wide/16 v0, 0xf0

    iput-wide v0, p0, Lcom/android/server/wm/zta/zta;->jb:J

    const-wide/16 v0, 0x78

    iput-wide v0, p0, Lcom/android/server/wm/zta/zta;->kb:J

    const-wide/16 v0, 0x32

    iput-wide v0, p0, Lcom/android/server/wm/zta/zta;->lb:J

    const-wide/16 v0, 0x28

    iput-wide v0, p0, Lcom/android/server/wm/zta/zta;->mb:J

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/zta/zta;->qb:Landroid/graphics/RectF;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/zta/zta;->rb:Ljava/util/ArrayList;

    iput-object p1, p0, Lcom/android/server/wm/zta/zta;->ob:Landroid/graphics/Rect;

    iput-object p2, p0, Lcom/android/server/wm/zta/zta;->pb:Landroid/graphics/Rect;
...
.method private bl()V
    ...
    iget-object v1, p0, Lcom/android/server/wm/zta/zta;->sb:Lcom/android/server/wm/zta/zta$zta;

    iget v1, v1, Lcom/android/server/wm/zta/zta$zta;->value:F

    mul-float/2addr v0, v1

    iget-object v1, p0, Lcom/android/server/wm/zta/zta;->ob:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Lcom/android/server/wm/zta/zta;->sb:Lcom/android/server/wm/zta/zta$zta;

    iget v2, v2, Lcom/android/server/wm/zta/zta$zta;->value:F

    mul-float/2addr v1, v2

    iget-object v2, p0, Lcom/android/server/wm/zta/zta;->ub:Lcom/android/server/wm/zta/zta$zta;

    iget v2, v2, Lcom/android/server/wm/zta/zta$zta;->value:F

    float-to-int v2, v2

    iget-object v3, p0, Lcom/android/server/wm/zta/zta;->pb:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Lcom/android/server/wm/zta/zta;->qb:Landroid/graphics/RectF;
    ...
    iput v1, p0, Lcom/android/server/wm/zta/zta;->vb:F

    iget v0, v0, Landroid/graphics/RectF;->top:F

    sub-float/2addr v0, v3

    iput v0, p0, Lcom/android/server/wm/zta/zta;->wb:F
...
.method private lqr(J)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/zta/zta;->rb:Ljava/util/ArrayList;
...
.method private you(F)V
    ...
    iget-object v0, v7, Lcom/android/server/wm/zta/zta;->pb:Landroid/graphics/Rect;
    ...
    iget-object v1, v7, Lcom/android/server/wm/zta/zta;->ob:Landroid/graphics/Rect;
    ...
    iget-object v1, v7, Lcom/android/server/wm/zta/zta;->pb:Landroid/graphics/Rect;
    ...
    iget-object v2, v7, Lcom/android/server/wm/zta/zta;->ob:Landroid/graphics/Rect;
    ...
    sget-object v6, Lcom/android/server/wm/zta/zta;->zb:Landroid/view/animation/Interpolator;
    ...
    sget-object v6, Lcom/android/server/wm/zta/zta;->Ab:Landroid/view/animation/Interpolator;
    ...
    iput-object v9, v7, Lcom/android/server/wm/zta/zta;->sb:Lcom/android/server/wm/zta/zta$zta;
    ...
    iput-object v8, v7, Lcom/android/server/wm/zta/zta;->tb:Lcom/android/server/wm/zta/zta$zta;
    ...
    iput-object v8, v7, Lcom/android/server/wm/zta/zta;->ub:Lcom/android/server/wm/zta/zta$zta;

    iget-object v0, v7, Lcom/android/server/wm/zta/zta;->rb:Ljava/util/ArrayList;
    ...
    iget-object v1, v7, Lcom/android/server/wm/zta/zta;->sb:Lcom/android/server/wm/zta/zta$zta;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v0, v7, Lcom/android/server/wm/zta/zta;->rb:Ljava/util/ArrayList;

    iget-object v1, v7, Lcom/android/server/wm/zta/zta;->tb:Lcom/android/server/wm/zta/zta$zta;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v0, v7, Lcom/android/server/wm/zta/zta;->rb:Ljava/util/ArrayList;

    iget-object v1, v7, Lcom/android/server/wm/zta/zta;->ub:Lcom/android/server/wm/zta/zta$zta;
...
.method protected applyTransformation(FLandroid/view/animation/Transformation;)V
    ...
    iget v0, p0, Lcom/android/server/wm/zta/zta;->vb:F

    iget v1, p0, Lcom/android/server/wm/zta/zta;->wb:F

    invoke-virtual {p1, v0, v1}, Landroid/graphics/Matrix;->postTranslate(FF)Z

    iget-object p1, p0, Lcom/android/server/wm/zta/zta;->tb:Lcom/android/server/wm/zta/zta$zta;
    ...
    iget p2, p0, Lcom/android/server/wm/zta/zta;->vb:F
    ...
    iget p2, p0, Lcom/android/server/wm/zta/zta;->wb:F
    ...
    iget-object p2, p0, Lcom/android/server/wm/zta/zta;->tb:Lcom/android/server/wm/zta/zta$zta;
    ...
    iget-object p0, p0, Lcom/android/server/wm/zta/zta;->ob:Landroid/graphics/Rect;
