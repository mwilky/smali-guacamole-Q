...
.field XO:Lcom/android/server/wm/OpPowerConsumpStats$wtn;
...
.method constructor <init>(Lcom/android/server/wm/OpPowerConsumpStats;)V
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->AO:Z

    iput-boolean p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->WO:Z
    ...
    iput-object p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->XO:Lcom/android/server/wm/OpPowerConsumpStats$wtn;
...
.method private Ab(I)Z
    ...
    :try_start_0
    iget-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->AO:Z
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->AO:Z
    ...
    iget-object v3, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->XO:Lcom/android/server/wm/OpPowerConsumpStats$wtn;

    invoke-static {v3}, Lcom/android/server/wm/OpPowerConsumpStats$wtn;->sis(Lcom/android/server/wm/OpPowerConsumpStats$wtn;)V

    iput-boolean v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->WO:Z
    ...
    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->KO:J
    ...
    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->OO:J
    ...
    iput v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->PO:I
    ...
    iput-object p1, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->VO:Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->XO:Lcom/android/server/wm/OpPowerConsumpStats$wtn;

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$tsu;

    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->KO:J
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->WO:Z
    ...
    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->OO:J
    ...
    iget v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->PO:I
    ...
    iget-object p0, p0, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->VO:Ljava/lang/String;
...
.method private Mo()Lcom/android/server/wm/OpPowerConsumpStats$tsu;
    .locals 6
    ...
    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->KO:J
    ...
    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->LO:J

    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->LO:J

    iget-wide v4, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->KO:J
    ...
    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->OO:J

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$tsu;

    iget v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->PO:I

    iput v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->PO:I
    ...
    iput v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->QO:I

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$tsu;

    iget-object v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->VO:Ljava/lang/String;

    iput-object v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->VO:Ljava/lang/String;

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$tsu;

    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->UO:J

    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->UO:J

    iget-object p0, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->XO:Lcom/android/server/wm/OpPowerConsumpStats$wtn;
    ...
    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->SO:J
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->KO:J
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->OO:J
    ...
    iget v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->PO:I
    ...
    iget v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->QO:I
    ...
    iget-object v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->VO:Ljava/lang/String;
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->UO:J
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->SO:J
...
.method private Po()Z
    ...
    :cond_0
    iput-boolean v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->AO:Z
    ...
    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->LO:J

    iget-object v4, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$tsu;

    iget-wide v4, v4, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->KO:J
    ...
    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->XO:Lcom/android/server/wm/OpPowerConsumpStats$wtn;

    iget-object v3, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$tsu;

    iget-wide v3, v3, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->LO:J
    ...
    iget-object v2, v2, Lcom/android/server/wm/OpPowerConsumpStats;->YP:Ljava/util/ArrayList;
    ...
    iget v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->QO:I
    ...
    iget-wide v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->SO:J
...
.method private Qo()Z
    ...
    :cond_0
    iget-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->WO:Z
    ...
    iget-wide v5, v5, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->KO:J

    sub-long/2addr v3, v5

    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->UO:J
    ...
    iget-wide v3, p0, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->UO:J
...
.method private Ro()Z
    ...
    iput-object v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->VO:Ljava/lang/String;
...
.method private clear()V
    ...
    iget-object v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->XO:Lcom/android/server/wm/OpPowerConsumpStats$wtn;
...
.method static synthetic cno(Lcom/android/server/wm/OpPowerConsumpStats$rtg;)Lcom/android/server/wm/OpPowerConsumpStats$tsu;
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Mo()Lcom/android/server/wm/OpPowerConsumpStats$tsu;
...
.method static synthetic rtg(Lcom/android/server/wm/OpPowerConsumpStats$rtg;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Qo()Z
...
.method static synthetic sis(Lcom/android/server/wm/OpPowerConsumpStats$rtg;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->No()V
...
.method static synthetic tsu(Lcom/android/server/wm/OpPowerConsumpStats$rtg;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Ro()Z
...
.method static synthetic you(Lcom/android/server/wm/OpPowerConsumpStats$rtg;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Oo()V
...
.method static synthetic zta(Lcom/android/server/wm/OpPowerConsumpStats$rtg;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Po()Z
...
.method static synthetic zta(Lcom/android/server/wm/OpPowerConsumpStats$rtg;I)Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Ab(I)Z
