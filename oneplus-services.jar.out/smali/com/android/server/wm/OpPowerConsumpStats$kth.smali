...
.method constructor <init>(Lcom/android/server/wm/OpPowerConsumpStats;)V
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->AO:Z
...
.method private Ko()Z
    ...
    :try_start_0
    iget-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->AO:Z
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->AO:Z
    ...
    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->KO:J
    ...
    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->OO:J
    ...
    iput v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->PO:I
    ...
    iget-wide v3, v3, Lcom/android/server/wm/OpPowerConsumpStats$cno;->KO:J
    ...
    iget-wide v3, v3, Lcom/android/server/wm/OpPowerConsumpStats$cno;->OO:J
    ...
    iget p0, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->PO:I
...
.method private So()Lcom/android/server/wm/OpPowerConsumpStats$cno;
    .locals 6
    ...
    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->KO:J

    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->KO:J

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$cno;

    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->OO:J

    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->OO:J

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$cno;

    iget v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->PO:I

    iput v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->PO:I
    ...
    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->LO:J

    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->LO:J

    iget-wide v4, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->KO:J
    ...
    iput p0, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->QO:I

    const-string p0, "StillContinuing"

    iput-object p0, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->YO:Ljava/lang/String;
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->KO:J
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->OO:J
    ...
    iget v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->PO:I
    ...
    iget v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->QO:I
    ...
    iget-object v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->YO:Ljava/lang/String;
...
.method static synthetic sis(Lcom/android/server/wm/OpPowerConsumpStats$kth;)Lcom/android/server/wm/OpPowerConsumpStats$cno;
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$kth;->So()Lcom/android/server/wm/OpPowerConsumpStats$cno;
...
.method private stopTiming(Ljava/lang/String;)Z
    ...
    :cond_0
    iput-boolean v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->AO:Z
    ...
    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->LO:J

    iget-object v4, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$cno;

    iget-wide v4, v4, Lcom/android/server/wm/OpPowerConsumpStats$cno;->KO:J
    ...
    iput v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->QO:I

    iget-object v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$cno;

    iput-object p1, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->YO:Ljava/lang/String;
    ...
    iget-object v1, v1, Lcom/android/server/wm/OpPowerConsumpStats;->XP:Ljava/util/ArrayList;
    ...
    iget-wide v1, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->LO:J
    ...
    iget v1, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->QO:I
    ...
    iget-object p0, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->YO:Ljava/lang/String;
...
.method static synthetic zta(Lcom/android/server/wm/OpPowerConsumpStats$kth;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$kth;->Ko()Z
