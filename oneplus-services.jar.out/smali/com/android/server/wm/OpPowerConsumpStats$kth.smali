...
.method constructor <init>(Lcom/android/server/wm/OpPowerConsumpStats;)V
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->BO:Z
...
.method private Jo()Z
    ...
    :try_start_0
    iget-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->BO:Z
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->BO:Z
    ...
    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->LO:J
    ...
    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->PO:J
    ...
    iput v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->QO:I
    ...
    iget-wide v3, v3, Lcom/android/server/wm/OpPowerConsumpStats$cno;->LO:J
    ...
    iget-wide v3, v3, Lcom/android/server/wm/OpPowerConsumpStats$cno;->PO:J
    ...
    iget p0, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->QO:I
...
.method private Ro()Lcom/android/server/wm/OpPowerConsumpStats$cno;
    .locals 6
    ...
    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->PO:J

    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->PO:J

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$cno;

    iget v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->QO:I
    ...
    iget-wide v4, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->LO:J
    ...
    iput p0, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->SO:I

    const-string p0, "StillContinuing"

    iput-object p0, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->ZO:Ljava/lang/String;
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->PO:J
    ...
    iget v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->SO:I
    ...
    iget-object v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->ZO:Ljava/lang/String;
...
.method static synthetic sis(Lcom/android/server/wm/OpPowerConsumpStats$kth;)Lcom/android/server/wm/OpPowerConsumpStats$cno;
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$kth;->Ro()Lcom/android/server/wm/OpPowerConsumpStats$cno;
...
.method private stopTiming(Ljava/lang/String;)Z
    ...
    :cond_0
    iput-boolean v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->BO:Z
    ...
    iget-wide v4, v4, Lcom/android/server/wm/OpPowerConsumpStats$cno;->LO:J
    ...
    iput v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->SO:I

    iget-object v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$cno;

    iput-object p1, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->ZO:Ljava/lang/String;
    ...
    iget-object v1, v1, Lcom/android/server/wm/OpPowerConsumpStats;->YP:Ljava/util/ArrayList;
    ...
    iget-wide v1, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->OO:J
    ...
    iget v1, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->SO:I
    ...
    iget-object p0, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->ZO:Ljava/lang/String;
...
.method static synthetic zta(Lcom/android/server/wm/OpPowerConsumpStats$kth;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$kth;->Jo()Z
