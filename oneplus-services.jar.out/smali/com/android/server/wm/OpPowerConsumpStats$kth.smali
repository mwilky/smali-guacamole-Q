...
.method constructor <init>(Lcom/android/server/wm/OpPowerConsumpStats;)V
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->SO:Z
...
.method private Ko()Z
    ...
    :try_start_0
    iget-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->SO:Z
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->SO:Z
    ...
    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->cP:J
    ...
    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->eP:J
    ...
    iput v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->fP:I
    ...
    iget-wide v3, v3, Lcom/android/server/wm/OpPowerConsumpStats$cno;->cP:J
    ...
    iget-wide v3, v3, Lcom/android/server/wm/OpPowerConsumpStats$cno;->eP:J
    ...
    iget p0, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->fP:I
...
.method private So()Lcom/android/server/wm/OpPowerConsumpStats$cno;
    ...
    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->cP:J

    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->cP:J

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$cno;

    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->eP:J

    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->eP:J

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$cno;

    iget v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->fP:I

    iput v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->fP:I
    ...
    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->dP:J

    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->dP:J

    iget-wide v4, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->cP:J
    ...
    iput p0, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->gP:I

    const-string p0, "StillContinuing"

    iput-object p0, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->nP:Ljava/lang/String;
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->cP:J
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->eP:J
    ...
    iget v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->fP:I
    ...
    iget v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->gP:I
    ...
    iget-object v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->nP:Ljava/lang/String;
...
.method private stopTiming(Ljava/lang/String;)Z
    ...
    :cond_0
    iput-boolean v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->SO:Z
    ...
    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$cno;->dP:J

    iget-object v4, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$cno;

    iget-wide v4, v4, Lcom/android/server/wm/OpPowerConsumpStats$cno;->cP:J
    ...
    iput v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->gP:I

    iget-object v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$kth;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$cno;

    iput-object p1, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->nP:Ljava/lang/String;
    ...
    iget-object v1, v1, Lcom/android/server/wm/OpPowerConsumpStats;->lQ:Ljava/util/ArrayList;
    ...
    iget-wide v1, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->dP:J
    ...
    iget v1, v1, Lcom/android/server/wm/OpPowerConsumpStats$cno;->gP:I
    ...
    iget-object p0, p0, Lcom/android/server/wm/OpPowerConsumpStats$cno;->nP:Ljava/lang/String;
