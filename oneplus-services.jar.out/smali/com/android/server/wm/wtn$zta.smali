...
.field private static final TN:Ljava/lang/String; = "com.oneplus.camera"

.field private static final UN:Ljava/lang/String; = "com.oneplus.gallery"
...
.field private static final VN:Ljava/lang/String; = "com.amazon.avod.thirdpartyclient"

.field private static final WN:Ljava/lang/String; = "com.netflix.mediaclient"

.field private static final XN:I = 0x1f4

.field private static YN:Lcom/android/server/wm/ActivityRecord;
...
# instance fields
.field private FN:Landroid/app/AlertDialog;

.field private GN:Landroid/content/Intent;

.field private HN:Lcom/android/server/wm/ActivityStackSupervisor;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/server/wm/wtn$zta;->JN:I

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/server/wm/wtn$zta;->KN:Ljava/lang/String;

    iput-boolean v0, p0, Lcom/android/server/wm/wtn$zta;->LN:Z

    iput-object v1, p0, Lcom/android/server/wm/wtn$zta;->MN:Ljava/lang/String;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/wtn$zta;->NN:Ljava/util/ArrayList;
...
.method static synthetic sis(Lcom/android/server/wm/wtn$zta;)Landroid/app/AlertDialog;
    ...
    iget-object p0, p0, Lcom/android/server/wm/wtn$zta;->FN:Landroid/app/AlertDialog;
...
.method static synthetic tsu(Lcom/android/server/wm/wtn$zta;)Landroid/content/Intent;
    ...
    iget-object p0, p0, Lcom/android/server/wm/wtn$zta;->GN:Landroid/content/Intent;
...
.method private you(ILjava/lang/String;I)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/wtn$zta;->HN:Lcom/android/server/wm/ActivityStackSupervisor;
...
.method static synthetic zta(Lcom/android/server/wm/wtn$zta;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    ...
    iput-object p1, p0, Lcom/android/server/wm/wtn$zta;->FN:Landroid/app/AlertDialog;
...
.method static synthetic zta(Lcom/android/server/wm/wtn$zta;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/wtn$zta;->qbh(Ljava/lang/String;I)V
...
.method public Pd()V
    ...
    iget-object v0, p0, Lcom/android/server/wm/wtn$zta;->NN:Ljava/util/ArrayList;

    iget-object v1, p0, Lcom/android/server/wm/wtn$zta;->KN:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/server/wm/wtn$zta;->KN:Ljava/lang/String;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lcom/android/server/wm/wtn$zta;->LN:Z

    iput-object v0, p0, Lcom/android/server/wm/wtn$zta;->MN:Ljava/lang/String;
...
.method public init(Lcom/android/server/wm/ActivityStack;Lcom/android/server/wm/ActivityStackSupervisor;)V
    ...
    iput-object p2, p0, Lcom/android/server/wm/wtn$zta;->HN:Lcom/android/server/wm/ActivityStackSupervisor;

    iget-object p1, p0, Lcom/android/server/wm/wtn$zta;->HN:Lcom/android/server/wm/ActivityStackSupervisor;
...
.method public putSceneMode(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    ...
    :goto_0
    iput-object p1, p0, Lcom/android/server/wm/wtn$zta;->MN:Ljava/lang/String;
    ...
    :cond_1
    iget-boolean p2, p0, Lcom/android/server/wm/wtn$zta;->LN:Z

    if-eqz p2, :cond_3

    iget-object p2, p0, Lcom/android/server/wm/wtn$zta;->MN:Ljava/lang/String;
...
.method public sendReadModeNotification(Lcom/android/server/wm/ActivityRecord;)V
    ...
    iget-object v4, p0, Lcom/android/server/wm/wtn$zta;->HN:Lcom/android/server/wm/ActivityStackSupervisor;
    ...
    iput-object v3, p0, Lcom/android/server/wm/wtn$zta;->GN:Landroid/content/Intent;

    iget-object v3, p0, Lcom/android/server/wm/wtn$zta;->GN:Landroid/content/Intent;
...
.method public startEvaluateGameMode(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    ...
    iget-object v3, p0, Lcom/android/server/wm/wtn$zta;->NN:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Lcom/android/server/wm/wtn$zta;->MN:Ljava/lang/String;
    ...
    iget-boolean v4, p0, Lcom/android/server/wm/wtn$zta;->LN:Z

    if-eqz v4, :cond_5

    iget-object v4, p0, Lcom/android/server/wm/wtn$zta;->PN:Ljava/util/ArrayList;
    ...
    :cond_9
    iput-object v2, p0, Lcom/android/server/wm/wtn$zta;->KN:Ljava/lang/String;
    ...
    iget-boolean v2, p0, Lcom/android/server/wm/wtn$zta;->LN:Z
...
.method public startEvaluateSceneModes(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    ...
    sget-object v1, Lcom/android/server/wm/wtn$zta;->YN:Lcom/android/server/wm/ActivityRecord;
    ...
    sget-object v0, Lcom/android/server/wm/wtn$zta;->YN:Lcom/android/server/wm/ActivityRecord;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/wm/wtn$zta;->HN:Lcom/android/server/wm/ActivityStackSupervisor;
    ...
    :cond_d
    sput-object p2, Lcom/android/server/wm/wtn$zta;->ZN:Lcom/android/server/wm/ActivityRecord;
...
.method public stopEvaluateSceneModes(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    ...
    sput-object p1, Lcom/android/server/wm/wtn$zta;->YN:Lcom/android/server/wm/ActivityRecord;

    goto :goto_0

    :cond_2
    sput-object v0, Lcom/android/server/wm/wtn$zta;->YN:Lcom/android/server/wm/ActivityRecord;
...
.method public y(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/wtn$zta;->PN:Ljava/util/ArrayList;

    iget-object v0, p0, Lcom/android/server/wm/wtn$zta;->KN:Ljava/lang/String;
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/wtn$zta;->LN:Z

    iget-object p1, p0, Lcom/android/server/wm/wtn$zta;->KN:Ljava/lang/String;
