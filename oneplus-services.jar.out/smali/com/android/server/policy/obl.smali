...
.field private static final dD:I = 0x9c4

.field static final eD:F = 2.5f

.field static final fD:I = 0xc9

.field static final gD:I = 0xca

.field static final hD:I = 0xcb

.field static final iD:J = 0xbb8L

.field private static final jD:J = 0x78L

.field private static final kD:I = 0x3

.field private static final lD:I = 0x5

.field static final mD:I = 0x0

.field static final nD:I = 0x1

.field static final oD:I = 0x2

.field static final pD:I = 0x3

.field private static final qD:Landroid/net/Uri;
...
# instance fields
.field TC:Lcom/android/server/policy/PhoneWindowManager;
...
.field _C:Lcom/android/server/GestureLauncherService;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/policy/obl;->qD:Landroid/net/Uri;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/server/policy/obl;->VC:Z

    iput v0, p0, Lcom/android/server/policy/obl;->WC:I

    iput-boolean v0, p0, Lcom/android/server/policy/obl;->YC:Z

    iput v0, p0, Lcom/android/server/policy/obl;->bD:I

    iput v0, p0, Lcom/android/server/policy/obl;->cD:I

    return-void
.end method

.method private En()Landroid/content/ComponentName;
    .locals 5
    ...
    iget-object v2, p0, Lcom/android/server/policy/obl;->TC:Lcom/android/server/policy/PhoneWindowManager;
...
.method private Fn()Z
    ...
    sget-object v2, Lcom/android/server/policy/obl;->qD:Landroid/net/Uri;
...
.method private Gn()V
    ...
    :cond_0
    iget v0, p0, Lcom/android/server/policy/obl;->WC:I
    ...
    :cond_2
    iput v2, p0, Lcom/android/server/policy/obl;->WC:I

    iget-object v0, p0, Lcom/android/server/policy/obl;->TC:Lcom/android/server/policy/PhoneWindowManager;

    iput-boolean v2, v0, Lcom/android/server/policy/PhoneWindowManager;->mPowerKeyHandled:Z

    iget-boolean v3, p0, Lcom/android/server/policy/obl;->VC:Z
    ...
    :cond_3
    invoke-direct {p0}, Lcom/android/server/policy/obl;->En()Landroid/content/ComponentName;
    ...
    :goto_0
    iget v3, p0, Lcom/android/server/policy/obl;->XC:I
    ...
    iget-boolean v2, p0, Lcom/android/server/policy/obl;->VC:Z
    ...
    :cond_a
    iget-boolean v0, p0, Lcom/android/server/policy/obl;->VC:Z
    ...
    iget-object p0, p0, Lcom/android/server/policy/obl;->TC:Lcom/android/server/policy/PhoneWindowManager;
...
.method static synthetic zta(Lcom/android/server/policy/obl;)V
    ...
    invoke-direct {p0}, Lcom/android/server/policy/obl;->Gn()V
...
.method public synthetic Ec()V
    ...
    iget p0, p0, Lcom/android/server/policy/obl;->XC:I
...
.method public handleEmergency(Landroid/util/MutableBoolean;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/obl;->ZC:Z
    ...
    iput-boolean v1, p0, Lcom/android/server/policy/obl;->ZC:Z
    ...
    :cond_5
    :goto_1
    iget p0, p0, Lcom/android/server/policy/obl;->bD:I
...
.method public init(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    iput-object p3, p0, Lcom/android/server/policy/obl;->TC:Lcom/android/server/policy/PhoneWindowManager;

    iget-object p1, p0, Lcom/android/server/policy/obl;->TC:Lcom/android/server/policy/PhoneWindowManager;
...
.method public initGestureLauncherService(Lcom/android/server/GestureLauncherService;)V
    ...
    iput-object p1, p0, Lcom/android/server/policy/obl;->_C:Lcom/android/server/GestureLauncherService;
...
.method public interceptPowerKeyDown(Landroid/view/KeyEvent;)Z
    ...
    iput p1, p0, Lcom/android/server/policy/obl;->XC:I
...
.method public isDoubleTapPowerWalletHasNoActiveCard()Z
    ...
    iget v0, p0, Lcom/android/server/policy/obl;->cD:I

    const/4 v1, 0x1

    if-ne v0, v1, :cond_0

    invoke-direct {p0}, Lcom/android/server/policy/obl;->Fn()Z
...
.method public processEmergencyTap(Landroid/view/KeyEvent;ZZ)Z
    ...
    iput-boolean v2, p0, Lcom/android/server/policy/obl;->ZC:Z
    ...
    iget p3, p0, Lcom/android/server/policy/obl;->aD:I
    ...
    iput v2, p0, Lcom/android/server/policy/obl;->bD:I
    ...
    iput v9, p0, Lcom/android/server/policy/obl;->bD:I
    ...
    iput v5, p0, Lcom/android/server/policy/obl;->bD:I
    ...
    iget p1, p0, Lcom/android/server/policy/obl;->aD:I
...
.method public updateSettings(Landroid/content/ContentResolver;)V
    ...
    :goto_0
    iput-boolean v2, p0, Lcom/android/server/policy/obl;->UC:Z
    ...
    iput p1, p0, Lcom/android/server/policy/obl;->cD:I
