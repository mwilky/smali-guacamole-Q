...
# static fields
.field private static Oc:Ljava/util/HashMap; = null
...
.field private static Pc:Ljava/util/HashMap; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/Integer;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/OnePlusUtil$you;->Oc:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcom/android/server/OnePlusUtil$you;->Pc:Ljava/util/HashMap;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/OnePlusUtil$you;->Nc:Ljava/util/ArrayList;
...
.method private jl()Z
    ...
    sget-object v2, Lcom/android/server/OnePlusUtil$you;->Pc:Ljava/util/HashMap;
    ...
    sget-object v2, Lcom/android/server/OnePlusUtil$you;->Oc:Ljava/util/HashMap;
    ...
    sget-object v5, Lcom/android/server/OnePlusUtil$you;->Oc:Ljava/util/HashMap;
    ...
    sget-object v0, Lcom/android/server/OnePlusUtil$you;->Pc:Ljava/util/HashMap;
    ...
    iget v9, v0, Lcom/android/server/OnePlusUtil$you$zta;->Mc:I
    ...
    sget-object p0, Lcom/android/server/OnePlusUtil$you;->Oc:Ljava/util/HashMap;
    ...
    sget-object v3, Lcom/android/server/OnePlusUtil$you;->Pc:Ljava/util/HashMap;
...
.method private sis(IILjava/lang/String;II)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/OnePlusUtil$you;->Nc:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object p0, p0, Lcom/android/server/OnePlusUtil$you;->Nc:Ljava/util/ArrayList;
...
.method private zta(IIIII)Z
    ...
    sget-object p0, Lcom/android/server/OnePlusUtil$you;->Pc:Ljava/util/HashMap;
    ...
    iget p0, p0, Lcom/android/server/OnePlusUtil$you$zta;->Mc:I
    ...
    sget-object p2, Lcom/android/server/OnePlusUtil$you;->Pc:Ljava/util/HashMap;
...
.method public addUidtoTouchWindowUids(IILjava/lang/String;III)V
    ...
    :try_start_0
    sget-object v1, Lcom/android/server/OnePlusUtil$you;->Oc:Ljava/util/HashMap;
    ...
    iget v1, v1, Lcom/android/server/OnePlusUtil$you$zta;->Mc:I
    ...
    :cond_4
    sget-object v14, Lcom/android/server/OnePlusUtil$you;->Oc:Ljava/util/HashMap;
...
.method public gck(I)Z
    ...
    sget-object v0, Lcom/android/server/OnePlusUtil$you;->Oc:Ljava/util/HashMap;
...
.method public onFindFocusedWindow()V
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/OnePlusUtil$you;->jl()Z
    ...
    sput-object p0, Lcom/android/server/OnePlusUtil$you;->Pc:Ljava/util/HashMap;
...
.method public zta(Lcom/android/server/OnePlusUtil$you$you;)V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/OnePlusUtil$you;->Nc:Ljava/util/ArrayList;
