...
.field private static final Uc:Ljava/lang/String; = "stopGps"

.field private static final Vc:Ljava/lang/String; = "aggressive"

.field private static final Wc:Ljava/lang/String;

.field private static final Xc:Ljava/lang/String;

.field static Yc:Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;

.field static Zc:Ljava/util/ArrayList;
...
.field static bc:Lcom/android/server/LocationManagerService$LocationManagerServiceInner;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/vdb;->DEBUG_ONEPLUS:Z
    ...
    sput-object v0, Lcom/android/server/vdb;->Wc:Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/server/vdb;->Xc:Ljava/lang/String;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/vdb;->Zc:Ljava/util/ArrayList;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/android/server/vdb;->mLock:Ljava/lang/Object;

    const/4 v0, 0x1

    sput-boolean v0, Lcom/android/server/vdb;->_c:Z
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/server/vdb;->mPolicy:I

    iput-boolean v0, p0, Lcom/android/server/vdb;->Qc:Z

    iput-boolean v0, p0, Lcom/android/server/vdb;->Rc:Z
...
.method private Fa(I)V
    ...
    iget-object p0, p0, Lcom/android/server/vdb;->mResolver:Landroid/content/ContentResolver;
    ...
    :cond_0
    sget-object p1, Lcom/android/server/vdb;->Xc:Ljava/lang/String;

    goto :goto_0

    :cond_1
    sget-object p1, Lcom/android/server/vdb;->Wc:Ljava/lang/String;
...
.method private Ga(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/obl;->gck(Z)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/obl;->gck(Z)Z
...
.method C()Z
    ...
    invoke-virtual {p0}, Lcom/android/server/vdb;->D()Landroid/util/ArrayMap;
    ...
    iget-object v2, p0, Lcom/android/server/vdb;->mContext:Landroid/content/Context;
    ...
    const-string v9, "com.amap.android.ams"
    ...
    const-string v9, "com.amap.android.location"
    ...
    invoke-virtual {v2, v7, v1}, Landroid/content/pm/PackageManager;->getApplicationInfo(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    iget-object v7, p0, Lcom/android/server/vdb;->mDeviceIdleController:Lcom/android/server/DeviceIdleController;

    aget-object v9, v5, v6

    invoke-virtual {v7, v9}, Lcom/android/server/DeviceIdleController;->isPowerSaveWhitelistExceptIdleAppInternal(Ljava/lang/String;)Z

    move-result v7

    if-nez v7, :cond_5

    sget-object v7, Lcom/android/server/vdb;->mLock:Ljava/lang/Object;
    ...
    :try_start_1
    const-string v9, "OpAggressiveDoze"

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "checkLoctionWhitelistUid package = "
    ...
    sget-object v9, Lcom/android/server/vdb;->Zc:Ljava/util/ArrayList;

    aget-object v10, v5, v6

    invoke-virtual {v9, v10}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v9, p0, Lcom/android/server/vdb;->mDeviceIdleController:Lcom/android/server/DeviceIdleController;

    aget-object v10, v5, v6

    invoke-virtual {v9, v10}, Lcom/android/server/DeviceIdleController;->addPowerSaveWhitelistAppInternal(Ljava/lang/String;)Z
    ...
    const-string v8, "OpAggressiveDoze"

    const-string v9, "Failed to check LoctionWhitelistUid"
...
.method D()Landroid/util/ArrayMap;
    ...
    iget-object v0, p0, Lcom/android/server/vdb;->cc:Ljava/lang/Object;
    ...
    iget-object v2, p0, Lcom/android/server/vdb;->mReceivers:Ljava/util/HashMap;
    ...
    sget-object v7, Lcom/android/server/vdb;->bc:Lcom/android/server/LocationManagerService$LocationManagerServiceInner;
    ...
    iget-object v6, p0, Lcom/android/server/vdb;->Tc:Ljava/util/ArrayList;
...
.method E()Z
    ...
    invoke-virtual {p0}, Lcom/android/server/vdb;->isAggressive()Z
...
.method F()Z
    ...
    iget-object v0, p0, Lcom/android/server/vdb;->mLocationManagerService:Lcom/android/server/LocationManagerService;
    ...
    iget-object p0, p0, Lcom/android/server/vdb;->mContext:Landroid/content/Context;
...
.method public anyMotionResultOverride(I)I
    ...
    invoke-virtual {p0}, Lcom/android/server/vdb;->E()Z
...
.method public clearWhitelistUid()V
    ...
    sget-object v0, Lcom/android/server/vdb;->mLock:Ljava/lang/Object;
    ...
    :goto_0
    :try_start_0
    sget-object v2, Lcom/android/server/vdb;->Zc:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/android/server/vdb;->mDeviceIdleController:Lcom/android/server/DeviceIdleController;
    ...
    :cond_0
    sget-object p0, Lcom/android/server/vdb;->Zc:Ljava/util/ArrayList;
...
.method public getStopGpsState()Z
    ...
    sget-boolean p0, Lcom/android/server/vdb;->_c:Z
...
.method isAggressive()Z
    ...
    iget p0, p0, Lcom/android/server/vdb;->mPolicy:I
...
.method public isMoving(Landroid/location/Location;)Z
    ...
    iget-boolean v1, p0, Lcom/android/server/vdb;->Rc:Z
    ...
    iput-boolean v2, p0, Lcom/android/server/vdb;->Qc:Z

    return v0

    :cond_0
    iget-boolean v1, p0, Lcom/android/server/vdb;->Qc:Z
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/android/server/vdb;->C()Z

    move-result v1

    if-eqz v1, :cond_2

    sput-boolean v2, Lcom/android/server/vdb;->_c:Z
    ...
    iget-object p0, p0, Lcom/android/server/vdb;->mConstants:Lcom/android/server/DeviceIdleController$Constants;
...
.method public mayUseAggressiveTimeoutLocked(FJJJJJFJJ)Z
    ...
    iget v1, v0, Lcom/android/server/vdb;->mPolicy:I

    const/4 v2, 0x1

    if-ne v1, v2, :cond_0

    iget-object v0, v0, Lcom/android/server/vdb;->mConstants:Lcom/android/server/DeviceIdleController$Constants;
...
.method public onChange(ZLandroid/net/Uri;)V
    ...
    iget-object p2, p0, Lcom/android/server/vdb;->mResolver:Landroid/content/ContentResolver;
    ...
    iput p1, p0, Lcom/android/server/vdb;->mPolicy:I

    sget-boolean p1, Lcom/android/server/vdb;->DEBUG_ONEPLUS:Z
    ...
    iget p2, p0, Lcom/android/server/vdb;->mPolicy:I
    ...
    :cond_0
    iget p1, p0, Lcom/android/server/vdb;->mPolicy:I

    invoke-direct {p0, p1}, Lcom/android/server/vdb;->Fa(I)V

    iget p1, p0, Lcom/android/server/vdb;->mPolicy:I

    invoke-direct {p0, p1}, Lcom/android/server/vdb;->Ga(I)V
...
.method public prepareDeviceIdleController(Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;)V
    ...
    sput-object p1, Lcom/android/server/vdb;->Yc:Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;

    invoke-virtual {p1}, Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;->getContext()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/vdb;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/server/vdb;->mDeviceIdleController:Lcom/android/server/DeviceIdleController;
    ...
    iput-object v0, p0, Lcom/android/server/vdb;->mConstants:Lcom/android/server/DeviceIdleController$Constants;
    ...
    iput-object v0, p0, Lcom/android/server/vdb;->mResolver:Landroid/content/ContentResolver;

    invoke-virtual {p1}, Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;->getHandler()Landroid/os/Handler;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/vdb;->mHandler:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lcom/android/server/vdb;->mLocationManager:Landroid/location/LocationManager;
    ...
    iput-object p1, p0, Lcom/android/server/vdb;->mGpsLocationListener:Landroid/location/LocationListener;

    iget-object p1, p0, Lcom/android/server/vdb;->mResolver:Landroid/content/ContentResolver;
    ...
    iget-object v2, p0, Lcom/android/server/vdb;->mConstants:Lcom/android/server/DeviceIdleController$Constants;
    ...
    iget v0, p0, Lcom/android/server/vdb;->mPolicy:I
...
.method public prepareLocationManagerService(Lcom/android/server/LocationManagerService$LocationManagerServiceInner;)V
    ...
    sput-object p1, Lcom/android/server/vdb;->bc:Lcom/android/server/LocationManagerService$LocationManagerServiceInner;
    ...
    iput-object v0, p0, Lcom/android/server/vdb;->mLocationManagerService:Lcom/android/server/LocationManagerService;

    invoke-virtual {p1}, Lcom/android/server/LocationManagerService$LocationManagerServiceInner;->getLock()Ljava/lang/Object;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/vdb;->cc:Ljava/lang/Object;

    invoke-virtual {p1}, Lcom/android/server/LocationManagerService$LocationManagerServiceInner;->getReceivers()Ljava/util/HashMap;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/vdb;->mReceivers:Ljava/util/HashMap;
...
.method public requestLocationUpdatesOverride()Z
    ...
    sget-object v0, Lcom/android/server/vdb;->Yc:Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;
    ...
    iget-boolean v0, p0, Lcom/android/server/vdb;->Rc:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/server/vdb;->mLocationManager:Landroid/location/LocationManager;
    ...
    iput-boolean v1, p0, Lcom/android/server/vdb;->Qc:Z

    iget-object v2, p0, Lcom/android/server/vdb;->mLocationManager:Landroid/location/LocationManager;

    const-wide/16 v4, 0x3e8

    const/high16 v6, 0x41200000    # 10.0f

    iget-object v7, p0, Lcom/android/server/vdb;->mGpsLocationListener:Landroid/location/LocationListener;

    iget-object p0, p0, Lcom/android/server/vdb;->mHandler:Landroid/os/Handler;
    ...
    sget-object p0, Lcom/android/server/vdb;->Yc:Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;
...
.method public scheduleAlarmOverride()Z
    ...
    invoke-virtual {p0}, Lcom/android/server/vdb;->F()Z
    ...
    iget-boolean v2, p0, Lcom/android/server/vdb;->Rc:Z
    ...
    iget-object p0, p0, Lcom/android/server/vdb;->mDeviceIdleController:Lcom/android/server/DeviceIdleController;
...
.method public shellCommand(Lcom/android/server/DeviceIdleController$Shell;Ljava/lang/String;Ljava/io/PrintWriter;)Z
    ...
    iget v3, p0, Lcom/android/server/vdb;->mPolicy:I
...
.method public tryClearAllPendingBroadcasts()V
    ...
    :try_start_0
    iget-object p0, p0, Lcom/android/server/vdb;->mReceivers:Ljava/util/HashMap;
