...
# instance fields
.field private Ka:Lcom/android/server/engineer/OneplusEngineerService;

.field private La:Ljava/io/PrintWriter;
...
.method public constructor <init>(Lcom/android/server/engineer/OneplusEngineerService;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/server/engineer/ywr;->Ka:Lcom/android/server/engineer/OneplusEngineerService;
...
.method private igw(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {p0}, Lcom/android/server/engineer/zta;->oc()V
...
.method private rtg(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    :cond_4
    iget-object p0, p0, Lcom/android/server/engineer/ywr;->Ka:Lcom/android/server/engineer/OneplusEngineerService;
    ...
    :cond_5
    invoke-static {v1}, Lcom/android/server/secrecy/zta/zta/sis;->q(I)Z
...
.method private ssp(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-static {p0}, Lcom/android/server/secrecy/zta/zta/sis;->q(I)Z
...
.method private tsu(B)I
    ...
    invoke-static {p0}, Lcom/android/server/engineer/qbh;->tsu(Ljava/util/ArrayList;)Ljava/util/ArrayList;
...
.method static synthetic zta(Lcom/android/server/engineer/ywr;)Ljava/io/PrintWriter;
    ...
    iget-object p0, p0, Lcom/android/server/engineer/ywr;->La:Ljava/io/PrintWriter;
...
.method private zta(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    :cond_5
    invoke-static {p0}, Lcom/android/server/engineer/qbh;->rtg(Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/android/server/engineer/qbh;->tsu(Ljava/util/ArrayList;)Ljava/util/ArrayList;
...
.method public onCommand(Ljava/lang/String;)I
    ...
    iput-object v5, v1, Lcom/android/server/engineer/ywr;->La:Ljava/io/PrintWriter;
    ...
    :try_start_0
    iget-object v5, v1, Lcom/android/server/engineer/ywr;->Ka:Lcom/android/server/engineer/OneplusEngineerService;
    ...
    iget-object v3, v1, Lcom/android/server/engineer/ywr;->La:Ljava/io/PrintWriter;
    ...
    iget-object v6, v1, Lcom/android/server/engineer/ywr;->La:Ljava/io/PrintWriter;
    ...
    iget-object v5, v1, Lcom/android/server/engineer/ywr;->La:Ljava/io/PrintWriter;
    ...
    iget-object v4, v1, Lcom/android/server/engineer/ywr;->La:Ljava/io/PrintWriter;
    ...
    :pswitch_3
    :try_start_7
    iget-object v3, v1, Lcom/android/server/engineer/ywr;->Ka:Lcom/android/server/engineer/OneplusEngineerService;
    ...
    iget-object v2, v1, Lcom/android/server/engineer/ywr;->La:Ljava/io/PrintWriter;
    ...
    iget-object v1, v1, Lcom/android/server/engineer/ywr;->La:Ljava/io/PrintWriter;
    ...
    iget-object v2, v1, Lcom/android/server/engineer/ywr;->Ka:Lcom/android/server/engineer/OneplusEngineerService;
    ...
    invoke-static {v3}, Lcom/android/server/secrecy/zta/zta/sis;->q(I)Z
    ...
    invoke-static {v2}, Lcom/android/server/secrecy/zta/zta/sis;->q(I)Z
