...
.field private static final ee:I = 0x0

.field private static final fe:I = 0x1

.field private static final ge:I = 0x2

.field private static final he:I = 0x3

.field static ie:Ljava/util/List;
...
# instance fields
.field private Fd:Lcom/android/server/AlarmManagerService$AmsInner;
...
.field private _d:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/ear;->ie:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lcom/android/server/ear;->Vd:[I
    ...
    iput-object v1, p0, Lcom/android/server/ear;->Yd:Ljava/util/HashMap;
    ...
    iput-object v1, p0, Lcom/android/server/ear;->_d:Ljava/util/List;

    iput-boolean v0, p0, Lcom/android/server/ear;->ae:Z

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/ear;->be:Ljava/util/HashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/ear;->ce:Ljava/util/List;
...
.method private kth(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lcom/android/server/ear;->Yd:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lcom/android/server/ear;->Yd:Ljava/util/HashMap;
...
.method private zta(Ljava/lang/String;Landroid/app/PendingIntent;I)J
    ...
    iget-object p0, p0, Lcom/android/server/ear;->Yd:Ljava/util/HashMap;
    ...
    iget-object v0, p3, Lcom/android/server/ear$you;->Ud:Ljava/lang/String;
    ...
    :cond_0
    iget-wide p0, p3, Lcom/android/server/ear$you;->Td:J
...
.method private zta(Lorg/json/JSONArray;)V
    ...
    iget-object v4, p0, Lcom/android/server/ear;->Xd:Ljava/util/List;
    ...
    :try_start_1
    iget-object v6, p0, Lcom/android/server/ear;->Xd:Ljava/util/List;
    ...
    iget-object v7, p0, Lcom/android/server/ear;->Xd:Ljava/util/List;
    ...
    sget-object v6, Lcom/android/server/ear;->ie:Ljava/util/List;
    ...
    :try_start_3
    sget-object v7, Lcom/android/server/ear;->ie:Ljava/util/List;
    ...
    sget-object v8, Lcom/android/server/ear;->ie:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/server/ear;->_d:Ljava/util/List;
    ...
    :try_start_5
    iget-object v7, p0, Lcom/android/server/ear;->_d:Ljava/util/List;
    ...
    :cond_5
    iget-object v8, p0, Lcom/android/server/ear;->_d:Ljava/util/List;
    ...
    :cond_6
    iget-object v4, p0, Lcom/android/server/ear;->Zd:Ljava/util/HashMap;
    ...
    iget-object v4, p0, Lcom/android/server/ear;->ce:Ljava/util/List;
    ...
    :try_start_7
    iget-object v6, p0, Lcom/android/server/ear;->ce:Ljava/util/List;
    ...
    :cond_8
    iget-object v7, p0, Lcom/android/server/ear;->ce:Ljava/util/List;
    ...
    :cond_9
    iget-object v3, p0, Lcom/android/server/ear;->be:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lcom/android/server/ear;->Xd:Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/ear;->ie:Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/android/server/ear;->Xd:Ljava/util/List;
...
.method public alleviateFirePendingLocked(Ljava/util/ArrayList;)Z
    ...
    iget-object v1, v0, Lcom/android/server/ear;->Fd:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_3
    iget-object v4, v0, Lcom/android/server/ear;->Fd:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v5, v0, Lcom/android/server/ear;->Fd:Lcom/android/server/AlarmManagerService$AmsInner;
...
.method public ifDropPkgAlarm(Lcom/android/server/AlarmManagerService$Alarm;Z)Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/ear;->ae:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/server/ear;->be:Ljava/util/HashMap;
...
.method public ifHandleCommand(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    iget-object p2, p0, Lcom/android/server/ear;->Zd:Ljava/util/HashMap;

    invoke-direct {p0, p2, p1, v1}, Lcom/android/server/ear;->zta(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V

    iget-object p2, p0, Lcom/android/server/ear;->be:Ljava/util/HashMap;
...
.method public onStart(Lcom/android/server/AlarmManagerService$AmsInner;)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/android/server/ear;->Fd:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_1
    iput-boolean p1, p0, Lcom/android/server/ear;->ae:Z
    ...
    iget-object v2, p0, Lcom/android/server/ear;->be:Ljava/util/HashMap;
    ...
    iget-object v0, p0, Lcom/android/server/ear;->Xd:Ljava/util/List;
    ...
    iput-object p1, p0, Lcom/android/server/ear;->de:Lcom/oneplus/config/ConfigObserver;

    iget-object p1, p0, Lcom/android/server/ear;->de:Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object p1, p0, Lcom/android/server/ear;->Wd:Ljava/util/List;

    sget-object p1, Lcom/android/server/ear;->ie:Ljava/util/List;
...
.method public setDeepSleepWhitelist([I)V
    ...
    iput-object p1, p0, Lcom/android/server/ear;->Vd:[I
...
.method public setPkgNetworkAlarmRestriction(Z)V
    ...
    :cond_0
    iput-boolean v2, p0, Lcom/android/server/ear;->ae:Z
...
.method public updateFlag(Ljava/lang/String;ILandroid/app/AlarmManager$AlarmClockInfo;)I
    ...
    iget-object p0, p0, Lcom/android/server/ear;->Wd:Ljava/util/List;
...
.method public vdb(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/ear;->ie:Ljava/util/List;
    ...
    :goto_0
    :try_start_0
    sget-object v2, Lcom/android/server/ear;->ie:Ljava/util/List;
