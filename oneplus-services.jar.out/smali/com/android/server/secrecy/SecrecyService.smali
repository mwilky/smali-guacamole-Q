...
.field private final Qg:Ljava/util/concurrent/ConcurrentHashMap;
...
.field private Sg:Lcom/android/server/secrecy/you/you;

.field private Tg:Lcom/android/server/secrecy/you/sis;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->Qg:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object p1, p0, Lcom/android/server/secrecy/SecrecyService;->Lg:Lcom/android/server/ServiceThread;

    iget-object p1, p0, Lcom/android/server/secrecy/SecrecyService;->Lg:Lcom/android/server/ServiceThread;

    invoke-virtual {p1}, Lcom/android/server/ServiceThread;->start()V

    invoke-direct {p0}, Lcom/android/server/secrecy/SecrecyService;->Gl()V
...
.method private Gl()V
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->Sg:Lcom/android/server/secrecy/you/you;
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->Tg:Lcom/android/server/secrecy/you/sis;
...
.method private dumpInternal(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/android/server/secrecy/SecrecyService;->la()Z
    ...
    invoke-virtual {p3}, Lcom/android/server/secrecy/zta/sis;->od()Lcom/android/server/secrecy/zta/zta;
    ...
    invoke-virtual {p0}, Lcom/android/server/secrecy/zta/sis;->od()Lcom/android/server/secrecy/zta/zta;
    ...
    iget-boolean v0, p0, Lcom/android/server/secrecy/SecrecyService;->Rg:Z
    ...
    invoke-virtual {p3, v1}, Lcom/android/server/secrecy/zta/sis;->p(I)Z

    move-result p3

    if-nez p3, :cond_12

    iget-object p3, p0, Lcom/android/server/secrecy/SecrecyService;->Sg:Lcom/android/server/secrecy/you/you;
    ...
    :cond_12
    iget-object p0, p0, Lcom/android/server/secrecy/SecrecyService;->Tg:Lcom/android/server/secrecy/you/sis;
...
.method private initPolicy()V
    ...
    iget-object v2, p0, Lcom/android/server/secrecy/SecrecyService;->Lg:Lcom/android/server/ServiceThread;
...
.method static synthetic zta(Lcom/android/server/secrecy/SecrecyService;)Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p0, p0, Lcom/android/server/secrecy/SecrecyService;->Qg:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private zta(Landroid/content/pm/ActivityInfo;)Z
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/secrecy/zta/sis;->p(I)Z
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->Sg:Lcom/android/server/secrecy/you/you;
    ...
    :cond_2
    iget-object p0, p0, Lcom/android/server/secrecy/SecrecyService;->Sg:Lcom/android/server/secrecy/you/you;
...
.method public la()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/secrecy/SecrecyService;->Rg:Z
...
.method public vdb(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/secrecy/SecrecyService;->Rg:Z
