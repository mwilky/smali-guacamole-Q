...
.field private final fh:Ljava/util/concurrent/ConcurrentHashMap;
...
.field private hh:Lcom/android/server/secrecy/you/you;

.field private ih:Lcom/android/server/secrecy/you/sis;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->fh:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object p1, p0, Lcom/android/server/secrecy/SecrecyService;->ah:Lcom/android/server/ServiceThread;

    iget-object p1, p0, Lcom/android/server/secrecy/SecrecyService;->ah:Lcom/android/server/ServiceThread;

    invoke-virtual {p1}, Lcom/android/server/ServiceThread;->start()V

    invoke-direct {p0}, Lcom/android/server/secrecy/SecrecyService;->Hl()V
...
.method private Hl()V
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->hh:Lcom/android/server/secrecy/you/you;
    ...
    iput-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->ih:Lcom/android/server/secrecy/you/sis;
...
.method private dumpInternal(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-boolean v0, p0, Lcom/android/server/secrecy/SecrecyService;->gh:Z
    ...
    iget-object p3, p0, Lcom/android/server/secrecy/SecrecyService;->hh:Lcom/android/server/secrecy/you/you;
    ...
    :cond_12
    iget-object p0, p0, Lcom/android/server/secrecy/SecrecyService;->ih:Lcom/android/server/secrecy/you/sis;
...
.method private initPolicy()V
    ...
    iget-object v2, p0, Lcom/android/server/secrecy/SecrecyService;->ah:Lcom/android/server/ServiceThread;
...
.method static synthetic zta(Lcom/android/server/secrecy/SecrecyService;)Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p0, p0, Lcom/android/server/secrecy/SecrecyService;->fh:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private zta(Landroid/content/pm/ActivityInfo;)Z
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/server/secrecy/SecrecyService;->hh:Lcom/android/server/secrecy/you/you;
    ...
    :cond_2
    iget-object p0, p0, Lcom/android/server/secrecy/SecrecyService;->hh:Lcom/android/server/secrecy/you/you;
...
.method public ma()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/secrecy/SecrecyService;->gh:Z
...
.method public vdb(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/secrecy/SecrecyService;->gh:Z
