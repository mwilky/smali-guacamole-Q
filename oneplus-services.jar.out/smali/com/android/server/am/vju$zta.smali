.class public Lcom/android/server/am/vju$zta;
...
.field private static Up:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private static Vp:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private static Wp:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
            "Ljava/lang/String;",
...
.field private static Yp:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private static Zp:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/vju$zta;->Up:Ljava/util/List;
    ...
    sput-object v0, Lcom/android/server/am/vju$zta;->Vp:Ljava/util/ArrayList;
    ...
    sput-object v0, Lcom/android/server/am/vju$zta;->Wp:Ljava/util/ArrayList;
    ...
    sput-object v0, Lcom/android/server/am/vju$zta;->Xp:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/am/vju$zta;->Yp:Ljava/util/List;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, Lcom/android/server/am/vju$zta;->Zp:Landroid/util/ArrayMap;
...
.method private constructor <init>()V
    ...
    sget-object v0, Lcom/android/server/am/vju$zta;->Zp:Landroid/util/ArrayMap;
...
.method public static Lb()V
    ...
    sget-object v1, Lcom/android/server/am/vju$zta;->Up:Ljava/util/List;
    ...
    sget-object v2, Lcom/android/server/am/vju$zta;->Yp:Ljava/util/List;
    ...
    :cond_0
    invoke-static {}, Lcom/android/server/am/vju$zta;->getInstance()Lcom/android/server/am/vju$zta;

    move-result-object v0

    sget-object v1, Lcom/android/server/am/vju$zta;->Yp:Ljava/util/List;
...
.method static final checkBroadcastIsPackageCanStart(Lcom/android/server/am/BroadcastQueue;Landroid/content/pm/ResolveInfo;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    invoke-direct {v2, v1, p2}, Lcom/android/server/am/vju$zta;->zta(Landroid/content/pm/ApplicationInfo;Lcom/android/server/am/BroadcastRecord;)Z

    move-result v1

    if-eqz v1, :cond_5

    invoke-static {}, Lcom/android/server/am/vju;->access$200()Z
...
.method private static getInstance()Lcom/android/server/am/vju$zta;
    .locals 1

    sget-object v0, Lcom/android/server/am/vju$zta;->mInstance:Lcom/android/server/am/vju$zta;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/vju$zta;

    invoke-direct {v0}, Lcom/android/server/am/vju$zta;-><init>()V

    sput-object v0, Lcom/android/server/am/vju$zta;->mInstance:Lcom/android/server/am/vju$zta;
...
.method private gwm(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/am/vju$zta;->Zp:Landroid/util/ArrayMap;
...
.method private setBlackAlarm(Ljava/util/List;)V
    ...
    sget-boolean p0, Lcom/android/server/am/vju;->DEBUG:Z
...
.method static final skipBroadcastLocked(Lcom/android/server/am/BroadcastFilter;Lcom/android/server/am/BroadcastRecord;Z)Z
    ...
    invoke-direct {v2, v3, p1, p2}, Lcom/android/server/am/vju$zta;->zta(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;Z)Z
...
.method static final skipBroadcastLocked(Lcom/android/server/am/BroadcastQueue;Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    invoke-direct {v2, p1, p2, v3}, Lcom/android/server/am/vju$zta;->zta(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;Z)Z
...
.method public static ssp(Ljava/util/List;)V
    ...
    sget-object v0, Lcom/android/server/am/vju$zta;->Yp:Ljava/util/List;
...
.method public static tsu(Ljava/util/List;)V
    ...
    sget-object v0, Lcom/android/server/am/vju$zta;->Up:Ljava/util/List;
...
.method private ub(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/am/vju$zta;->Wp:Ljava/util/ArrayList;

    monitor-enter p0

    :try_start_0
    sget-object v0, Lcom/android/server/am/vju$zta;->Wp:Ljava/util/ArrayList;
...
.method private vb(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/am/vju$zta;->Vp:Ljava/util/ArrayList;

    monitor-enter p0

    :try_start_0
    sget-object v0, Lcom/android/server/am/vju$zta;->Vp:Ljava/util/ArrayList;
...
.method private zta(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;Z)Z
    ...
    invoke-direct {p0, v0, v3}, Lcom/android/server/am/vju$zta;->gwm(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_4
    sget-object v3, Lcom/android/server/am/vju$zta;->Tp:Ljava/util/List;

    monitor-enter v3

    :try_start_0
    sget-object v4, Lcom/android/server/am/vju$zta;->Tp:Ljava/util/List;
    ...
    invoke-static {p1}, Lcom/android/server/am/vju;->you(Lcom/android/server/am/ProcessRecord;)Z
    ...
    sget-object p0, Lcom/android/server/am/vju$zta;->Xp:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/vju$zta;->ub(Ljava/lang/String;)Z
    ...
    :cond_e
    sget-object p0, Lcom/android/server/am/vju$zta;->Yp:Ljava/util/List;
