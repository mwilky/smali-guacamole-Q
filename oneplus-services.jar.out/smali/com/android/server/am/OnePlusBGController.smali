...
.field private static final em:J = 0xbb8L

.field private static final fm:Ljava/lang/String; = "persist.sys.bgc_debug"

.field private static final gm:Ljava/lang/String; = "persist.sys.bgc.keep"

.field private static final hm:Ljava/lang/String; = "net.oneplus.bgc.budget_reset"

.field private static final im:Ljava/lang/String; = "net.oneplus.powercontroller.intent.SLEEP_CHANGED"

.field public static jm:Z = false

.field private static final km:Z

.field private static lm:Z = false
...
.field private static nm:I = 0x0

.field private static final om:I = -0x1

.field private static final pm:J = 0x5265c00L

.field private static qm:Landroid/os/Handler; = null

.field private static final rm:F = 999.0f

.field static final sm:J = 0x19000L

.field static final tm:J = 0xbb8L

.field private static final um:Ljava/lang/String; = "com.test.bgc"

.field public static final yj:Ljava/lang/String; = "com.google.android.gms"
...
.field private Gl:Lcom/android/server/am/OnePlusBGController$NetType;
...
.field private Nl:Lcom/android/server/am/OnePlusBGController$zta;
...
.field private Wl:Ljava/util/HashSet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashSet<",
            "Ljava/lang/String;",
...
.field private Zl:Lcom/android/internal/os/MyBatteryStatsHelper;

.field _l:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field cm:Ljava/util/Comparator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/android/server/am/OnePlusBGController;->jm:Z
    ...
    sput-boolean v0, Lcom/android/server/am/OnePlusBGController;->lm:Z
    ...
    sput v0, Lcom/android/server/am/OnePlusBGController;->nm:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/BatteryStatsService;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/am/OnePlusBGController;->Cl:Z
    ...
    iput-wide v2, p0, Lcom/android/server/am/OnePlusBGController;->Hl:J

    const/4 v2, -0x1

    iput v2, p0, Lcom/android/server/am/OnePlusBGController;->Il:I
    ...
    iput-object v2, p0, Lcom/android/server/am/OnePlusBGController;->Kl:Landroid/util/SparseArray;
    ...
    iput-object v2, p0, Lcom/android/server/am/OnePlusBGController;->Ml:Ljava/util/List;

    const/high16 v2, 0x41200000    # 10.0f

    iput v2, p0, Lcom/android/server/am/OnePlusBGController;->Ol:F

    const/high16 v3, 0x41000000    # 8.0f

    iput v3, p0, Lcom/android/server/am/OnePlusBGController;->Pl:F
    ...
    iput v2, p0, Lcom/android/server/am/OnePlusBGController;->Ul:F

    iput v3, p0, Lcom/android/server/am/OnePlusBGController;->Vl:F

    new-instance v2, Ljava/util/HashSet;

    invoke-direct {v2}, Ljava/util/HashSet;-><init>()V

    iput-object v2, p0, Lcom/android/server/am/OnePlusBGController;->Wl:Ljava/util/HashSet;
    ...
    iput-object v2, p0, Lcom/android/server/am/OnePlusBGController;->cm:Ljava/util/Comparator;
    ...
    sput-object p2, Lcom/android/server/am/OnePlusBGController;->qm:Landroid/os/Handler;
    ...
    iput-object p1, p0, Lcom/android/server/am/OnePlusBGController;->Zl:Lcom/android/internal/os/MyBatteryStatsHelper;
    ...
    iput-object p1, p0, Lcom/android/server/am/OnePlusBGController;->Nl:Lcom/android/server/am/OnePlusBGController$zta;
    ...
    iput-boolean v1, p0, Lcom/android/server/am/OnePlusBGController;->Cl:Z
...
.method private Ka(I)Z
    ...
    iget-wide v7, p0, Lcom/android/server/am/OnePlusBGController$cno;->hl:J
...
.method private Oa(I)D
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/OnePlusBGController;->Zl:Lcom/android/internal/os/MyBatteryStatsHelper;

    invoke-virtual {v1, v0}, Lcom/android/internal/os/MyBatteryStatsHelper;->create(Landroid/os/BatteryStats;)V

    iget-object p0, p0, Lcom/android/server/am/OnePlusBGController;->Zl:Lcom/android/internal/os/MyBatteryStatsHelper;
...
.method private Wl()V
    ...
    iget-object v3, v0, Lcom/android/server/am/OnePlusBGController;->Nl:Lcom/android/server/am/OnePlusBGController$zta;
    ...
    sget-boolean v2, Lcom/android/server/am/OnePlusBGController;->jm:Z
    ...
    iget-object v9, v0, Lcom/android/server/am/OnePlusBGController;->Ml:Ljava/util/List;
    ...
    iget-object v13, v0, Lcom/android/server/am/OnePlusBGController;->Jl:Lcom/android/server/f;
    ...
    iput-object v13, v0, Lcom/android/server/am/OnePlusBGController;->Jl:Lcom/android/server/f;
    ...
    :cond_4
    iget v3, v0, Lcom/android/server/am/OnePlusBGController;->Ol:F
    ...
    :cond_7
    iget v14, v0, Lcom/android/server/am/OnePlusBGController;->Ql:F
    ...
    :cond_d
    iget v4, v0, Lcom/android/server/am/OnePlusBGController;->Sl:F
    ...
    iget v5, v0, Lcom/android/server/am/OnePlusBGController;->Vl:F
    ...
    iget v8, v0, Lcom/android/server/am/OnePlusBGController;->Ul:F
    ...
    iget v2, v0, Lcom/android/server/am/OnePlusBGController;->Vl:F
    ...
    iget-object v10, v0, Lcom/android/server/am/OnePlusBGController;->Nl:Lcom/android/server/am/OnePlusBGController$zta;
    ...
    sget-boolean v5, Lcom/android/server/am/OnePlusBGController;->jm:Z
    ...
    iget v1, v0, Lcom/android/server/am/OnePlusBGController;->Vl:F
    ...
    iget-object v1, v0, Lcom/android/server/am/OnePlusBGController;->Nl:Lcom/android/server/am/OnePlusBGController$zta;

    invoke-virtual {v1}, Lcom/android/server/am/OnePlusBGController$zta;->dump()V

    :cond_18
    sget-object v1, Lcom/android/server/am/OnePlusBGController;->qm:Landroid/os/Handler;

    const v2, 0x101d4

    iget-object v0, v0, Lcom/android/server/am/OnePlusBGController;->Nl:Lcom/android/server/am/OnePlusBGController$zta;
...
.method private Xl()V
    ...
    iget-object v0, p0, Lcom/android/server/am/OnePlusBGController;->Ml:Ljava/util/List;
    ...
    :goto_0
    :try_start_0
    iget-object v2, p0, Lcom/android/server/am/OnePlusBGController;->Ll:Landroid/util/SparseArray;
    ...
    iget-object v3, p0, Lcom/android/server/am/OnePlusBGController;->Ml:Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/server/am/OnePlusBGController;->cm:Ljava/util/Comparator;
...
.method private Yl()V
    ...
    iget v1, p0, Lcom/android/server/am/OnePlusBGController;->Ol:F
    ...
    iget v2, p0, Lcom/android/server/am/OnePlusBGController;->Pl:F
...
.method private Zl()V
    ...
    :goto_0
    :try_start_0
    iget-object v2, p0, Lcom/android/server/am/OnePlusBGController;->Ml:Ljava/util/List;
...
.method private _l()V
    ...
    iget-object v3, p0, Lcom/android/server/am/OnePlusBGController;->Ll:Landroid/util/SparseArray;
...
.method static synthetic access$1002(Z)Z
    ...
    sput-boolean p0, Lcom/android/server/am/OnePlusBGController;->lm:Z
...
.method static synthetic access$300()I
    ...
    sget v0, Lcom/android/server/am/OnePlusBGController;->nm:I
...
.method static synthetic access$3800()Z
    ...
    sget-boolean v0, Lcom/android/server/am/OnePlusBGController;->km:Z
...
.method private bm()Ljava/util/List;
    ...
    iget v1, p0, Lcom/android/server/am/OnePlusBGController;->Il:I
...
.method static synthetic bvj(Lcom/android/server/am/OnePlusBGController;)Landroid/util/SparseArray;
    ...
    iget-object p0, p0, Lcom/android/server/am/OnePlusBGController;->Kl:Landroid/util/SparseArray;
...
.method private dm()V
    ...
    sput p0, Lcom/android/server/am/OnePlusBGController;->nm:I
    ...
    sget v1, Lcom/android/server/am/OnePlusBGController;->nm:I
...
.method private fm()Z
    ...
    iget-wide v2, p0, Lcom/android/server/am/OnePlusBGController;->Hl:J
...
.method private gm()V
    ...
    iput-wide v0, p0, Lcom/android/server/am/OnePlusBGController;->Hl:J
...
.method static synthetic gwm(Lcom/android/server/am/OnePlusBGController;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/am/OnePlusBGController;->fm()Z
...
.method private igw(Ljava/util/List;)V
    ...
    iget-object v9, v0, Lcom/android/server/am/OnePlusBGController;->Kl:Landroid/util/SparseArray;
    ...
    sget-boolean v7, Lcom/android/server/am/OnePlusBGController;->jm:Z
    ...
    :cond_3
    sget-object v5, Lcom/android/server/am/ire;->_k:[I
    ...
    iget-boolean v1, v9, Lcom/android/server/am/OnePlusBGController$igw;->ol:Z
    ...
    sget-object v1, Lcom/android/server/am/ire;->Zk:[I

    iget-object v5, v0, Lcom/android/server/am/OnePlusBGController;->Gl:Lcom/android/server/am/OnePlusBGController$NetType;
...
.method static synthetic rtg(Lcom/android/server/am/OnePlusBGController;)Lcom/android/server/f;
    ...
    iget-object p0, p0, Lcom/android/server/am/OnePlusBGController;->Jl:Lcom/android/server/f;
...
.method static synthetic ssp(Lcom/android/server/am/OnePlusBGController;)F
    ...
    iget p0, p0, Lcom/android/server/am/OnePlusBGController;->Ol:F
...
.method static synthetic ugm(Lcom/android/server/am/OnePlusBGController;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/am/OnePlusBGController;->Fl:Z
...
.method static synthetic vdb(Lcom/android/server/am/OnePlusBGController;)V
    ...
    invoke-direct {p0}, Lcom/android/server/am/OnePlusBGController;->Wl()V
...
.method private you(ILcom/android/server/am/OnePlusBGController$ProcType;D)V
    ...
    iget-object v2, p0, Lcom/android/server/am/OnePlusBGController;->Gl:Lcom/android/server/am/OnePlusBGController$NetType;
...
.method static synthetic you(Lcom/android/server/am/OnePlusBGController;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/am/OnePlusBGController;->Fl:Z
...
.method static synthetic ywr(Lcom/android/server/am/OnePlusBGController;)Ljava/util/HashSet;
    ...
    iget-object p0, p0, Lcom/android/server/am/OnePlusBGController;->Wl:Ljava/util/HashSet;
...
.method private zgw(IZ)Z
    ...
    iget-object v0, p0, Lcom/android/server/am/OnePlusBGController;->Kl:Landroid/util/SparseArray;
...
.method static synthetic zta(Lcom/android/server/am/OnePlusBGController;F)F
    ...
    iput p1, p0, Lcom/android/server/am/OnePlusBGController;->Ol:F
...
.method static synthetic zta(Lcom/android/server/am/OnePlusBGController;Lcom/android/server/f;)Lcom/android/server/f;
    ...
    iput-object p1, p0, Lcom/android/server/am/OnePlusBGController;->Jl:Lcom/android/server/f;
...
.method public Bb()I
    ...
    sget p0, Lcom/android/server/am/OnePlusBGController;->nm:I
...
.method public Cb()Ljava/lang/String;
    ...
    iget v0, p0, Lcom/android/server/am/OnePlusBGController;->Il:I
...
.method Eb()V
    ...
    iget v3, p0, Lcom/android/server/am/OnePlusBGController;->Il:I
...
.method public Fb()Ljava/util/HashSet;
    ...
    :cond_1
    iget-object p0, p0, Lcom/android/server/am/OnePlusBGController;->Yl:Ljava/util/HashSet;
...
.method public gck(II)Z
    ...
    iget-boolean p1, p0, Lcom/android/server/am/OnePlusBGController;->Cl:Z
...
.method handleOnUidStateChanged(II)V
    ...
    iget-boolean v1, p0, Lcom/android/server/am/OnePlusBGController;->Cl:Z
    ...
    iget-object p2, p0, Lcom/android/server/am/OnePlusBGController;->Ll:Landroid/util/SparseArray;
...
.method public veq(Z)V
    ...
    sput-boolean p1, Lcom/android/server/am/OnePlusBGController;->mm:Z
    ...
    sget-boolean p1, Lcom/android/server/am/OnePlusBGController;->mm:Z
...
.method you(Ljava/util/HashSet;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/OnePlusBGController;->Xl:Ljava/util/HashSet;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/OnePlusBGController;->Xl:Ljava/util/HashSet;
    ...
    iget-object v3, p0, Lcom/android/server/am/OnePlusBGController;->Xl:Ljava/util/HashSet;
    ...
    :goto_1
    iget-object v1, p0, Lcom/android/server/am/OnePlusBGController;->Kl:Landroid/util/SparseArray;
...
.method public zta(Lcom/android/server/am/OnePlusBGController$SnapshotType;)V
    ...
    sget-object v0, Lcom/android/server/am/ire;->bl:[I
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/am/OnePlusBGController;->_l:Ljava/util/List;
