.class public Lcom/android/server/am/vju$sis;
...
.field private static mInstance:Lcom/android/server/am/vju$sis;
...
.method static final checkAppInLaunchingProviders(Lcom/android/server/am/ProcessRecord;)V
    ...
    invoke-static {}, Lcom/android/server/am/vju;->access$300()Lcom/android/server/am/ActivityManagerService;
...
.method static final checkProcessCanRestart(Lcom/android/server/am/ProcessRecord;)Z
    ...
    :cond_1
    invoke-static {}, Lcom/android/server/am/vju$sis;->getInstance()Lcom/android/server/am/vju$sis;

    move-result-object v0

    invoke-direct {v0, p0}, Lcom/android/server/am/vju$sis;->ugm(Lcom/android/server/am/ProcessRecord;)Z
...
.method private static getInstance()Lcom/android/server/am/vju$sis;
    .locals 1

    sget-object v0, Lcom/android/server/am/vju$sis;->mInstance:Lcom/android/server/am/vju$sis;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/vju$sis;

    invoke-direct {v0}, Lcom/android/server/am/vju$sis;-><init>()V

    sput-object v0, Lcom/android/server/am/vju$sis;->mInstance:Lcom/android/server/am/vju$sis;
