...
.method public constructor <init>(Ljava/lang/String;ZZ)V
    ...
    iput-object v0, p0, Lcom/android/server/am/l$bio;->Cv:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput v0, p0, Lcom/android/server/am/l$bio;->Dv:I

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/android/server/am/l$bio;->Fv:Z

    iput-boolean v0, p0, Lcom/android/server/am/l$bio;->Gv:Z
    ...
    invoke-static {}, Lcom/android/server/am/l;->Bb()J
    ...
    iput-wide v2, p0, Lcom/android/server/am/l$bio;->Bv:J
    ...
    iget-object p2, p0, Lcom/android/server/am/l$bio;->Cv:Ljava/util/ArrayList;
    ...
    iget-wide p2, p0, Lcom/android/server/am/l$bio;->Bv:J

    invoke-static {p1, p2, p3}, Lcom/android/server/am/l$cno;->sis(Lcom/android/server/am/l$cno;J)J

    iget-object p0, p0, Lcom/android/server/am/l$bio;->Cv:Ljava/util/ArrayList;
...
.method private irq(J)I
    ...
    iget-object v0, p0, Lcom/android/server/am/l$bio;->Cv:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/android/server/am/l$bio;->Cv:Ljava/util/ArrayList;
    ...
    iget-wide v3, p0, Lcom/android/server/am/l$bio;->Bv:J
    ...
    :cond_2
    iget-object p1, p0, Lcom/android/server/am/l$bio;->Cv:Ljava/util/ArrayList;
    ...
    iput p1, p0, Lcom/android/server/am/l$bio;->Dv:I
    ...
    invoke-static {p1}, Lcom/android/server/am/l;->l(I)I

    :cond_3
    iget p0, p0, Lcom/android/server/am/l$bio;->Dv:I
...
.method static synthetic ssp(Lcom/android/server/am/l$bio;)J
    ...
    iget-wide v0, p0, Lcom/android/server/am/l$bio;->sv:J
...
.method static synthetic tsu(Lcom/android/server/am/l$bio;J)J
    ...
    iput-wide v0, p0, Lcom/android/server/am/l$bio;->sv:J
...
.method static synthetic tsu(Lcom/android/server/am/l$bio;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/am/l$bio;->Fv:Z
...
.method static synthetic you(Lcom/android/server/am/l$bio;)J
    ...
    iget-wide v0, p0, Lcom/android/server/am/l$bio;->rv:J
...
.method static synthetic you(Lcom/android/server/am/l$bio;J)J
    ...
    iput-wide p1, p0, Lcom/android/server/am/l$bio;->rv:J
...
.method static synthetic zta(Lcom/android/server/am/l$bio;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/am/l$bio;->Fv:Z
...
.method public dma(J)V
    ...
    iput-wide p1, p0, Lcom/android/server/am/l$bio;->sv:J
...
.method public dump()V
    ...
    iget-wide v1, p0, Lcom/android/server/am/l$bio;->xv:D
    ...
    iget-wide v1, p0, Lcom/android/server/am/l$bio;->yv:D
    ...
    iget-wide v1, p0, Lcom/android/server/am/l$bio;->zv:D
...
.method public ic()V
    ...
    iput-wide v0, p0, Lcom/android/server/am/l$bio;->xv:D

    iput-wide v0, p0, Lcom/android/server/am/l$bio;->yv:D

    iput-wide v0, p0, Lcom/android/server/am/l$bio;->zv:D
...
.method public jc()[B
    ...
    invoke-virtual {v1}, Lcom/android/server/am/l$cno;->jc()Ljava/lang/String;
...
.method public k(I)V
    ...
    iput p1, p0, Lcom/android/server/am/l$bio;->Av:I
...
.method public oif(J)Z
    ...
    iget-object v5, p0, Lcom/android/server/am/l$bio;->Cv:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lcom/android/server/am/l$bio;->Cv:Ljava/util/ArrayList;
...
.method public qbh(J)V
    ...
    iput-wide v0, p0, Lcom/android/server/am/l$bio;->Ev:J
...
.method public r(Ljava/lang/String;)V
    ...
    iget v1, p0, Lcom/android/server/am/l$bio;->Dv:I
    ...
    invoke-virtual {v0}, Lcom/android/server/am/l$cno;->hc()V
...
.method public ywr(J)V
    ...
    iput-wide v2, p0, Lcom/android/server/am/l$bio;->xv:D

    iput-wide v2, p0, Lcom/android/server/am/l$bio;->yv:D

    iput-wide v2, p0, Lcom/android/server/am/l$bio;->zv:D
    ...
    iput v1, p0, Lcom/android/server/am/l$bio;->Dv:I

    iput-wide p1, p0, Lcom/android/server/am/l$bio;->rv:J

    iput-wide p1, p0, Lcom/android/server/am/l$bio;->Ev:J

    iput-boolean v0, p0, Lcom/android/server/am/l$bio;->Fv:Z
...
.method public zta(Landroid/content/Context;J)V
    ...
    iget-wide v5, p0, Lcom/android/server/am/l$bio;->rv:J
    ...
    iget-wide v0, p0, Lcom/android/server/am/l$bio;->Ev:J

    iput-wide v0, p0, Lcom/android/server/am/l$bio;->rv:J

    iget-object p1, p0, Lcom/android/server/am/l$bio;->Cv:Ljava/util/ArrayList;

    iget p3, p0, Lcom/android/server/am/l$bio;->Dv:I
    ...
    :goto_0
    iget-boolean p1, p0, Lcom/android/server/am/l$bio;->Gv:Z
    ...
    invoke-virtual {p1}, Lcom/android/server/am/l$cno;->fc()V
    ...
    :cond_1
    iput-boolean p2, p0, Lcom/android/server/am/l$bio;->Gv:Z

    return-void

    :cond_2
    iget-wide v4, p0, Lcom/android/server/am/l$bio;->rv:J
