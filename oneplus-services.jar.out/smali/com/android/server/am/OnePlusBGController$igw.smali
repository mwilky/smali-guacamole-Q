...
.field private Cl:Lcom/android/server/am/OnePlusBGController$cno;
...
.method constructor <init>(Lcom/android/server/am/OnePlusBGController;IZI)V
    ...
    iput-boolean v0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Dl:Z

    iput-boolean v0, p0, Lcom/android/server/am/OnePlusBGController$igw;->El:Z

    iput-boolean v0, p0, Lcom/android/server/am/OnePlusBGController$igw;->pl:Z
    ...
    iput-boolean v2, p0, Lcom/android/server/am/OnePlusBGController$igw;->pl:Z

    :cond_0
    iput-boolean p3, p0, Lcom/android/server/am/OnePlusBGController$igw;->Dl:Z
    ...
    iput-object p3, p0, Lcom/android/server/am/OnePlusBGController$igw;->Cl:Lcom/android/server/am/OnePlusBGController$cno;

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide p2

    iput-wide p2, p0, Lcom/android/server/am/OnePlusBGController$igw;->Bl:J
    ...
    :goto_1
    iget-boolean p3, p0, Lcom/android/server/am/OnePlusBGController$igw;->Dl:Z
    ...
    iput-boolean v2, p0, Lcom/android/server/am/OnePlusBGController$igw;->El:Z
    ...
    iget-boolean p3, p0, Lcom/android/server/am/OnePlusBGController$igw;->El:Z
    ...
    invoke-static {}, Lcom/android/server/am/OnePlusBGController;->Ab()Z
    ...
    iget-boolean p2, p0, Lcom/android/server/am/OnePlusBGController$igw;->El:Z
...
.method dump()V
    ...
    invoke-virtual {p0}, Lcom/android/server/am/OnePlusBGController$igw;->wb()J
    ...
    iget-boolean v1, p0, Lcom/android/server/am/OnePlusBGController$igw;->El:Z
...
.method igw(IZ)V
    ...
    iput-boolean v3, p0, Lcom/android/server/am/OnePlusBGController$igw;->El:Z
    ...
    :cond_0
    iget-wide v6, p0, Lcom/android/server/am/OnePlusBGController$igw;->Bl:J
    ...
    :cond_2
    invoke-virtual {p0, p1}, Lcom/android/server/am/OnePlusBGController$igw;->irq(I)Z
    ...
    iput-boolean p2, p0, Lcom/android/server/am/OnePlusBGController$igw;->El:Z
    ...
    iget-object p2, p0, Lcom/android/server/am/OnePlusBGController$igw;->Cl:Lcom/android/server/am/OnePlusBGController$cno;
    ...
    iput-wide v4, p2, Lcom/android/server/am/OnePlusBGController$cno;->il:J
    ...
    iput-wide v4, p2, Lcom/android/server/am/OnePlusBGController$cno;->jl:J
    ...
    sget-object p2, Lcom/android/server/am/OnePlusBGController$ProcType;->Pga:Lcom/android/server/am/OnePlusBGController$ProcType;
    ...
    sget-object v2, Lcom/android/server/am/OnePlusBGController$ProcType;->Pga:Lcom/android/server/am/OnePlusBGController$ProcType;
    ...
    iget-boolean v2, p0, Lcom/android/server/am/OnePlusBGController$igw;->El:Z
    ...
    iput-wide v0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Bl:J
...
.method irq(I)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/am/OnePlusBGController$igw;->El:Z

    iget-object v1, p0, Lcom/android/server/am/OnePlusBGController$igw;->this$0:Lcom/android/server/am/OnePlusBGController;

    iget-boolean p0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Dl:Z
...
.method lqr(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/am/OnePlusBGController$igw;->Dl:Z
...
.method wb()J
    ...
    iget-boolean v5, p0, Lcom/android/server/am/OnePlusBGController$igw;->Dl:Z
...
.method xb()Lcom/android/server/am/OnePlusBGController$cno;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Cl:Lcom/android/server/am/OnePlusBGController$cno;
...
.method yb()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/am/OnePlusBGController$igw;->El:Z
