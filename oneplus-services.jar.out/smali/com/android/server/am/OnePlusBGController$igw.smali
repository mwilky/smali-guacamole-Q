...
.field private Bl:Lcom/android/server/am/OnePlusBGController$cno;
...
.method constructor <init>(Lcom/android/server/am/OnePlusBGController;IZI)V
    ...
    iput-boolean v0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Cl:Z

    iput-boolean v0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Dl:Z

    iput-boolean v0, p0, Lcom/android/server/am/OnePlusBGController$igw;->ol:Z
    ...
    iput-boolean v2, p0, Lcom/android/server/am/OnePlusBGController$igw;->ol:Z

    :cond_0
    iput-boolean p3, p0, Lcom/android/server/am/OnePlusBGController$igw;->Cl:Z
    ...
    iput-object p3, p0, Lcom/android/server/am/OnePlusBGController$igw;->Bl:Lcom/android/server/am/OnePlusBGController$cno;

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide p2

    iput-wide p2, p0, Lcom/android/server/am/OnePlusBGController$igw;->Al:J
    ...
    :goto_1
    iget-boolean p3, p0, Lcom/android/server/am/OnePlusBGController$igw;->Cl:Z
    ...
    iput-boolean v2, p0, Lcom/android/server/am/OnePlusBGController$igw;->Dl:Z
    ...
    iget-boolean p2, p0, Lcom/android/server/am/OnePlusBGController$igw;->Dl:Z
...
.method dump()V
    ...
    iget-boolean v1, p0, Lcom/android/server/am/OnePlusBGController$igw;->Dl:Z
...
.method igw(IZ)V
    ...
    iput-boolean v3, p0, Lcom/android/server/am/OnePlusBGController$igw;->Dl:Z
    ...
    :cond_0
    iget-wide v6, p0, Lcom/android/server/am/OnePlusBGController$igw;->Al:J
    ...
    iput-boolean p2, p0, Lcom/android/server/am/OnePlusBGController$igw;->Dl:Z
    ...
    iget-object p2, p0, Lcom/android/server/am/OnePlusBGController$igw;->Bl:Lcom/android/server/am/OnePlusBGController$cno;
    ...
    iput-wide v4, p2, Lcom/android/server/am/OnePlusBGController$cno;->hl:J
    ...
    iget-boolean v2, p0, Lcom/android/server/am/OnePlusBGController$igw;->Dl:Z
    ...
    iput-wide v0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Al:J
...
.method irq(I)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Dl:Z

    iget-object v1, p0, Lcom/android/server/am/OnePlusBGController$igw;->this$0:Lcom/android/server/am/OnePlusBGController;

    iget-boolean p0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Cl:Z
...
.method lqr(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/am/OnePlusBGController$igw;->Cl:Z
...
.method wb()J
    ...
    iget-boolean v5, p0, Lcom/android/server/am/OnePlusBGController$igw;->Cl:Z
...
.method xb()Lcom/android/server/am/OnePlusBGController$cno;
    ...
    iget-object p0, p0, Lcom/android/server/am/OnePlusBGController$igw;->Bl:Lcom/android/server/am/OnePlusBGController$cno;
