...
.field private static sInstance:Lcom/android/server/am/wtn;


# instance fields
.field private Ah:Ljava/lang/reflect/Method;

.field private Bh:Ljava/lang/reflect/Method;

.field private Ch:Ljava/lang/reflect/Method;

.field private mAms:Lcom/android/server/am/ActivityManagerService;

.field private mAtmService:Lcom/android/server/wm/ActivityTaskManagerService;

.field private mEmbryoManager:Lcom/android/server/am/ywr;
...
.method constructor <init>(Lcom/android/server/am/ywr;Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ProcessList;Lcom/android/server/wm/ActivityTaskManagerService;Lcom/android/internal/os/ProcessCpuTracker;)V
    ...
    iput-object v0, p0, Lcom/android/server/am/wtn;->Ah:Ljava/lang/reflect/Method;

    iput-object v0, p0, Lcom/android/server/am/wtn;->Bh:Ljava/lang/reflect/Method;

    iput-object v0, p0, Lcom/android/server/am/wtn;->Ch:Ljava/lang/reflect/Method;

    iput-object p1, p0, Lcom/android/server/am/wtn;->mEmbryoManager:Lcom/android/server/am/ywr;

    iput-object p2, p0, Lcom/android/server/am/wtn;->mAms:Lcom/android/server/am/ActivityManagerService;

    iput-object p3, p0, Lcom/android/server/am/wtn;->mProcessList:Lcom/android/server/am/ProcessList;

    iput-object p4, p0, Lcom/android/server/am/wtn;->mAtmService:Lcom/android/server/wm/ActivityTaskManagerService;

    iput-object p5, p0, Lcom/android/server/am/wtn;->mProcessCpuTracker:Lcom/android/internal/os/ProcessCpuTracker;

    sput-object p0, Lcom/android/server/am/wtn;->sInstance:Lcom/android/server/am/wtn;

    return-void
.end method

.method public static getInstance()Lcom/android/server/am/wtn;
    .locals 1

    sget-object v0, Lcom/android/server/am/wtn;->sInstance:Lcom/android/server/am/wtn;
...
# virtual methods
.method public Ea()Lcom/android/server/am/ActivityManagerService;
    .locals 0
...
.method Fa()Z
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/am/wtn;->mProcessList:Lcom/android/server/am/ProcessList;
    ...
    iput-object v2, p0, Lcom/android/server/am/wtn;->Ah:Ljava/lang/reflect/Method;

    iget-object v2, p0, Lcom/android/server/am/wtn;->Ah:Ljava/lang/reflect/Method;
    ...
    iget-object v2, p0, Lcom/android/server/am/wtn;->mAms:Lcom/android/server/am/ActivityManagerService;
    ...
    iput-object v2, p0, Lcom/android/server/am/wtn;->Bh:Ljava/lang/reflect/Method;

    iget-object v2, p0, Lcom/android/server/am/wtn;->Bh:Ljava/lang/reflect/Method;
    ...
    iget-object v2, p0, Lcom/android/server/am/wtn;->mAtmService:Lcom/android/server/wm/ActivityTaskManagerService;
    ...
    iput-object v2, p0, Lcom/android/server/am/wtn;->Ch:Ljava/lang/reflect/Method;

    iget-object v2, p0, Lcom/android/server/am/wtn;->Ch:Ljava/lang/reflect/Method;
    ...
    :cond_2
    iget-object p0, p0, Lcom/android/server/am/wtn;->Ch:Ljava/lang/reflect/Method;
...
.method public bud(Ljava/lang/String;)Z
    .locals 5

    iget-object v0, p0, Lcom/android/server/am/wtn;->mPms:Landroid/content/pm/IPackageManager;
    ...
    iput-object v0, p0, Lcom/android/server/am/wtn;->mPms:Landroid/content/pm/IPackageManager;
    ...
    :try_start_0
    iget-object p0, p0, Lcom/android/server/am/wtn;->mPms:Landroid/content/pm/IPackageManager;
...
.method public compatibilityInfoForPackageLocked(Landroid/content/pm/ApplicationInfo;)Landroid/content/res/CompatibilityInfo;
    ...
    :try_start_1
    iget-object v1, p0, Lcom/android/server/am/wtn;->Ch:Ljava/lang/reflect/Method;
...
.method public final findEmbryoLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Lcom/android/server/am/wtn;->mEmbryoManager:Lcom/android/server/am/ywr;

    invoke-virtual {v0, p1, p2}, Lcom/android/server/am/ywr;->obtain(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;)Landroid/app/IApplicationThread;
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/server/am/wtn;->mAms:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v2, p0, Lcom/android/server/am/wtn;->mProcessCpuTracker:Lcom/android/internal/os/ProcessCpuTracker;

    monitor-enter v2

    :try_start_1
    iget-object v1, p0, Lcom/android/server/am/wtn;->mProcessCpuTracker:Lcom/android/internal/os/ProcessCpuTracker;
    ...
    iget-object v4, p0, Lcom/android/server/am/wtn;->mProcessCpuTracker:Lcom/android/internal/os/ProcessCpuTracker;
    ...
    iget-object v1, p0, Lcom/android/server/am/wtn;->mAtmService:Lcom/android/server/wm/ActivityTaskManagerService;
...
.method public getCommonServicesLocked(Z)Landroid/util/ArrayMap;
    ...
    :try_start_1
    iget-object v1, p0, Lcom/android/server/am/wtn;->Bh:Ljava/lang/reflect/Method;
...
.method public zta(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p2, p0, Lcom/android/server/am/wtn;->Ah:Ljava/lang/reflect/Method;
...
.method public zta(Landroid/content/pm/ApplicationInfo;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/wtn;->bud(Ljava/lang/String;)Z
