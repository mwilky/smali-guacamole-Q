...
.field private static PA:Z = false

.field private static final PROP_ENABLE:Ljava/lang/String; = "persist.sys.opdom.enable"

.field private static final QA:Ljava/lang/String; = "/data/system/opdom"

.field private static final RA:I = 0x1

.field private static final SA:I = 0x2
...
.field private volatile OA:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/pm/zta;->PA:Z
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/pm/zta;->JA:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/pm/zta;->KA:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/pm/zta;->LA:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/server/pm/zta;->MA:Z

    const-string v0, "unlocked"

    iput-object v0, p0, Lcom/android/server/pm/zta;->OA:Ljava/lang/String;

    sget-boolean v0, Lcom/android/server/pm/zta;->PA:Z
    ...
    iget-object v0, p0, Lcom/android/server/pm/zta;->JA:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/server/pm/zta;->JA:Ljava/util/ArrayList;
...
.method private declared-synchronized mn()V
    ...
    iget-object v0, p0, Lcom/android/server/pm/zta;->KA:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v2, p0, Lcom/android/server/pm/zta;->KA:Ljava/util/ArrayList;
...
.method private rn()V
    ...
    iput-boolean v1, p0, Lcom/android/server/pm/zta;->MA:Z
    ...
    iget-object p0, p0, Lcom/android/server/pm/zta;->KA:Ljava/util/ArrayList;
...
.method static synthetic sis(Lcom/android/server/pm/zta;)V
    ...
    invoke-direct {p0}, Lcom/android/server/pm/zta;->rn()V
...
.method static synthetic you(Lcom/android/server/pm/zta;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/pm/zta;->OA:Ljava/lang/String;
...
.method static synthetic you(Lcom/android/server/pm/zta;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/pm/zta;->Gb(Ljava/lang/String;)Z
...
.method static synthetic zta(Lcom/android/server/pm/zta;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/android/server/pm/zta;->OA:Ljava/lang/String;
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    sget-boolean p2, Lcom/android/server/pm/zta;->PA:Z
    ...
    :cond_0
    iget-object p2, p0, Lcom/android/server/pm/zta;->JA:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object p1, p0, Lcom/android/server/pm/zta;->LA:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object p2, p0, Lcom/android/server/pm/zta;->LA:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/server/pm/zta;->LA:Ljava/util/ArrayList;
...
.method public initInstance(Lcom/android/server/pm/PackageManagerService;)V
    ...
    iget-boolean p1, p0, Lcom/android/server/pm/zta;->MA:Z
...
.method public setEnable(Z)V
    ...
    sget-boolean v1, Lcom/android/server/pm/zta;->PA:Z
    ...
    :cond_0
    sput-boolean p1, Lcom/android/server/pm/zta;->PA:Z
...
.method public shutdown()V
    ...
    invoke-direct {p0}, Lcom/android/server/pm/zta;->mn()V
