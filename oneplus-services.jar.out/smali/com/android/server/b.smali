...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iget-object p2, p0, Lcom/android/server/b;->this$0:Lcom/android/server/OpPowerControllerService;
    ...
    iget-object v0, p0, Lcom/android/server/b;->this$0:Lcom/android/server/OpPowerControllerService;
    ...
    iget-object p1, p0, Lcom/android/server/b;->this$0:Lcom/android/server/OpPowerControllerService;
    ...
    invoke-static {p1}, Lcom/android/server/OpPowerControllerService;->access$1700(Lcom/android/server/OpPowerControllerService;)Landroid/net/ConnectivityManager;
    ...
    :cond_c
    invoke-static {p2, v1}, Lcom/android/server/OpPowerControllerService;->access$1802(Lcom/android/server/OpPowerControllerService;Z)Z
    ...
    invoke-static {p2}, Lcom/android/server/OpPowerControllerService;->access$1800(Lcom/android/server/OpPowerControllerService;)Z
    ...
    invoke-static {p1}, Lcom/android/server/OpPowerControllerService;->access$1800(Lcom/android/server/OpPowerControllerService;)Z
    ...
    invoke-static {p1, p2, v0}, Lcom/android/server/OpPowerControllerService;->access$1900(Lcom/android/server/OpPowerControllerService;Lcom/android/server/OpPowerControllerService$PkgRestrictType;Lcom/android/server/OpPowerControllerService$PurposeType;)V
    ...
    invoke-static {p1}, Lcom/android/server/OpPowerControllerService;->access$2000(Lcom/android/server/OpPowerControllerService;)Z
    ...
    invoke-static {p0, p1, p2}, Lcom/android/server/OpPowerControllerService;->access$1900(Lcom/android/server/OpPowerControllerService;Lcom/android/server/OpPowerControllerService$PkgRestrictType;Lcom/android/server/OpPowerControllerService$PurposeType;)V
    ...
    invoke-static {p0}, Lcom/android/server/OpPowerControllerService;->access$2202(I)I

    :cond_14
    if-lez p1, :cond_15

    invoke-static {p1}, Lcom/android/server/OpPowerControllerService;->access$2302(I)I

    :cond_15
    if-lez v0, :cond_16

    invoke-static {v0}, Lcom/android/server/OpPowerControllerService;->access$2402(I)I

    :cond_16
    if-lez v2, :cond_17

    invoke-static {v2}, Lcom/android/server/OpPowerControllerService;->access$2502(I)I

    :cond_17
    if-lez v3, :cond_18

    invoke-static {v3}, Lcom/android/server/OpPowerControllerService;->access$2602(I)I

    :cond_18
    if-lez v4, :cond_19

    invoke-static {v4}, Lcom/android/server/OpPowerControllerService;->access$2702(I)I

    :cond_19
    if-lez v5, :cond_1a

    invoke-static {v5}, Lcom/android/server/OpPowerControllerService;->access$2802(I)I

    :cond_1a
    if-lez p2, :cond_1c

    invoke-static {p2}, Lcom/android/server/OpPowerControllerService;->access$2902(I)I
