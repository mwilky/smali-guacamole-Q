...
# instance fields
.field private RY:Landroid/util/ArrayMap;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/context/OneplusContextStubImpl;->RY:Landroid/util/ArrayMap;

    iput-object p1, p0, Lcom/oneplus/android/server/context/OneplusContextStubImpl;->mContext:Landroid/content/Context;

    iget-object v0, p0, Lcom/oneplus/android/server/context/OneplusContextStubImpl;->RY:Landroid/util/ArrayMap;
    ...
    iget-object v2, p0, Lcom/oneplus/android/server/context/OneplusContextStubImpl;->RY:Landroid/util/ArrayMap;
    ...
    new-instance v5, Lcom/android/server/am/oif;

    invoke-direct {v5}, Lcom/android/server/am/oif;-><init>()V
    ...
    new-instance v5, Lcom/android/server/am/bio;

    invoke-direct {v5}, Lcom/android/server/am/bio;-><init>()V
    ...
    new-instance v5, Lcom/android/server/bud;

    invoke-direct {v5}, Lcom/android/server/bud;-><init>()V
    ...
    invoke-static {v5}, Lcom/android/server/f;->getInstance(Landroid/content/Context;)Lcom/android/server/f;
    ...
    new-instance v5, Lcom/android/server/am/j;

    invoke-direct {v5}, Lcom/android/server/am/j;-><init>()V
    ...
    new-instance v5, Lcom/android/server/am/g;

    invoke-direct {v5}, Lcom/android/server/am/g;-><init>()V
    ...
    new-instance v5, Lcom/android/server/am/l;

    invoke-direct {v5}, Lcom/android/server/am/l;-><init>()V
    ...
    :cond_18
    iget-object v1, p0, Lcom/oneplus/android/server/context/OneplusContextStubImpl;->RY:Landroid/util/ArrayMap;
    ...
    new-instance v4, Lcom/android/server/obl;

    invoke-direct {v4}, Lcom/android/server/obl;-><init>()V
    ...
    invoke-direct {v4, p1}, Lcom/android/server/am/f;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v4}, Lcom/android/server/oxb;-><init>()V
    ...
    invoke-static {}, Lcom/android/server/am/ywr;->getInstance()Lcom/android/server/am/IEmbryoManager;
    ...
    new-instance v4, Lcom/android/server/am/i;

    invoke-direct {v4}, Lcom/android/server/am/i;-><init>()V
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/context/OneplusContextStubImpl;->RY:Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/context/OneplusContextStubImpl;->RY:Landroid/util/ArrayMap;

    sget-object p1, Lcom/oneplus/android/server/context/IOneplusContextStub$EStubType;->oneplus_op_ads:Lcom/oneplus/android/server/context/IOneplusContextStub$EStubType;

    new-instance v0, Lcom/android/server/OpAppSwitchManagerServiceHelper;

    invoke-direct {v0}, Lcom/android/server/OpAppSwitchManagerServiceHelper;-><init>()V
...
.method public bootComplete()V
    ...
    invoke-virtual {v1}, Lcom/android/server/f;->onBootComplete()V

    :cond_2
    iget-object v1, p0, Lcom/oneplus/android/server/context/OneplusContextStubImpl;->mContext:Landroid/content/Context;

    invoke-static {v1}, Lcom/android/server/am/les;->init(Landroid/content/Context;)Lcom/android/server/am/les;
    ...
    new-instance v1, Lcom/android/server/am/h;

    invoke-direct {v1}, Lcom/android/server/am/h;-><init>()V
...
.method public systemReady()V
    ...
    check-cast v1, Lcom/android/server/am/l;

    if-eqz v1, :cond_8

    iget-object v2, p0, Lcom/oneplus/android/server/context/OneplusContextStubImpl;->mContext:Landroid/content/Context;

    invoke-virtual {v1, v2}, Lcom/android/server/am/l;->systemReady(Landroid/content/Context;)V
