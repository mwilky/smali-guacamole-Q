...
.field private static OQ:Z = true

.field private static OW:J = 0x0L

.field private static PW:J = 0x0L

.field private static QW:J = 0x0L
...
.field private static UV:Ljava/util/List; = null
...
.field private static final VV:Ljava/lang/String; = "com.oneplus.action.CAMERA"

.field private static VW:Z = false

.field private static final WV:Ljava/lang/String; = "oneplus.intent.action.INCALLUI_ANSWER"

.field private static WW:Z = false

.field private static final XV:Ljava/lang/String; = "isVideo"

.field private static XW:Z = false

.field private static final YV:Ljava/lang/String; = "oneplus.permission.ONEPLUS_COMPONENT_SAFE"

.field private static YW:Z = false

.field private static final ZV:Ljava/lang/String; = "android.policy:POWER"

.field private static ZW:Z = false

.field private static final _V:Ljava/lang/String; = "android.policy:DOUBLE_TAP"

.field private static _W:Z = false

.field private static final aW:Ljava/lang/String; = "systemui_faceunlock"

.field private static aX:Z = false

.field private static final bW:Ljava/lang/String; = "screenoff"

.field private static bX:Z = false

.field private static final cW:Ljava/lang/String; = "persist.sys.motor.calibtime"

.field private static cX:Z = false

.field private static final dW:Ljava/lang/String; = "org.codeaurora.ims"
...
.field private static final hW:I = 0xb7

.field private static final iW:I = 0xb8

.field private static final jW:I = 0xb9

.field private static final kW:I = 0xba

.field private static final lW:I = 0xbb

.field private static final mW:I = 0xbc

.field private static final nW:I = 0xbd

.field private static final oW:I = 0xbe

.field private static final pW:I = 0x1388

.field private static final qW:I = 0x800
...
.field private static final uW:I = 0x2bc

.field private static final vW:I = 0x2bf

.field private static final wW:I = 0x1fa2658

.field private static final xW:I = 0x32
...
.field private final PV:Landroid/hardware/SensorEventListener;

.field private QV:Landroid/media/AudioManager$AudioRecordingCallback;
...
.field private jV:Lcom/oneplus/android/server/vdb$zta;

.field private kV:Lsis/you/you/you/zta/zta;

.field private final lV:Lcom/oneplus/android/server/vdb$sis;
...
.field private mV:Landroid/app/AlertDialog;

.field private nV:Lcom/oneplus/android/server/vdb$tsu;

.field private final oV:Ljava/util/LinkedList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private final pV:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/oneplus/android/server/vdb;->UV:Ljava/util/List;
    ...
    sput v1, Lcom/oneplus/android/server/vdb;->DW:I
    ...
    sput v2, Lcom/oneplus/android/server/vdb;->KW:I
    ...
    sput-wide v2, Lcom/oneplus/android/server/vdb;->QW:J

    sput-boolean v1, Lcom/oneplus/android/server/vdb;->RW:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/vdb;->jV:Lcom/oneplus/android/server/vdb$zta;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/vdb;->oV:Ljava/util/LinkedList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/oneplus/android/server/vdb;->pV:Ljava/util/List;

    const/4 v0, 0x6

    new-array v0, v0, [J

    iput-object v0, p0, Lcom/oneplus/android/server/vdb;->qV:[J
    ...
    iput v0, p0, Lcom/oneplus/android/server/vdb;->yV:I
    ...
    iput-boolean v1, p0, Lcom/oneplus/android/server/vdb;->Ct:Z
    ...
    iput-boolean v1, p0, Lcom/oneplus/android/server/vdb;->MV:Z

    iput-boolean v0, p0, Lcom/oneplus/android/server/vdb;->OV:Z
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/vdb;->PV:Landroid/hardware/SensorEventListener;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/vdb;->QV:Landroid/media/AudioManager$AudioRecordingCallback;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/vdb;->RV:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/vdb;->Jn:Landroid/app/IProcessObserver;
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/vdb;->lV:Lcom/oneplus/android/server/vdb$sis;

    iget-object p0, p0, Lcom/oneplus/android/server/vdb;->lV:Lcom/oneplus/android/server/vdb$sis;
...
.method private Aq()V
    ...
    sget-boolean v0, Lcom/oneplus/android/server/vdb;->OQ:Z
    ...
    sget-boolean v2, Lcom/oneplus/android/server/vdb;->_W:Z
    ...
    :cond_0
    invoke-direct {p0}, Lcom/oneplus/android/server/vdb;->nq()I
    ...
    iget v2, p0, Lcom/oneplus/android/server/vdb;->xV:I
    ...
    :cond_4
    invoke-direct {p0}, Lcom/oneplus/android/server/vdb;->Zq()I
...
.method private Bq()V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/vdb;->sV:Ljava/lang/String;

    iget-object v1, p0, Lcom/oneplus/android/server/vdb;->tV:Ljava/lang/String;
    ...
    :cond_0
    invoke-direct {p0}, Lcom/oneplus/android/server/vdb;->wq()Z
    ...
    iget-boolean v0, p0, Lcom/oneplus/android/server/vdb;->OV:Z
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/vdb;->tV:Ljava/lang/String;
    ...
    iget-boolean v0, p0, Lcom/oneplus/android/server/vdb;->KV:Z
    ...
    :cond_7
    iget v0, p0, Lcom/oneplus/android/server/vdb;->yV:I
...
.method static synthetic D(Z)Z
    ...
    sput-boolean p0, Lcom/oneplus/android/server/vdb;->SV:Z
...
.method private Dq()V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/vdb;->mV:Landroid/app/AlertDialog;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/vdb;->mV:Landroid/app/AlertDialog;
...
.method private Gq()V
    ...
    sget-wide v1, Lcom/oneplus/android/server/vdb;->OW:J

    sget-wide v3, Lcom/oneplus/android/server/vdb;->NW:J

    sub-long/2addr v1, v3

    sput-wide v1, Lcom/oneplus/android/server/vdb;->QW:J
    ...
    sput-boolean v2, Lcom/oneplus/android/server/vdb;->WW:Z

    iget-boolean v3, p0, Lcom/oneplus/android/server/vdb;->EV:Z
    ...
    iget-boolean v3, p0, Lcom/oneplus/android/server/vdb;->Ct:Z

    if-eqz v3, :cond_2

    sget-boolean v3, Lcom/oneplus/android/server/vdb;->OQ:Z
    ...
    iget v4, p0, Lcom/oneplus/android/server/vdb;->xV:I
    ...
    sput-boolean v2, Lcom/oneplus/android/server/vdb;->TW:Z
...
.method private Iq()V
    ...
    sput-wide v0, Lcom/oneplus/android/server/vdb;->NW:J
    ...
    iget-object v2, p0, Lcom/oneplus/android/server/vdb;->sV:Ljava/lang/String;
    ...
    sget-object v2, Lcom/oneplus/android/server/vdb;->eW:Ljava/lang/String;
    ...
    sget-boolean v1, Lcom/oneplus/android/server/vdb;->_W:Z
...
.method private Lb(I)Z
    ...
    sget-object p1, Lcom/oneplus/android/server/vdb;->eW:Ljava/lang/String;
...
.method private Lq()V
    ...
    sget-wide v1, Lcom/oneplus/android/server/vdb;->MW:J

    sget-wide v3, Lcom/oneplus/android/server/vdb;->LW:J
    ...
    sget v3, Lcom/oneplus/android/server/vdb;->zW:I

    add-int/2addr v3, v1

    sput v3, Lcom/oneplus/android/server/vdb;->zW:I
    ...
    :cond_0
    sget-boolean v3, Lcom/oneplus/android/server/vdb;->TW:Z
    ...
    iget-boolean v3, p0, Lcom/oneplus/android/server/vdb;->HV:Z
    ...
    sget-boolean v5, Lcom/oneplus/android/server/vdb;->OQ:Z
    ...
    iput-boolean v2, p0, Lcom/oneplus/android/server/vdb;->HV:Z
    ...
    iput-boolean v1, p0, Lcom/oneplus/android/server/vdb;->IV:Z
...
.method private Mb(I)V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/vdb;->pV:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/oneplus/android/server/vdb;->pV:Ljava/util/List;
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/vdb;->pV:Ljava/util/List;
...
.method private Nq()V
    ...
    sput-wide v0, Lcom/oneplus/android/server/vdb;->LW:J
...
.method private Pq()Z
    ...
    iget-boolean v1, p0, Lcom/oneplus/android/server/vdb;->EV:Z
    ...
    iget-boolean v1, p0, Lcom/oneplus/android/server/vdb;->MV:Z
...
.method private Qq()V
    ...
    sget-object v4, Lcom/oneplus/android/server/vdb;->eW:Ljava/lang/String;
    ...
    :cond_1
    iget v3, p0, Lcom/oneplus/android/server/vdb;->yV:I
    ...
    :cond_2
    iget-object v3, p0, Lcom/oneplus/android/server/vdb;->mV:Landroid/app/AlertDialog;
...
.method private Wq()V
    ...
    sput v0, Lcom/oneplus/android/server/rtg;->ZU:I
...
.method private Xq()V
    ...
    sget v0, Lcom/oneplus/android/server/rtg;->ZU:I
...
.method private Yq()V
    ...
    sget v1, Lcom/oneplus/android/server/vdb;->JW:I
...
.method private Zq()I
    ...
    iput-boolean v1, p0, Lcom/oneplus/android/server/vdb;->FV:Z

    iget-boolean v2, p0, Lcom/oneplus/android/server/vdb;->EV:Z
    ...
    :cond_1
    sget-boolean v1, Lcom/oneplus/android/server/vdb;->OQ:Z
...
.method static synthetic a(Lcom/oneplus/android/server/vdb;)Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/vdb;->pV:Ljava/util/List;
...
.method static synthetic access$1200()I
    ...
    sget v0, Lcom/oneplus/android/server/vdb;->FW:I
...
.method static synthetic access$2202(Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object p0, Lcom/oneplus/android/server/vdb;->eW:Ljava/lang/String;
...
.method static synthetic access$302(Z)Z
    ...
    sput-boolean p0, Lcom/oneplus/android/server/vdb;->UW:Z
...
.method static synthetic access$3500()I
    ...
    sget v0, Lcom/oneplus/android/server/vdb;->HW:I
...
.method static synthetic access$6100()Ljava/util/List;
    ...
    sget-object v0, Lcom/oneplus/android/server/vdb;->UV:Ljava/util/List;
...
.method static synthetic bio(Lcom/oneplus/android/server/vdb;)Landroid/app/ActivityManager$StackInfo;
    ...
    invoke-direct {p0}, Lcom/oneplus/android/server/vdb;->tq()Landroid/app/ActivityManager$StackInfo;
...
.method private c(J)V
    ...
    iget-object v2, p0, Lcom/oneplus/android/server/vdb;->qV:[J
    ...
    :cond_1
    iget-object v1, p0, Lcom/oneplus/android/server/vdb;->qV:[J
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/vdb;->qV:[J
...
.method static synthetic cno(Lcom/oneplus/android/server/vdb;)I
    ...
    iget p0, p0, Lcom/oneplus/android/server/vdb;->yV:I
...
.method static synthetic dma(Lcom/oneplus/android/server/vdb;)Lcom/oneplus/android/server/vdb$tsu;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/vdb;->nV:Lcom/oneplus/android/server/vdb$tsu;
...
.method private dq()V
    ...
    sget v2, Lcom/oneplus/android/server/vdb;->GW:I
...
.method private dumpInternal(Ljava/io/PrintWriter;)V
    ...
    iget v1, p0, Lcom/oneplus/android/server/vdb;->xV:I
...
.method private fq()V
    ...
    sput v0, Lcom/oneplus/android/server/vdb;->DW:I
...
.method private fto(II)I
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/oneplus/android/server/vdb;->sq()Lsis/you/you/you/zta/zta;

    move-result-object v2

    if-eqz v2, :cond_0

    iget-object p0, p0, Lcom/oneplus/android/server/vdb;->kV:Lsis/you/you/you/zta/zta;
...
.method static synthetic ga(Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object p0, Lcom/oneplus/android/server/vdb;->gW:Ljava/lang/String;
...
.method static synthetic gck(Lcom/oneplus/android/server/vdb;)Z
    ...
    iget-boolean p0, p0, Lcom/oneplus/android/server/vdb;->OV:Z
...
.method static synthetic ge()I
    ...
    sget v0, Lcom/oneplus/android/server/vdb;->KW:I
...
.method static synthetic gwm(Lcom/oneplus/android/server/vdb;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/vdb;->vV:Ljava/lang/String;
...
.method private hq()V
    ...
    iput-object v1, p0, Lcom/oneplus/android/server/vdb;->mV:Landroid/app/AlertDialog;
    ...
    :cond_1
    invoke-direct {p0}, Lcom/oneplus/android/server/vdb;->Oq()Z
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/vdb;->mV:Landroid/app/AlertDialog;
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/vdb;->mV:Landroid/app/AlertDialog;
...
.method static synthetic ie()Z
    ...
    sget-boolean v0, Lcom/oneplus/android/server/vdb;->SV:Z
...
.method private iq()V
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/vdb;->vV:Ljava/lang/String;
...
.method static synthetic ivd(Lcom/oneplus/android/server/vdb;)I
    ...
    iput v1, p0, Lcom/oneplus/android/server/vdb;->xV:I
...
.method private jq()V
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/vdb;->PV:Landroid/hardware/SensorEventListener;
...
.method private lq()V
    ...
    sget v1, Lcom/oneplus/android/server/rtg;->YU:I

    add-int/2addr v1, v0

    sput v1, Lcom/oneplus/android/server/rtg;->YU:I
...
.method private mq()V
    ...
    sget v1, Lcom/oneplus/android/server/vdb;->DW:I
    ...
    sget v2, Lcom/oneplus/android/server/vdb;->JW:I
...
.method static synthetic qeg(I)I
    ...
    sput p0, Lcom/oneplus/android/server/vdb;->FW:I
...
.method private qq()V
    ...
    sget-boolean v1, Lcom/oneplus/android/server/vdb;->VW:Z
...
.method private rq()V
    ...
    :cond_0
    iput-boolean v2, p0, Lcom/oneplus/android/server/vdb;->KV:Z

    goto :goto_1

    :cond_1
    :goto_0
    iput-boolean v3, p0, Lcom/oneplus/android/server/vdb;->KV:Z

    :goto_1
    iget-boolean v4, p0, Lcom/oneplus/android/server/vdb;->KV:Z
...
.method private sis(Ljava/lang/String;Landroid/os/IBinder;)I
    ...
    sget-object v1, Lcom/oneplus/android/server/vdb;->UV:Ljava/util/List;
    ...
    iput-object v1, p0, Lcom/oneplus/android/server/vdb;->jV:Lcom/oneplus/android/server/vdb$zta;

    iget-object p1, p0, Lcom/oneplus/android/server/vdb;->jV:Lcom/oneplus/android/server/vdb$zta;
    ...
    iput v2, p0, Lcom/oneplus/android/server/vdb;->wV:I
    ...
    :cond_5
    iget-boolean p1, p0, Lcom/oneplus/android/server/vdb;->EV:Z

    if-nez p1, :cond_6

    iget-boolean p1, p0, Lcom/oneplus/android/server/vdb;->Ct:Z
    ...
    sget-boolean p1, Lcom/oneplus/android/server/vdb;->_W:Z
    ...
    :cond_8
    :goto_1
    sget-boolean p1, Lcom/oneplus/android/server/vdb;->OQ:Z
    ...
    sget-boolean v1, Lcom/oneplus/android/server/vdb;->YW:Z
...
.method private sq()Lsis/you/you/you/zta/zta;
    .locals 3

    iget-object v0, p0, Lcom/oneplus/android/server/vdb;->kV:Lsis/you/you/you/zta/zta;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/vdb;->kV:Lsis/you/you/you/zta/zta;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method static synthetic ssp(Lcom/oneplus/android/server/vdb;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/vdb;->vV:Ljava/lang/String;
...
.method private tq()Landroid/app/ActivityManager$StackInfo;
    .locals 2
...
.method static synthetic vdw(Lcom/oneplus/android/server/vdb;)Ljava/util/LinkedList;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/vdb;->oV:Ljava/util/LinkedList;
...
.method private vq()V
    ...
    :cond_1
    iget-object v0, p0, Lcom/oneplus/android/server/vdb;->PV:Landroid/hardware/SensorEventListener;
...
.method private you(Ljava/lang/String;Landroid/os/IBinder;)I
    ...
    iget-object p2, p0, Lcom/oneplus/android/server/vdb;->oV:Ljava/util/LinkedList;

    iget-object v1, p0, Lcom/oneplus/android/server/vdb;->jV:Lcom/oneplus/android/server/vdb$zta;
    ...
    :cond_0
    sget-object p2, Lcom/oneplus/android/server/vdb;->UV:Ljava/util/List;

    invoke-interface {p2, p1}, Ljava/util/List;->remove(Ljava/lang/Object;)Z

    iget p2, p0, Lcom/oneplus/android/server/vdb;->xV:I
    ...
    iput p2, p0, Lcom/oneplus/android/server/vdb;->xV:I

    :cond_1
    sget-boolean p2, Lcom/oneplus/android/server/vdb;->OQ:Z
    ...
    :cond_3
    iget p1, p0, Lcom/oneplus/android/server/vdb;->xV:I
...
.method private you(Landroid/os/IBinder;)Lcom/oneplus/android/server/vdb$zta;
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/vdb;->oV:Ljava/util/LinkedList;
...
.method static synthetic you(Lcom/oneplus/android/server/vdb;Z)Z
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/vdb;->OV:Z
...
.method private yq()V
    ...
    iget-boolean v2, p0, Lcom/oneplus/android/server/vdb;->OV:Z
...
.method static synthetic zta(Lcom/oneplus/android/server/vdb;I)I
    ...
    iput p1, p0, Lcom/oneplus/android/server/vdb;->yV:I
...
.method private zta(Ljava/lang/String;Landroid/os/IBinder;)I
    ...
    sget p1, Lcom/oneplus/android/server/vdb;->yW:I
...
.method static synthetic zta(Lcom/oneplus/android/server/vdb;Lcom/oneplus/android/server/vdb$tsu;)Lcom/oneplus/android/server/vdb$tsu;
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/vdb;->nV:Lcom/oneplus/android/server/vdb$tsu;
...
.method private zta(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    :cond_1
    iget-object p2, p0, Lcom/oneplus/android/server/vdb;->sV:Ljava/lang/String;

    iget-object p3, p0, Lcom/oneplus/android/server/vdb;->vV:Ljava/lang/String;
...
.method static synthetic zta(Lcom/oneplus/android/server/vdb;Z)Z
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/vdb;->KV:Z
...
.method public getMotorState()I
    ...
    :cond_2
    sget-boolean p0, Lcom/oneplus/android/server/vdb;->_W:Z
...
.method public le()V
    ...
    sget-boolean p0, Lcom/oneplus/android/server/vdb;->OQ:Z
...
.method public ne()V
    ...
    iput-boolean v0, p0, Lcom/oneplus/android/server/vdb;->Ct:Z
...
.method public systemReady()V
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/vdb;->Jn:Landroid/app/IProcessObserver;
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/vdb;->QV:Landroid/media/AudioManager$AudioRecordingCallback;
    ...
    iget-object v2, p0, Lcom/oneplus/android/server/vdb;->RV:Landroid/content/BroadcastReceiver;
