...
# instance fields
.field private AX:Lcom/oneplus/android/server/alertslider/rtg;

.field private mContext:Landroid/content/Context;

.field private qX:Lcom/oneplus/android/server/alertslider/zta;

.field private yX:Lcom/oneplus/android/server/alertslider/AlertSliderHw;

.field private zX:Lcom/oneplus/android/server/alertslider/rtg;
...
.method public getAlertSliderMode()I
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/alertslider/tsu;->qX:Lcom/oneplus/android/server/alertslider/zta;
...
.method public initInstance(Landroid/content/Context;Lcom/android/server/audio/AudioService;)V
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/alertslider/tsu;->zX:Lcom/oneplus/android/server/alertslider/rtg;
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/alertslider/tsu;->AX:Lcom/oneplus/android/server/alertslider/rtg;
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/alertslider/tsu;->qX:Lcom/oneplus/android/server/alertslider/zta;

    iget-object p1, p0, Lcom/oneplus/android/server/alertslider/tsu;->qX:Lcom/oneplus/android/server/alertslider/zta;

    iget-object p2, p0, Lcom/oneplus/android/server/alertslider/tsu;->zX:Lcom/oneplus/android/server/alertslider/rtg;

    invoke-virtual {p1, p2}, Lcom/oneplus/android/server/alertslider/zta;->zta(Lcom/oneplus/android/server/alertslider/rtg;)V

    iget-object p1, p0, Lcom/oneplus/android/server/alertslider/tsu;->qX:Lcom/oneplus/android/server/alertslider/zta;

    iget-object p2, p0, Lcom/oneplus/android/server/alertslider/tsu;->AX:Lcom/oneplus/android/server/alertslider/rtg;
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/alertslider/tsu;->qX:Lcom/oneplus/android/server/alertslider/zta;
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/alertslider/tsu;->yX:Lcom/oneplus/android/server/alertslider/AlertSliderHw;

    iget-object p0, p0, Lcom/oneplus/android/server/alertslider/tsu;->yX:Lcom/oneplus/android/server/alertslider/AlertSliderHw;
