...
# static fields
.field private static final Ju:Ljava/lang/String; = "motor_socket"

.field private static final tka:Ljava/lang/String; = "MotorSocketServer"

.field private static final uka:I = 0x400

.field private static final vka:I = 0x3
...
.field private ska:Landroid/net/LocalServerSocket;
...
.method public constructor <init>(Lcom/oneplus/android/server/vdb;Lcom/oneplus/android/server/vdb;Ljava/lang/String;)V
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/vdb$sis;->rka:Z
...
.method public If()V
    ...
    iput-boolean v0, p0, Lcom/oneplus/android/server/vdb$sis;->rka:Z
...
.method public run()V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/vdb$sis;->ska:Landroid/net/LocalServerSocket;

    :cond_1
    :goto_0
    iget-boolean v0, p0, Lcom/oneplus/android/server/vdb$sis;->rka:Z

    if-eqz v0, :cond_4

    iget-object v0, p0, Lcom/oneplus/android/server/vdb$sis;->ska:Landroid/net/LocalServerSocket;
    ...
    iget-boolean v2, p0, Lcom/oneplus/android/server/vdb$sis;->rka:Z
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/vdb$sis;->ska:Landroid/net/LocalServerSocket;
    ...
    :goto_2
    :try_start_5
    iget-object v1, p0, Lcom/oneplus/android/server/vdb$sis;->ska:Landroid/net/LocalServerSocket;
