...
.field private static final oka:Ljava/lang/String; = "MotorSocketServer"

.field private static final pka:I = 0x400

.field private static final qka:I = 0x3
...
.field private nka:Landroid/net/LocalServerSocket;
...
.method public constructor <init>(Lcom/oneplus/android/server/vdb;Lcom/oneplus/android/server/vdb;Ljava/lang/String;)V
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/vdb$sis;->mka:Z
...
.method public Jf()V
    ...
    iput-boolean v0, p0, Lcom/oneplus/android/server/vdb$sis;->mka:Z
...
.method public run()V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/vdb$sis;->nka:Landroid/net/LocalServerSocket;

    :cond_1
    :goto_0
    iget-boolean v0, p0, Lcom/oneplus/android/server/vdb$sis;->mka:Z

    if-eqz v0, :cond_4

    iget-object v0, p0, Lcom/oneplus/android/server/vdb$sis;->nka:Landroid/net/LocalServerSocket;
    ...
    iget-boolean v2, p0, Lcom/oneplus/android/server/vdb$sis;->mka:Z
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/vdb$sis;->nka:Landroid/net/LocalServerSocket;
    ...
    :goto_2
    :try_start_5
    iget-object v1, p0, Lcom/oneplus/android/server/vdb$sis;->nka:Landroid/net/LocalServerSocket;
