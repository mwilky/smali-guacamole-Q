...
# static fields
.field private static final Iu:Ljava/lang/String; = "motor_socket"

.field private static final fka:Ljava/lang/String; = "MotorSocketServer"

.field private static final gka:I = 0x400

.field private static final hka:I = 0x3


# instance fields
.field private dka:Z

.field private eka:Landroid/net/LocalServerSocket;
...
.method public constructor <init>(Lcom/oneplus/android/server/vdb;Lcom/oneplus/android/server/vdb;Ljava/lang/String;)V
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/vdb$sis;->dka:Z
...
.method public Jf()V
    ...
    iput-boolean v0, p0, Lcom/oneplus/android/server/vdb$sis;->dka:Z
...
.method public run()V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/vdb$sis;->eka:Landroid/net/LocalServerSocket;

    :cond_1
    :goto_0
    iget-boolean v0, p0, Lcom/oneplus/android/server/vdb$sis;->dka:Z

    if-eqz v0, :cond_4

    iget-object v0, p0, Lcom/oneplus/android/server/vdb$sis;->eka:Landroid/net/LocalServerSocket;
    ...
    iget-boolean v2, p0, Lcom/oneplus/android/server/vdb$sis;->dka:Z
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/vdb$sis;->eka:Landroid/net/LocalServerSocket;
    ...
    :goto_2
    :try_start_5
    iget-object v1, p0, Lcom/oneplus/android/server/vdb$sis;->eka:Landroid/net/LocalServerSocket;
