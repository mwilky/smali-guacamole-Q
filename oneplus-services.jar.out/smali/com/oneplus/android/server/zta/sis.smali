...
.field public static KX:Ljava/lang/String; = null

.field public static final LX:Ljava/lang/String; = "/sys/class/thermal/thermal_zone71/temp"

.field public static MDM:Z = false

.field public static final MX:Ljava/lang/String; = "/sys/class/power_supply/battery/temp"
...
.field private HX:Lcom/oneplus/android/server/zta/sis$zta;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/oneplus/android/server/zta/sis;->JX:Ljava/lang/String;

    const-string v0, "com.antutu.benchmark.ui.test.activity.ActivityTestResultDetails"

    sput-object v0, Lcom/oneplus/android/server/zta/sis;->KX:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/oneplus/android/server/zta/sis;->GX:Z

    new-instance v1, Lcom/oneplus/android/server/zta/sis$zta;

    invoke-direct {v1}, Lcom/oneplus/android/server/zta/sis$zta;-><init>()V

    iput-object v1, p0, Lcom/oneplus/android/server/zta/sis;->HX:Lcom/oneplus/android/server/zta/sis$zta;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/zta/sis;->IX:Ljava/lang/Runnable;
...
.method private Ia(Z)V
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/zta/sis;->IX:Ljava/lang/Runnable;
...
.method private Ja(Z)Z
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/zta/sis;->HX:Lcom/oneplus/android/server/zta/sis$zta;
    ...
    :goto_0
    iput v0, p1, Lcom/oneplus/android/server/zta/sis$zta;->CX:I

    iget-object p0, p0, Lcom/oneplus/android/server/zta/sis;->HX:Lcom/oneplus/android/server/zta/sis$zta;
    ...
    :goto_1
    iput v2, p0, Lcom/oneplus/android/server/zta/sis$zta;->DX:I
    ...
    :goto_2
    iput v0, p1, Lcom/oneplus/android/server/zta/sis$zta;->EX:I
    ...
    :goto_3
    iput v2, p0, Lcom/oneplus/android/server/zta/sis$zta;->FX:I
...
.method private dump()V
    ...
    iget-boolean v2, p0, Lcom/oneplus/android/server/zta/sis;->GX:Z
...
.method private kc(Ljava/lang/String;)Z
    ...
    :cond_0
    sget-object v1, Lcom/oneplus/android/server/zta/sis;->JX:Ljava/lang/String;
    ...
    iget-boolean v1, p0, Lcom/oneplus/android/server/zta/sis;->GX:Z

    if-nez v1, :cond_1

    iput-boolean v2, p0, Lcom/oneplus/android/server/zta/sis;->GX:Z

    goto :goto_0

    :cond_1
    sget-object v1, Lcom/oneplus/android/server/zta/sis;->KX:Ljava/lang/String;
    ...
    :goto_0
    iget-boolean p1, p0, Lcom/oneplus/android/server/zta/sis;->GX:Z
