...
.field private static final eda:Ljava/lang/String; = "-1"

.field private static final fda:Ljava/lang/String; = "android.intent.action.PHONE_STATE"

.field private static final gda:J = 0x1f4L

.field private static final hda:Landroid/net/Uri;

.field private static ida:Lcom/oneplus/android/server/scene/vju;

.field private static jda:Lcom/oneplus/android/server/scene/vju;

.field private static kda:Landroid/view/View;


# instance fields
.field private Wca:Landroid/view/WindowManager;

.field private Xca:Landroid/animation/ValueAnimator;

.field private Yca:Landroid/animation/ValueAnimator;

.field private Zca:Lcom/oneplus/android/server/scene/vju;

.field private _ca:Lcom/oneplus/android/server/scene/cgv$zta;
...
.field private dda:Ljava/util/ArrayList;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/oneplus/android/server/scene/cgv;->hda:Landroid/net/Uri;

    const/4 v0, 0x0

    sput-object v0, Lcom/oneplus/android/server/scene/cgv;->ida:Lcom/oneplus/android/server/scene/vju;

    sput-object v0, Lcom/oneplus/android/server/scene/cgv;->jda:Lcom/oneplus/android/server/scene/vju;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->Wca:Landroid/view/WindowManager;

    iput-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->Zca:Lcom/oneplus/android/server/scene/vju;

    iput-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->mESportGuider:Lcom/oneplus/android/server/scene/tsu;

    const-string v0, ""

    iput-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->ada:Ljava/lang/String;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/oneplus/android/server/scene/cgv;->bda:Z

    iput-boolean v0, p0, Lcom/oneplus/android/server/scene/cgv;->cda:Z

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/oneplus/android/server/scene/cgv;->dda:Ljava/util/ArrayList;
    ...
    iput-object p2, p0, Lcom/oneplus/android/server/scene/cgv;->Wca:Landroid/view/WindowManager;
    ...
    iput-object v1, p0, Lcom/oneplus/android/server/scene/cgv;->Xca:Landroid/animation/ValueAnimator;
    ...
    iput-object p2, p0, Lcom/oneplus/android/server/scene/cgv;->Yca:Landroid/animation/ValueAnimator;

    invoke-direct {p0}, Lcom/oneplus/android/server/scene/cgv;->listenForCallState()V

    invoke-direct {p0}, Lcom/oneplus/android/server/scene/cgv;->Ur()V

    invoke-direct {p0}, Lcom/oneplus/android/server/scene/cgv;->Vr()V
    ...
    iput-object p2, p0, Lcom/oneplus/android/server/scene/cgv;->_ca:Lcom/oneplus/android/server/scene/cgv$zta;
    ...
    sget-object p2, Lcom/oneplus/android/server/scene/cgv;->hda:Landroid/net/Uri;

    iget-object v1, p0, Lcom/oneplus/android/server/scene/cgv;->_ca:Lcom/oneplus/android/server/scene/cgv$zta;
    ...
    invoke-direct {p0}, Lcom/oneplus/android/server/scene/cgv;->Tr()V
...
.method private Sa(Z)V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->Yca:Landroid/animation/ValueAnimator;
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/scene/cgv;->Yca:Landroid/animation/ValueAnimator;
    ...
    :cond_0
    iget-object p0, p0, Lcom/oneplus/android/server/scene/cgv;->Yca:Landroid/animation/ValueAnimator;
...
.method private Tr()V
    ...
    iget-object v4, p0, Lcom/oneplus/android/server/scene/cgv;->dda:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/cgv;->dda:Ljava/util/ArrayList;
...
.method private Wr()V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->Zca:Lcom/oneplus/android/server/scene/vju;
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/scene/cgv;->Zca:Lcom/oneplus/android/server/scene/vju;
    ...
    iput-object v1, p0, Lcom/oneplus/android/server/scene/cgv;->Zca:Lcom/oneplus/android/server/scene/vju;
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->Wca:Landroid/view/WindowManager;
...
.method private Xr()V
    ...
    invoke-direct {p0, v0}, Lcom/oneplus/android/server/scene/cgv;->Sa(Z)V
...
.method private Yr()V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->Xca:Landroid/animation/ValueAnimator;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/cgv;->Xca:Landroid/animation/ValueAnimator;
...
.method public static af()I
    ...
    sget-object v0, Lcom/oneplus/android/server/scene/cgv;->kda:Landroid/view/View;
...
.method private hide(Z)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/oneplus/android/server/scene/cgv;->Zca:Lcom/oneplus/android/server/scene/vju;

    if-eqz p1, :cond_1

    iget-object v1, p0, Lcom/oneplus/android/server/scene/cgv;->Wca:Landroid/view/WindowManager;
    ...
    sput-object v0, Lcom/oneplus/android/server/scene/cgv;->kda:Landroid/view/View;
...
.method static synthetic rtg(Lcom/oneplus/android/server/scene/cgv;)Landroid/view/WindowManager;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/cgv;->Wca:Landroid/view/WindowManager;
...
.method private show(Z)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/oneplus/android/server/scene/cgv;->Xca:Landroid/animation/ValueAnimator;
...
.method static synthetic sis(Lcom/oneplus/android/server/scene/cgv;)Lcom/oneplus/android/server/scene/vju;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/cgv;->Zca:Lcom/oneplus/android/server/scene/vju;
...
.method static synthetic ssp(Lcom/oneplus/android/server/scene/cgv;)Z
    ...
    iget-boolean p0, p0, Lcom/oneplus/android/server/scene/cgv;->bda:Z
...
.method static synthetic you(Lcom/oneplus/android/server/scene/cgv;Z)Z
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/scene/cgv;->bda:Z
...
.method static synthetic zta(Lcom/oneplus/android/server/scene/cgv;Lcom/oneplus/android/server/scene/vju;)Lcom/oneplus/android/server/scene/vju;
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/scene/cgv;->Zca:Lcom/oneplus/android/server/scene/vju;
...
.method public O(Z)V
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/scene/cgv;->cda:Z
...
.method public bf()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/cgv;->ada:Ljava/lang/String;
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    :cond_0
    iget-object p2, p0, Lcom/oneplus/android/server/scene/cgv;->ada:Ljava/lang/String;

    iput-object p1, p0, Lcom/oneplus/android/server/scene/cgv;->ada:Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/scene/cgv;->ada:Ljava/lang/String;
...
.method public zta(Landroid/content/res/Configuration;)V
    ...
    iget-boolean p1, p0, Lcom/oneplus/android/server/scene/cgv;->cda:Z
