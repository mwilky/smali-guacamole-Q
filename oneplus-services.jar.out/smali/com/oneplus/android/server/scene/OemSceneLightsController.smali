...
# instance fields
.field private lda:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lcom/oneplus/android/server/scene/OemSceneLightsController$LightsMode;->Kja:Lcom/oneplus/android/server/scene/OemSceneLightsController$LightsMode;
    ...
    sput v0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->nda:I
    ...
    sput v0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->oda:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->mda:I
...
.method private bio(III)Z
    ...
    iget v0, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->mda:I

    sget v1, Lcom/oneplus/android/server/scene/OemSceneLightsController;->nda:I
    ...
    :cond_0
    sget v1, Lcom/oneplus/android/server/scene/OemSceneLightsController;->oda:I
...
.method private qeg(IZ)V
    ...
    :try_start_0
    iget p2, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->mda:I

    shl-int p1, v1, p1

    or-int/2addr p1, p2

    iput p1, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->mda:I
...
.method public ef()Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->lda:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->lda:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;

    :cond_0
    iget-object p0, p0, Lcom/oneplus/android/server/scene/OemSceneLightsController;->lda:Lcom/oneplus/android/server/scene/OemSceneLightsController$ZenModeLedController;
