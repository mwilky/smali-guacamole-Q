...
.field private static final BZ:I = 0x4
...
.field private static final CZ:I = 0x5

.field private static final DEBUG:Z

.field private static final DZ:I = 0x6

.field private static final EZ:I = 0x7

.field private static final FZ:I = 0x8

.field private static final GZ:I = 0x9

.field private static final HZ:I = 0xa

.field private static final IZ:I = 0xb
...
.field private static final WZ:I = 0x190

.field private static final XZ:J = 0x2710L

.field private static final YZ:F = 1.1f

.field private static final ZZ:I = 0x3e

.field private static final _Z:I = 0x10
...
.field private final tZ:Lcom/oneplus/android/server/display/ibl;

.field private final uZ:Lcom/oneplus/android/server/display/gwm;

.field private vZ:Lcom/oneplus/android/server/display/OpColorModeManager;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/oneplus/android/server/display/dma;->lZ:Z
    ...
    iput-object v2, p0, Lcom/oneplus/android/server/display/dma;->oZ:[[I

    iput-boolean v0, p0, Lcom/oneplus/android/server/display/dma;->qZ:Z

    iput-boolean v1, p0, Lcom/oneplus/android/server/display/dma;->rZ:Z

    const/4 v2, -0x1

    iput v2, p0, Lcom/oneplus/android/server/display/dma;->wZ:I
    ...
    iput-object v2, p0, Lcom/oneplus/android/server/display/dma;->tZ:Lcom/oneplus/android/server/display/ibl;
    ...
    iput v0, p0, Lcom/oneplus/android/server/display/dma;->fZ:I

    iput v0, p0, Lcom/oneplus/android/server/display/dma;->hZ:I

    iput v1, p0, Lcom/oneplus/android/server/display/dma;->gZ:I
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/display/dma;->uZ:Lcom/oneplus/android/server/display/gwm;
...
.method private Ar()Z
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/display/dma;->vZ:Lcom/oneplus/android/server/display/OpColorModeManager;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/display/dma;->vZ:Lcom/oneplus/android/server/display/OpColorModeManager;
...
.method private Ka(Z)V
    ...
    iget p1, p0, Lcom/oneplus/android/server/display/dma;->fZ:I
    ...
    iget-boolean p1, p0, Lcom/oneplus/android/server/display/dma;->sZ:Z
...
.method private Oa(Z)V
    ...
    iget v1, p0, Lcom/oneplus/android/server/display/dma;->fZ:I
...
.method private Pa(Z)V
    ...
    iget-boolean p1, p0, Lcom/oneplus/android/server/display/dma;->jZ:Z
...
.method private Qb(I)V
    ...
    :cond_2
    :goto_0
    iget-boolean p1, p0, Lcom/oneplus/android/server/display/dma;->mZ:Z
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/display/dma;->uZ:Lcom/oneplus/android/server/display/gwm;
...
.method private Ub(I)V
    ...
    iget-boolean v0, p0, Lcom/oneplus/android/server/display/dma;->jZ:Z
    ...
    invoke-direct {p0, v1}, Lcom/oneplus/android/server/display/dma;->Rb(I)Ljava/lang/String;
    ...
    :cond_1
    iget-object v0, p0, Lcom/oneplus/android/server/display/dma;->tZ:Lcom/oneplus/android/server/display/ibl;
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/display/dma;->tZ:Lcom/oneplus/android/server/display/ibl;
...
.method private Vb(I)V
    ...
    iget v3, p0, Lcom/oneplus/android/server/display/dma;->gZ:I
    ...
    :cond_0
    iput-boolean v1, p0, Lcom/oneplus/android/server/display/dma;->mZ:Z
    ...
    :goto_0
    iput-boolean v4, p0, Lcom/oneplus/android/server/display/dma;->mZ:Z
...
.method private Wb(I)V
    ...
    iget-boolean v1, p0, Lcom/oneplus/android/server/display/dma;->pZ:Z
    ...
    :cond_2
    iput-boolean v2, p0, Lcom/oneplus/android/server/display/dma;->pZ:Z
...
.method private Xb(I)V
    ...
    iget v2, p0, Lcom/oneplus/android/server/display/dma;->fZ:I
    ...
    :cond_0
    iget v0, p0, Lcom/oneplus/android/server/display/dma;->fZ:I
...
.method private cgv(II)V
    ...
    iget v2, p0, Lcom/oneplus/android/server/display/dma;->mBrightness:I

    invoke-direct {p0, p1, v2}, Lcom/oneplus/android/server/display/dma;->veq(II)[[I

    move-result-object v2

    iget v3, p0, Lcom/oneplus/android/server/display/dma;->mBrightness:I

    invoke-direct {p0, p2, v3}, Lcom/oneplus/android/server/display/dma;->veq(II)[[I

    move-result-object v3

    iget-object v4, p0, Lcom/oneplus/android/server/display/dma;->tZ:Lcom/oneplus/android/server/display/ibl;

    invoke-virtual {v4}, Lcom/oneplus/android/server/display/igw;->cancelAnimator()V

    iget-object v4, p0, Lcom/oneplus/android/server/display/dma;->tZ:Lcom/oneplus/android/server/display/ibl;

    invoke-virtual {v4, p1}, Lcom/oneplus/android/server/display/igw;->B(I)V

    iget-object v4, p0, Lcom/oneplus/android/server/display/dma;->tZ:Lcom/oneplus/android/server/display/ibl;

    invoke-virtual {v4, p2}, Lcom/oneplus/android/server/display/igw;->C(I)V
    ...
    invoke-virtual {v4, p1}, Lcom/oneplus/android/server/display/igw;->setAnimator(Landroid/animation/ValueAnimator;)V
    ...
    invoke-direct {p2, p0, v2, v3}, Lcom/oneplus/android/server/display/wtn;-><init>(Lcom/oneplus/android/server/display/dma;[[I[[I)V
    ...
    invoke-direct {p2, p0, v3}, Lcom/oneplus/android/server/display/gck;-><init>(Lcom/oneplus/android/server/display/dma;[[I)V

    invoke-virtual {p1, p2}, Landroid/animation/ValueAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iget-object p0, p0, Lcom/oneplus/android/server/display/dma;->tZ:Lcom/oneplus/android/server/display/ibl;
...
.method private getWhitePoint()[I
    ...
    iget-boolean v1, p0, Lcom/oneplus/android/server/display/dma;->mZ:Z
    ...
    :cond_2
    iget-object v0, p0, Lcom/oneplus/android/server/display/dma;->uZ:Lcom/oneplus/android/server/display/gwm;
...
.method private les(IZ)V
    ...
    iget v4, p0, Lcom/oneplus/android/server/display/dma;->gZ:I

    invoke-virtual {p0, v0, v3, v4}, Lcom/oneplus/android/server/display/dma;->rtg(III)I
    ...
    invoke-virtual {p0, p1, v3, v4}, Lcom/oneplus/android/server/display/dma;->rtg(III)I
    ...
    invoke-direct {p0, v5}, Lcom/oneplus/android/server/display/dma;->Tb(I)Ljava/lang/String;
    ...
    invoke-direct {p0, v3, p1}, Lcom/oneplus/android/server/display/dma;->lqr(II)V
    ...
    :cond_8
    invoke-direct {p0, v0, v3}, Lcom/oneplus/android/server/display/dma;->cgv(II)V
...
.method private lqr(II)V
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/display/dma;->oZ:[[I

    iget-object p1, p0, Lcom/oneplus/android/server/display/dma;->cZ:Lcom/oneplus/android/server/display/bio;

    iget-object p2, p0, Lcom/oneplus/android/server/display/dma;->oZ:[[I
...
.method static synthetic rtg(Lcom/oneplus/android/server/display/dma;)Lcom/oneplus/android/server/display/gwm;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/display/dma;->uZ:Lcom/oneplus/android/server/display/gwm;
...
.method static synthetic rtg(Lcom/oneplus/android/server/display/dma;Z)V
    ...
    invoke-direct {p0, p1}, Lcom/oneplus/android/server/display/dma;->Ka(Z)V
...
.method private veq(II)[[I
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/display/dma;->oZ:[[I

    goto :goto_0

    :cond_2
    iget-object p1, p0, Lcom/oneplus/android/server/display/dma;->uZ:Lcom/oneplus/android/server/display/gwm;
...
.method static synthetic you(Lcom/oneplus/android/server/display/dma;I)V
    .locals 0
...
.method static synthetic zta(Lcom/oneplus/android/server/display/dma;I)I
    .locals 0
...
.method static synthetic zta(Lcom/oneplus/android/server/display/dma;)[[I
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/display/dma;->oZ:[[I
...
.method public G(Z)V
    ...
    :cond_1
    iput-boolean p1, p0, Lcom/oneplus/android/server/display/dma;->jZ:Z
...
.method public H(Z)V
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/oneplus/android/server/display/dma;->pZ:Z
    ...
    :cond_1
    iput-boolean p1, p0, Lcom/oneplus/android/server/display/dma;->pZ:Z
...
.method public bvj(IZ)V
    ...
    iput p1, p0, Lcom/oneplus/android/server/display/dma;->fZ:I
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-boolean v2, p0, Lcom/oneplus/android/server/display/dma;->pZ:Z
...
.method public zta(Lcom/oneplus/android/server/display/OpColorModeManager;)V
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/display/dma;->vZ:Lcom/oneplus/android/server/display/OpColorModeManager;
