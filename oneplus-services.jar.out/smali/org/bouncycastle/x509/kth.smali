...
.field private Mla:Ljava/math/BigInteger;

.field private Nla:[B

.field private Ola:Z

.field private Pla:Lorg/bouncycastle/x509/cno;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/x509/kth;->Kla:Z

    iput-boolean v0, p0, Lorg/bouncycastle/x509/kth;->Lla:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lorg/bouncycastle/x509/kth;->Mla:Ljava/math/BigInteger;

    iput-object v1, p0, Lorg/bouncycastle/x509/kth;->Nla:[B

    iput-boolean v0, p0, Lorg/bouncycastle/x509/kth;->Ola:Z
...
.method public V(Z)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/x509/kth;->Lla:Z
...
.method public W(Z)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/x509/kth;->Kla:Z
...
.method public X(Z)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/x509/kth;->Ola:Z
...
.method public Xf()Lorg/bouncycastle/x509/cno;
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/kth;->Pla:Lorg/bouncycastle/x509/cno;
...
.method public Yf()[B
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/kth;->Nla:[B
...
.method public Zf()Ljava/math/BigInteger;
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/kth;->Mla:Ljava/math/BigInteger;
...
.method public _f()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/x509/kth;->Lla:Z
...
.method public ag()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/x509/kth;->Kla:Z
...
.method public bg()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/x509/kth;->Ola:Z
...
.method public clone()Ljava/lang/Object;
    ...
    iget-boolean v1, p0, Lorg/bouncycastle/x509/kth;->Kla:Z

    iput-boolean v1, v0, Lorg/bouncycastle/x509/kth;->Kla:Z

    iget-boolean v1, p0, Lorg/bouncycastle/x509/kth;->Lla:Z

    iput-boolean v1, v0, Lorg/bouncycastle/x509/kth;->Lla:Z

    iget-object v1, p0, Lorg/bouncycastle/x509/kth;->Mla:Ljava/math/BigInteger;

    iput-object v1, v0, Lorg/bouncycastle/x509/kth;->Mla:Ljava/math/BigInteger;

    iget-object v1, p0, Lorg/bouncycastle/x509/kth;->Pla:Lorg/bouncycastle/x509/cno;

    iput-object v1, v0, Lorg/bouncycastle/x509/kth;->Pla:Lorg/bouncycastle/x509/cno;

    iget-boolean v1, p0, Lorg/bouncycastle/x509/kth;->Ola:Z

    iput-boolean v1, v0, Lorg/bouncycastle/x509/kth;->Ola:Z
    ...
    iput-object p0, v0, Lorg/bouncycastle/x509/kth;->Nla:[B
...
.method public cno([B)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/kth;->Nla:[B
...
.method public match(Ljava/lang/Object;)Z
    ...
    :try_start_0
    sget-object v2, Lorg/bouncycastle/asn1/x509/gwm;->Kla:Lorg/bouncycastle/asn1/bvj;
    ...
    iget-object v2, p0, Lorg/bouncycastle/x509/kth;->Mla:Ljava/math/BigInteger;
    ...
    :cond_4
    iget-boolean v0, p0, Lorg/bouncycastle/x509/kth;->Ola:Z
    ...
    iget-object v2, p0, Lorg/bouncycastle/x509/kth;->Nla:[B
...
.method public sis(Ljava/math/BigInteger;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/kth;->Mla:Ljava/math/BigInteger;
...
.method public zta(Lorg/bouncycastle/x509/cno;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/kth;->Pla:Lorg/bouncycastle/x509/cno;
