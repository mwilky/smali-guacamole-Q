...
# instance fields
.field private Xka:Ljava/security/spec/ECParameterSpec;

.field private Yka:Ljava/lang/String;
...
.method protected engineGetEncoded(Ljava/lang/String;)[B
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->oa(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_2

    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Xka:Ljava/security/spec/ECParameterSpec;
    ...
    :cond_0
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Yka:Ljava/lang/String;

    if-eqz p0, :cond_1

    new-instance p1, Lorg/bouncycastle/asn1/ibl/veq;

    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/bio;->Ea(Ljava/lang/String;)Lorg/bouncycastle/asn1/bvj;
...
.method protected engineGetParameterSpec(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Yka:Ljava/lang/String;

    if-eqz v0, :cond_2

    invoke-static {v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/bio;->Ea(Ljava/lang/String;)Lorg/bouncycastle/asn1/bvj;
    ...
    :cond_2
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Xka:Ljava/security/spec/ECParameterSpec;
...
.method protected engineInit(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Yka:Ljava/lang/String;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Yka:Ljava/lang/String;
    ...
    iput-object v6, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Xka:Ljava/security/spec/ECParameterSpec;
    ...
    :goto_0
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Yka:Ljava/lang/String;

    check-cast p1, Ljava/security/spec/ECParameterSpec;

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Xka:Ljava/security/spec/ECParameterSpec;
...
.method protected engineInit([BLjava/lang/String;)V
    ...
    invoke-virtual {p0, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->oa(Ljava/lang/String;)Z
    ...
    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Yka:Ljava/lang/String;
