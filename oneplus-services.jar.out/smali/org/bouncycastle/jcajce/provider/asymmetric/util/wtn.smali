...
# instance fields
.field private VAa:Ljava/util/Hashtable;
...
.method constructor <init>(Ljava/util/Hashtable;Ljava/util/Vector;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/util/wtn;->VAa:Ljava/util/Hashtable;

    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/util/wtn;->WAa:Ljava/util/Vector;
...
.method getAttributes()Ljava/util/Hashtable;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/util/wtn;->VAa:Ljava/util/Hashtable;
...
.method getOrdering()Ljava/util/Vector;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/util/wtn;->WAa:Ljava/util/Vector;
...
.method public readObject(Ljava/io/ObjectInputStream;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/util/wtn;->VAa:Ljava/util/Hashtable;
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/util/wtn;->WAa:Ljava/util/Vector;
...
.method public writeObject(Ljava/io/ObjectOutputStream;)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/util/wtn;->WAa:Ljava/util/Vector;
    ...
    iget-object v4, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/util/wtn;->VAa:Ljava/util/Hashtable;
...
.method public zta(Lorg/bouncycastle/asn1/bvj;Lorg/bouncycastle/asn1/ssp;)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/util/wtn;->VAa:Ljava/util/Hashtable;
