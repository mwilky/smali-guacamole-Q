...
.field private final rAa:Ljava/security/cert/PKIXParameters;

.field private sAa:Lorg/bouncycastle/jcajce/cno;

.field private tAa:Ljava/util/List;
...
.field private uAa:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
...
.field private vAa:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field private wAa:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Lorg/bouncycastle/asn1/x509/zgw;",
...
.field private yAa:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
...
.method public constructor <init>(Ljava/security/cert/PKIXParameters;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->tAa:Ljava/util/List;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->uAa:Ljava/util/Map;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->vAa:Ljava/util/List;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->wAa:Ljava/util/Map;

    const/4 v0, 0x0

    iput v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->ema:I

    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->fma:Z
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->rAa:Ljava/security/cert/PKIXParameters;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->sAa:Lorg/bouncycastle/jcajce/cno;
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->xAa:Z

    invoke-virtual {p1}, Ljava/security/cert/PKIXParameters;->getTrustAnchors()Ljava/util/Set;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/wtn$zta;->yAa:Ljava/util/Set;
...
.method static synthetic bio(Lorg/bouncycastle/jcajce/wtn$zta;)Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->fma:Z
...
.method static synthetic cno(Lorg/bouncycastle/jcajce/wtn$zta;)Lorg/bouncycastle/jcajce/cno;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->sAa:Lorg/bouncycastle/jcajce/cno;
...
.method static synthetic igw(Lorg/bouncycastle/jcajce/wtn$zta;)I
    ...
    iget p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->ema:I
...
.method static synthetic kth(Lorg/bouncycastle/jcajce/wtn$zta;)Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->xAa:Z
...
.method static synthetic rtg(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/util/List;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->vAa:Ljava/util/List;
...
.method static synthetic sis(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/util/List;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->tAa:Ljava/util/List;
...
.method static synthetic ssp(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->wAa:Ljava/util/Map;
...
.method static synthetic tsu(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->uAa:Ljava/util/Map;
...
.method static synthetic wtn(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/util/Set;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->yAa:Ljava/util/Set;
...
.method static synthetic zta(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/security/cert/PKIXParameters;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->rAa:Ljava/security/cert/PKIXParameters;
...
.method public U(Z)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/jcajce/wtn$zta;->fma:Z
...
.method public V(I)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iput p1, p0, Lorg/bouncycastle/jcajce/wtn$zta;->ema:I
...
.method public setRevocationEnabled(Z)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/jcajce/wtn$zta;->xAa:Z
...
.method public you(Lorg/bouncycastle/jcajce/cno;)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/wtn$zta;->sAa:Lorg/bouncycastle/jcajce/cno;
...
.method public zta(Lorg/bouncycastle/asn1/x509/zgw;Lorg/bouncycastle/jcajce/rtg;)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->uAa:Ljava/util/Map;
...
.method public zta(Lorg/bouncycastle/asn1/x509/zgw;Lorg/bouncycastle/jcajce/you;)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->wAa:Ljava/util/Map;
...
.method public zta(Lorg/bouncycastle/jcajce/rtg;)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->tAa:Ljava/util/List;
...
.method public zta(Lorg/bouncycastle/jcajce/you;)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->vAa:Ljava/util/List;
