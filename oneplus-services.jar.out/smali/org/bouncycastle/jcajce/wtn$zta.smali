...
# instance fields
.field private final BAa:Ljava/security/cert/PKIXParameters;

.field private CAa:Lorg/bouncycastle/jcajce/cno;
...
.field private EAa:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
...
.method public constructor <init>(Ljava/security/cert/PKIXParameters;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->DAa:Ljava/util/List;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->EAa:Ljava/util/Map;
    ...
    iput v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->pma:I

    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->qma:Z
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->BAa:Ljava/security/cert/PKIXParameters;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->CAa:Lorg/bouncycastle/jcajce/cno;
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->HAa:Z

    invoke-virtual {p1}, Ljava/security/cert/PKIXParameters;->getTrustAnchors()Ljava/util/Set;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/wtn$zta;->IAa:Ljava/util/Set;
...
.method static synthetic bio(Lorg/bouncycastle/jcajce/wtn$zta;)Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->qma:Z
...
.method static synthetic cno(Lorg/bouncycastle/jcajce/wtn$zta;)Lorg/bouncycastle/jcajce/cno;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->CAa:Lorg/bouncycastle/jcajce/cno;
...
.method static synthetic igw(Lorg/bouncycastle/jcajce/wtn$zta;)I
    ...
    iget p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->pma:I
...
.method static synthetic kth(Lorg/bouncycastle/jcajce/wtn$zta;)Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->HAa:Z
...
.method static synthetic sis(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/util/List;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->DAa:Ljava/util/List;
...
.method static synthetic tsu(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->EAa:Ljava/util/Map;
...
.method static synthetic wtn(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/util/Set;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->IAa:Ljava/util/Set;
...
.method static synthetic zta(Lorg/bouncycastle/jcajce/wtn$zta;)Ljava/security/cert/PKIXParameters;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->BAa:Ljava/security/cert/PKIXParameters;
...
.method public U(Z)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/jcajce/wtn$zta;->qma:Z
...
.method public V(I)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iput p1, p0, Lorg/bouncycastle/jcajce/wtn$zta;->pma:I
...
.method public setRevocationEnabled(Z)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/jcajce/wtn$zta;->HAa:Z
...
.method public you(Lorg/bouncycastle/jcajce/cno;)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/wtn$zta;->CAa:Lorg/bouncycastle/jcajce/cno;
...
.method public zta(Lorg/bouncycastle/asn1/x509/zgw;Lorg/bouncycastle/jcajce/rtg;)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->EAa:Ljava/util/Map;
...
.method public zta(Lorg/bouncycastle/jcajce/rtg;)Lorg/bouncycastle/jcajce/wtn$zta;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/wtn$zta;->DAa:Ljava/util/List;
