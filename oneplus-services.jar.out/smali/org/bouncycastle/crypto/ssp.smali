...
.field protected eva:Z

.field protected fva:Z

.field protected rla:Lorg/bouncycastle/crypto/rtg;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/rtg;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/ssp;->rla:Lorg/bouncycastle/crypto/rtg;
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/ssp;->cva:I
    ...
    :goto_0
    iput-boolean v4, p0, Lorg/bouncycastle/crypto/ssp;->fva:Z

    iget-boolean v4, p0, Lorg/bouncycastle/crypto/ssp;->fva:Z
    ...
    :cond_2
    iput-boolean v0, p0, Lorg/bouncycastle/crypto/ssp;->eva:Z

    goto :goto_2

    :cond_3
    :goto_1
    iput-boolean v3, p0, Lorg/bouncycastle/crypto/ssp;->eva:Z
...
.method public b()Lorg/bouncycastle/crypto/rtg;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/ssp;->rla:Lorg/bouncycastle/crypto/rtg;
...
.method public doFinal([BI)I
    ...
    :try_start_0
    iget v0, p0, Lorg/bouncycastle/crypto/ssp;->cva:I
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/ssp;->eva:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lorg/bouncycastle/crypto/ssp;->rla:Lorg/bouncycastle/crypto/rtg;
    ...
    iput v1, p0, Lorg/bouncycastle/crypto/ssp;->cva:I
...
.method public getOutputSize(I)I
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/ssp;->cva:I
...
.method public you(I)I
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/ssp;->fva:Z
...
.method public zta(B[BI)I
    ...
    iget v1, p0, Lorg/bouncycastle/crypto/ssp;->cva:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, Lorg/bouncycastle/crypto/ssp;->cva:I

    aput-byte p1, v0, v1

    iget p1, p0, Lorg/bouncycastle/crypto/ssp;->cva:I
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/ssp;->rla:Lorg/bouncycastle/crypto/rtg;
...
.method public zta([BII[BI)I
    ...
    iget v3, p0, Lorg/bouncycastle/crypto/ssp;->cva:I
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/ssp;->rla:Lorg/bouncycastle/crypto/rtg;
    ...
    iput v4, p0, Lorg/bouncycastle/crypto/ssp;->cva:I
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/ssp;->rla:Lorg/bouncycastle/crypto/rtg;
    ...
    iget v2, p0, Lorg/bouncycastle/crypto/ssp;->cva:I
    ...
    iput p1, p0, Lorg/bouncycastle/crypto/ssp;->cva:I
...
.method public zta(ZLorg/bouncycastle/crypto/kth;)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/crypto/ssp;->dva:Z
